...
export type MicrosoftStrategyOptions = Omit<
    oauth2.StrategyOptions,
    OptionalOptionParameters
> &
    Partial<oauth2.StrategyOptions> &
    Partial<MicrosoftSpecificStrategyOptions>;

export type MicrosoftStrategyOptionsWithRequest = Omit<
    oauth2.StrategyOptionsWithRequest,
    OptionalOptionParameters
> &
...
export class Strategy extends oauth2.Strategy {
    ...
    constructor(
        options: MicrosoftStrategyOptionsWithRequest,
