...
if (
    hyphenateDe1996("<section>Silbentrennung</section>") !==
    "<section>Sil-ben-tren-nung</section>"
) {
    throw new Error("Test failed");
}

// Test with debug output
const hyphenateHu = createHyphenator(hyphenationPatternsHu, {
    debug: true,
}) as HyphenationFunctionSync;
if (
    hyphenateHu("szóelválasztás", { hyphenChar: "|" }) !== "szó|el|vá|lasz|tás"
) {
    throw new Error("Test failed");
}
...
const hyphenateEnUsSyncWithMinWordLength = createHyphenator(
    hyphenationPatternsEnGb,
    {
        hyphenChar: "-",
        minWordLength: 11,
    },
