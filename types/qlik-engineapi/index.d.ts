declare namespace EngineAPI {
    ...
    interface IApp extends enigmaJS.IGeneratedAPI {
        ...
        exportReducedData(qOptions?: {
            qBookmarkId?: string | undefined;
            qExpires?: number | undefined;
    ...
    interface INxCell {
         ...
         */
        qIsTotalCell?: boolean | undefined;
         ...
         * Not applicable to list objects.
         */
        qIsOtherCell?: boolean | undefined;
         ...
         * This parameter is optional.
         */
        qHighlightRanges?: INxHighlightRanges | undefined;
    ...
    interface IGenericObjectLayout extends IGenericBaseLayout {
         ...
         */
        qError?: INxLayoutErrors | undefined;
    ...
    interface INxTreeNode {
         ...
         * Attribute expression values.
         */
        qAttrExps?: INxAttributeExpressionValues | undefined;

        /**
         * Attribute dimension values.
         */
        qAttrDims?: INxAttributeDimValues | undefined;
    }
    ...
    interface IBNFDef {
         ...
         * >> The default value is false.
         */
        qScriptStatement?: boolean | undefined;
         ...
         * >> The default value is false.
         */
        qControlStatement?: boolean | undefined;
    ...
    interface IInteractDef {
         ...
         * Interaction type.
         */
        qType?: InteractionType | undefined;
         ...
         * This property is used if the type of interaction is IT_SCRIPTLINE.
         */
        qOldLineNr?: number | undefined;

        /**
         * First line number of the next statement to be executed.
         * This property is used if the type of interaction is IT_SCRIPTLINE.
         */
        qNewLineNr?: number | undefined;
    ...
    interface INxDimensionInfo {
         ...
         */
        qSortIndicator?: SortIndicatorType | undefined;
         ...
         */
        qError?: INxValidationError | undefined;
         ...
         * FieldAttributes
         */
        qNumFormat?: FieldAttributesType | undefined;
    ...
    interface INxValidationError {
         ...
         * String
         */
        qExtendedMessage?: string | undefined;
    }
    ...
    interface INxMeasureInfo {
         ...
         */
        qNumFormat?: IFieldAttributes | undefined;
    ...
    interface INxInlineDimensionDef {
         ...
         * >> This parameter is optional.
         */
        qFieldDefs?: string[] | undefined;

        /**
         * Array of field labels.
         * >> This parameter is optional.
         */
        qFieldLabels?: string[] | undefined;
         ...
         * >> This parameter is optional.
         */
        qNumberPresentations?: IFieldAttributes[] | undefined;
    ...
    interface IHyperCubeDimensionqDef extends INxInlineDimensionDef {
        ...
        othersLabel?: IStringExpressionContainer | undefined;
    }
    ...
    interface INxDimension {
         ...
         */
        qNullSuppression?: boolean | undefined;
         ...
         */
        qOtherTotalSpec?: IOtherTotalSpecProp | undefined;

        /**
         * If set to true, all dimension values are shown.
         */
        qShowAll?: boolean | undefined;
         ...
         */
        qOtherLabel?: IStringExpressionContainer | undefined;
         ...
         */
        qTotalLabel?: IStringExpressionContainer | undefined;
         ...
         */
        qCalcCond?: IValueExpr | undefined;

        /**
         * List of attribute expressions.
         */
        qAttributeExpressions?: INxAttrExprDef[] | undefined;

        /**
         * List of attribute dimensions.
         */
        qAttributeDimensions?: INxAttrDimDef[] | undefined;

        /**
         * no / empty docu
         */
        qIncludeElemValue?: boolean | undefined; // ?Nicht in Doku

        /**
         * no / empty docu
         */
        qShowTotal?: boolean | undefined; // ?Nicht in Doku
    }
    ...
    interface ISortCriteria {
         ...
         */
        qSortByState?: TypeSortDirection | undefined;

        /**
         * Sorts the field values by frequency
         * (number of occurrences in the field).
         */
        qSortByFrequency?: TypeSortDirection | undefined;

        /**
         * Sorts the field values by numeric value.
         */
        qSortByNumeric?: TypeSortDirection | undefined;

        /**
         * Sorts the field by alphabetical order.
         */
        qSortByAscii?: TypeSortDirection | undefined;

        /**
         * Sorts the field values by the initial load order.
         */
        qSortByLoadOrder?: TypeSortDirection | undefined;

        /**
         * Sorts the field by expression.
         */
        qSortByExpression?: TypeSortDirection | undefined;

        /**
         * Sort by expression.
         */
        qExpression?: IValueExpr | undefined;

        /**
         * no / empty docu
         */
        qSortByGreyness?: TypeSortDirection | undefined; // ?Nicht in Doku
    }
    ...
    interface INxMeasure {
         ...
         */
        qSortBy?: ISortCriteria | undefined;
    ...
    interface INxInlineMeasureDef {
         ...
         * >> The default value is 0.
         */
        qActiveExpression?: number | undefined;
    ...
    interface IHyperCubeMeasureqDef extends INxInlineMeasureDef {
        autoSort?: boolean | undefined;
        cId?: string | undefined;
        numFormatFromTemplate?: boolean | undefined;
    }
...
declare namespace EngineAPI {
    ...
    interface IListObjectDef {
         ...
         */
        qFrequencyMode?: FrequencyModeType | undefined;
         ...
         */
        qShowAlternatives?: boolean | undefined;
         ...
         * >> This parameter is optional.
         */
        qExpressions?: INxListObjectExpressionDef[] | undefined;
    }
...
declare namespace EngineAPI {
    ...
    interface IHyperCube {
         ...
         * >> This property is optional.
         */
        qLastExpandedPos?: INxCellPosition | undefined;
...
declare namespace EngineAPI {
    ...
    interface INxVariableListItem {
         ...
         */
        qIsReserved?: boolean | undefined;

        /**
         * Information about publishing and permissions.
         * >> This parameter is optional.
         */
        qMeta?: INxMeta | undefined;
