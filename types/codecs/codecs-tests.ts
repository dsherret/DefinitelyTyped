...
}
{
    ...
    const set: [Codec<null>, InType<null>, OutType<null>, CodecName<null>] =
        [] as any;
    set; // $ExpectType [BinaryCodec, string | Uint8Array, Buffer, "binary"]
}
{
    codecs("any").name; // $ExpectType "binary"
    const set: [Codec<"any">, InType<"any">, OutType<"any">, CodecName<"any">] =
        [] as any;
    set; // $ExpectType [BinaryCodec, string | Uint8Array, Buffer, "binary"]
}
{
...
}
{
    ...
    codecs[codec].encode("hello"); // $ExpectType Buffer
    codecs[codec].decode(new Uint8Array()); // $ExpectType string
    const set: [Codec<"hex">, InType<"hex">, OutType<"hex">, CodecName<"hex">] =
        [] as any;
