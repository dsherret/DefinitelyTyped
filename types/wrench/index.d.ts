...
export declare function rmdirSyncRecursive(
    path: string,
    failSilent?: boolean,
): void;
...
export declare function chmodSyncRecursive(
    sourceDir: string,
    filemode: number,
): void;
export declare function chownSyncRecursive(
    sourceDir: string,
    uid: number,
    gid: number,
): void;
...
export declare function readdirRecursive(
    baseDir: string,
    fn: (err: Error, files: string[]) => void,
): void;
export declare function rmdirRecursive(
    path: string,
    fn: (err: Error) => void,
): void;
export declare function copyDirRecursive(
    srcDir: string,
    newDir: string,
    fn: (err: Error) => void,
): void;
