...
const findCallback: LineNavigator.FindCallback = (
    ...
    match: LineNavigator.FindMatch | undefined,
) => {};
const findAllCallback: LineNavigator.FindAllCallback = (
    err: any,
    index: number,
    limitHit: boolean | undefined,
    results: LineNavigator.FindAllResult[] | undefined,
) => {};
const readLinesCallback: LineNavigator.ReadLinesCallback = (
    err: any,
    index: number,
