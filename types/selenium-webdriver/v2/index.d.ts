...
export namespace promise {
    ...
    interface IThenable<T> extends PromiseLike<T> {
         ...
         */
        then<R>(
            opt_callback?: ((value: T) => R | PromiseLike<R>) | null,
            opt_errback?: (error: any) => any,
        ): Promise<R>;
    ...
    class Thenable<T> implements IThenable<T> {
         ...
         */
        then<R>(
            opt_callback?: (value: T) => R | IThenable<R>,
            opt_errback?: (error: any) => R | IThenable<R>,
        ): Promise<R>;
    ...
    implements promise.IThenable<WebElement>
{
     ...
     */
    then<R>(
        opt_callback?: (value: WebElement) => promise.Promise<R>,
        opt_errback?: (error: any) => any,
    ): promise.Promise<R>;
