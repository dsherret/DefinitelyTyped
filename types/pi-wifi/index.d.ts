...
declare function checkConnection(
    ssid: string,
    callback: (err: Error, result: ConnectionCheck) => any,
): any;
/**
 ...
 */
declare function secureConnection(
    ssid: string,
    password: string,
    callback: (error: Error) => any,
): any;
 ...
 * @param callback Returns error if the connection isn't successful
 */
declare function openConnection(
    ssid: string,
    callback: (error: Error) => any,
): any;
/**
 ...
 */
export function detectSupplicant(
    callback: (error: Error, iface: string, configFile: string) => any,
): any;
/**
 ...
 */
declare function disableSupplicant(
    iface: string,
    callback: (error: Error) => any,
): any;
/**
...
export function listNetworks(
    callback: (error: Error, networksArray: ListNetwork[]) => any,
): any;
/**
 ...
 * @param callback (err) Returns an error if the process fails
 */
export function restartInterface(
    iface: string,
    callback: (error: Error) => any,
): any;
/**
...
export function scan(
    callback: (error: Error, data: ScanNetwork[]) => any,
): any[][any];
/**
 ...
 */
export function setCurrentInterface(
    iface: string,
    callback: (error: Error) => any,
): any;
/**
 ...
 */
export function startSupplicant(
    options: object,
    callback: (error: Error) => any,
): any;
/**
...
export function status(
    iface: string,
    callback: (error: Error, status: Status) => any,
): any;
export {
