...
myApp.controller(
    "sortableController",
    function ($scope: MySortableControllerScope) {
        $scope.sortableOptions = {
            activate: function (e, ui) {
                var jQueryEventObject: JQueryEventObject = e;
                var uiSortableUIParams: ng.ui.UISortableUIParams<SortableModelInfo> =
                    ui;
            },
            ...
            stop: function (e, ui) {
                ...
                var uiitemsortable: ng.ui.UISortableProperties<SortableModelInfo> =
                    uiitem.sortable;

                var dropindex: number = uiitemsortable.dropindex;
                var droptarget: number = uiitemsortable.droptarget;
                var droptargetModel: SortableModelInfo[] =
                    uiitemsortable.droptargetModel;
                ...
                var sourceModel: SortableModelInfo[] =
                    uiitemsortable.sourceModel;
            ...
            update: function (e, ui) {
                ...
                var isCustomHelperUsed: Boolean =
        ...
        $scope.sortableOptions.helper = function (
            e: JQueryEventObject,
        ...
        const sortableFloatingOption0: ng.ui.UISortableOptions<SortableModelInfo> =
            { "ui-floating": undefined };
        const sortableFloatingOption1: ng.ui.UISortableOptions<SortableModelInfo> =
            { "ui-floating": false };
        const sortableFloatingOption2: ng.ui.UISortableOptions<SortableModelInfo> =
            { "ui-floating": true };
        const sortableFloatingOption3: ng.ui.UISortableOptions<SortableModelInfo> =
            { "ui-floating": "auto" };
    },
);
