...
ServiceBus.listRules(
    "testTopic",
    "testSub",
    createResultCallback<Models.Rule[]>(),
);
ServiceBus.createRule(
    "testTopic",
    "testSub",
    "testRule",
    createResultCallback<Models.Rule>(),
...
ServiceBus.receiveQueueMessage(
    "testQueue",
    createResultCallback<Azure.ServiceBus.Message>(),
);
...
ServiceBus.receiveSubscriptionMessage(
    "testTopic",
    "testSub",
    createResultCallback<Azure.ServiceBus.Message>(),
);
