...
console.log(
    user.getQuickInviteLinkSteamID(
        "www.steamcommunity.com/quickinvite/123456780",
    ),
);

user.redeemQuickInviteLink(
    "www.steamcommunity.com/quickinvite/123456780",
).catch((err) => console.error(err));
...
user.chat
    .saveGroup("groupId", "myAwesomeGroupName")
    .catch((err) => console.error(err));
