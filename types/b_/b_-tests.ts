...
const blockWithModsClass: string = b_("block", {
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
const elemClass: string = b_("block", "elem");
const elemWithModsClass: string = b_("block", "elem", {
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
...
const withBlockWithModsClass: string = withBlock({
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
const withBlockElemClass: string = withBlock("elem");
const withBlockElemWithModsClass: string = withBlock("elem", {
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
...
const lockBlockWithModsClass: string = lockBlock({
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
const lockBlockElemClass: string = lockBlock("elem");
const lockBlockElemWithModsClass: string = lockBlock("elem", {
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
...
const withElemWithModsClass: string = withElem({
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
...
const parameterizedElemWithModsClass: string = parameterizedB_(
    "block",
    "elem",
    {
        stringMod: "string",
...
const parameterizedWithBlockElemWithModsClass: string = parameterizedWithBlock(
    "elem",
    {
        stringMod: "string",
        boolMod: true,
...
const parameterizedLockBlockElemWithModsClass: string = parameterizedLockBlock(
    "elem",
    {
        stringMod: "string",
        boolMod: true,
