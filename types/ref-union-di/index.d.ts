...
declare var UnionType: {
    new <
        TDefinition extends
            | union.UnionTypeObjectDefinitionBase
            | union.UnionTypeObjectDefinitionInferenceMarker,
    >(
        fields: TDefinition,
    ): union.UnionType<
        union.UnionTypeObjectDefinitionToUnionTypeDefinition<TDefinition>
    >;
...
declare namespace union {
     ...
     */
    type UnionTypeObjectDefinitionToUnionTypeDefinition<
        T extends UnionTypeObjectDefinitionBase,
    > = [T] extends [never] | [0]
     ...
     */
    type UnionFields<T extends UnionTypeDefinitionBase> = [T] extends
        | [never]
        | [0]
     ...
     */
    type UnionObjectProperties<T extends UnionTypeDefinitionBase> = [T] extends
        | [never]
        | [0]
     ...
     */
    type UnionInput<T extends UnionTypeDefinitionBase> = [T] extends
        | [never]
        | [0]
        ? Record<string, any> // catches T extends never/any (since `0` doesn't overlap with our constraint)
        : {
              ...
              //          y: { y: number, x?: never };
              //      }
              [P in keyof UnionObjectProperties<T>]: Pick<
                  UnionObjectProperties<T>,
                  P
              > &
                  Partial<
                      Record<Exclude<keyof UnionObjectProperties<T>, P>, never>
                  >;
    ...
    interface UnionType<TDefinition extends UnionTypeDefinitionBase = any>
        ...
        new (
            arg: Buffer,
            data?: UnionInput<TDefinition>,
        ): UnionObject<UnionObjectProperties<TDefinition>>;
        new (
            data?: UnionInput<TDefinition>,
        ): UnionObject<UnionObjectProperties<TDefinition>>;
