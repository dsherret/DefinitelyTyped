...
function testAccountNotificationsReply(
    accountNotif: ImgurRestApi.AccountNotifications,
): ImgurRestApi.Notification<ImgurRestApi.Comment> {
    return accountNotif.replies[0];
}

function testAccountNotificationsMessage(
    accountNotif: ImgurRestApi.AccountNotifications,
): ImgurRestApi.Notification<ImgurRestApi.Conversation> {
...
function testResponseWithValue(
    response: ImgurRestApi.Response<ImgurRestApi.GalleryProfile>,
): ImgurRestApi.GalleryProfile {
