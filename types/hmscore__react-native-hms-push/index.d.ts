...
declare namespace HmsLocalNotification {
    ...
    function cancelNotificationsWithId(
        notificationIds: string[],
    ): Promise<ResultResponse<boolean>>;
    ...
    function getNotifications(): Promise<
        ResultResponse<LocalNotificationOptions[]>
    >;
    function getScheduledNotifications(): Promise<
        ResultResponse<LocalNotificationOptions[]>
    >;
    function getChannels(): Promise<ResultResponse<string[]>>;
    function cancelNotifications(): Promise<ResultResponse<boolean>>;
    function cancelNotificationsWithTag(
        tag: string,
    ): Promise<ResultResponse<boolean>>;
...
declare namespace HmsPushMessaging {
    function setBackgroundMessageHandler(
        handler: (dataMessage: BackgroundRemoteMessage) => void,
    ): void;
    function sendRemoteMessage(remoteMessageObject: {
        [k: string]: unknown;
    }): Promise<ResultResponse<boolean>>;
    ...
    function setAutoInitEnabled(
        value: boolean,
    ): Promise<ResultResponse<boolean>>;
    function getInitialNotification(): Promise<
        ResultResponse<RemoteDataMessageWithExtras>
    >;
}
...
declare namespace HmsPushInstanceId {
    ...
    function getTokenWithSubjectId(
        subjectId: string,
    ...
    function deleteTokenWithSubjectId(
        subjectId: string,
    ): Promise<ResultResponse<boolean>>;
}
...
declare namespace HmsPushProfile {
    ...
    function deleteProfileWithSubjectId(
        subjectId: string,
        profileId: string,
    ): Promise<ResultResponse<boolean>>;
}
