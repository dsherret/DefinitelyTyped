...
export default class App extends Component<{}, State> {
    ...
    componentDidMount() {
        this.onRemoteMessageReceivedListener =
        ...
        this.onTokenErrorListener = HmsPushEvent.onTokenError((result) => {
            ...
            if (
                result.result_code ===
                HmsPushResultCode.ERROR_CLIENT_API_INVALID
            ) {
                console.log("Invalid Client");
            }
        });

        this.onMultiSenderTokenReceivedListener =
            HmsPushEvent.onMultiSenderTokenReceived((result) => {
                console.log("onMultiSenderTokenReceived", result);
            });

        this.onMultiSenderTokenErrorListener =
        ...
        this.onLocalNotificationActionListener =
            HmsPushEvent.onLocalNotificationAction((result) => {
                ...
                if (notification.action === "Yes") {
                    HmsLocalNotification.cancelNotificationsWithId([
                        notification.id,
                    ]);
                }
                console.log(
                    "onLocalNotificationAction-Clicked",
                    notification.action,
                );
            });
    ...
    turnOnPush() {
        HmsPushMessaging.turnOnPush()
            ...
            .catch((err) => {
                console.log(
                    "[turnOnPush] Error/Exception: " + JSON.stringify(err),
                );
            });
    }
    ...
    turnOffPush() {
        HmsPushMessaging.turnOffPush()
            ...
            .catch((err) => {
                console.log(
                    "[turnOffPush] Error/Exception: " + JSON.stringify(err),
                );
            });
    }
    ...
    getAAID() {
        HmsPushInstanceId.getAAID()
            ...
            .catch((err) => {
                console.log(
                    "[getAAID] Error/Exception: " + JSON.stringify(err),
                );
            });
    }
    getOdid() {
        HmsPushOpenDevice.getOdid()
            ...
            .catch((err) => {
                console.log(
                    "[getOdid] Error/Exception: " + JSON.stringify(err),
                );
            });
    }
    ...
    getTokenWithSubjectId() {
        HmsPushInstanceId.getTokenWithSubjectId(this.state.subjectId)
            ...
            .catch((err) => {
                console.log(
                    "[getTokenWithSubjectId] Error/Exception: " +
                        JSON.stringify(err),
                );
            });
    }
    ...
    getCreationTime() {
        HmsPushInstanceId.getCreationTime()
            ...
            .catch((err) => {
                console.log(
                    "[getCreationTime] Error/Exception: " + JSON.stringify(err),
                );
            });
    }
    ...
    deleteAAID() {
        HmsPushInstanceId.deleteAAID()
            ...
            .catch((err) => {
                console.log(
                    "[deleteAAID] Error/Exception: " + JSON.stringify(err),
                );
            });
    }
    ...
    deleteToken() {
        HmsPushInstanceId.deleteToken("")
            ...
            .catch((err) => {
                console.log(
                    "[deleteToken] Error/Exception: " + JSON.stringify(err),
                );
            });
    }
    ...
    deleteTokenWithSubjectId() {
        HmsPushInstanceId.deleteTokenWithSubjectId(this.state.subjectId)
            ...
            .catch((err) => {
                console.log(
                    "[deleteTokenWithSubjectId] Error/Exception: " +
                        JSON.stringify(err),
                );
            });
    }
    ...
    subscribe() {
        HmsPushMessaging.subscribe(this.state.topic)
            ...
            .catch((err) => {
                ...
                console.log(
                    "[subscribe] Error/Exception: " + JSON.stringify(err),
                );
            });
    }
    ...
    unsubscribe() {
        HmsPushMessaging.unsubscribe(this.state.topic)
            ...
            .catch((err) => {
                console.log(
                    "[unsubscribe] Error/Exception: " + JSON.stringify(err),
                );
            });
    }
    ...
    sendRemoteMessage() {
        HmsPushMessaging.sendRemoteMessage({
            ...
            .catch((err) => {
                console.log(
                    "[sendRemoteMessage] Error/Exception: " +
                        JSON.stringify(err),
                );
            });
    }
    ...
    isAutoInitEnabled() {
        HmsPushMessaging.isAutoInitEnabled()
            ...
            .catch((err) => {
                console.log(
                    "[isAutoInitEnabled] Error/Exception: " +
                        JSON.stringify(err),
                );
            });
    }
    setAutoInitEnabled(value: boolean) {
        HmsPushMessaging.setAutoInitEnabled(value)
            ...
            .catch((err) => {
                console.log(
                    "[setAutoInitEnabled] Error/Exception: " +
                        JSON.stringify(err),
                );
            });
    }
    ...
    getInitialNotification() {
        HmsPushMessaging.getInitialNotification()
            ...
            .catch((err) => {
                console.log(
                    "[getInitialNotification] Error/Exception: " +
                        JSON.stringify(err),
                );
            });
    }
    ...
    isSupportProfile() {
        HmsPushProfile.isSupportProfile()
            ...
            .catch((err) => {
                console.log(
                    "[isSupportProfile] Error/Exception: " +
                        JSON.stringify(err),
                );
            });
    }
    ...
    addProfile() {
        HmsPushProfile.addProfile(
            ...
            .catch((err) => {
                console.log(
                    "[addProfile] Error/Exception: " + JSON.stringify(err),
                );
            });
    }
    ...
    addProfileWithSubjectId() {
        HmsPushProfile.addProfileWithSubjectId(
            ...
            .catch((err) => {
                console.log(
                    "[addProfileWithSubjectId] Error/Exception: " +
                        JSON.stringify(err),
                );
            });
    }
    ...
    deleteProfile() {
        HmsPushProfile.deleteProfile("<profile_Id>")
            ...
            .catch((err) => {
                console.log(
                    "[deleteProfile] Error/Exception: " + JSON.stringify(err),
                );
            });
    }

    deleteProfileWithSubjectId() {
        HmsPushProfile.deleteProfileWithSubjectId(
            "<subject_Id>",
            "<profile_Id>",
        )
            .then((result) => {
            ...
            .catch((err) => {
                console.log(
                    "[deleteProfileWithSubjectId] Error/Exception: " +
                        JSON.stringify(err),
                );
            });
    }
