...
export type KnuddelsJsonData =
    ...
    | undefined;
export type KnuddelsSerializable =
    | string
    | number
    | boolean
    | User
...
declare global {
    ...
    class BotUser extends User {
        ...
        destroyKnuddel(
            ...
            parameters?: {
                onSuccess?:
                    | ((knuddelAmount: KnuddelAmount, reason: string) => void)
                    | undefined;
                onError?:
                    | ((
                          knuddelAmount: KnuddelAmount,
    ...
    class UserAccess {
        ...
        eachAccessibleUser(
            ...
            parameters?: {
                onStart?:
                    | ((accessibleUserCount: number, key?: string) => void)
                    | undefined;
                onEnd?:
                    | ((accessibleUserCount: number, key?: string) => void)
                    | undefined;
    ...
    class UserPersistenceNumbers {
        ...
        static each(
            ...
            parameters?: {
                ...
                onStart?:
                    | ((totalCount: number, key: string) => void)
                    | undefined;
