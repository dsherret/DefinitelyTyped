...
declare function assertLinesToCharsResultEquals(
    expected: { chars1: string; chars2: string; lineArray: string[] },
    actual: { chars1: string; chars2: string; lineArray: string[] },
): void;
