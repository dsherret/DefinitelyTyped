...
declare namespace CoreObject {
    ...
    type ExtendOptions<Base> = { [K in keyof Base]?: Base[K] } & Record<
        string,
        any
    >;

    /** The `this` type for any methods on the options passed to `Base.extend()` */
    type ExtendThisType<Base, Ext> = ThisType<
        Mix<Base, Ext> & { _super: Super<Base> }
    >;
}
...
declare class CoreObject {
    ...
    static extend<
        ...
        Ext extends CoreObject.ExtendOptions<InstanceType<BaseClass>>,
    >(
        this: BaseClass,
