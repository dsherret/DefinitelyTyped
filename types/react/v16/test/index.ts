...
// --------------------------------------------------------------------------
{
    ...
    class SettingStateFromCtorComponent extends React.Component<
        Props,
        State,
        Snapshot
    > {
    ...
    class BadlyInitializedState extends React.Component<
        Props,
        State,
        Snapshot
    > {
    ...
    class BetterPropsAndStateChecksComponent extends React.Component<
        Props,
        State,
        Snapshot
    > {
...
const domFactory: React.DOMFactory<
    React.DOMAttributes<{}>,
    Element
> = React.createFactory("div");
const domFactoryElement: React.DOMElement<
    React.DOMAttributes<{}>,
    Element
> = domFactory();
...
const elementNoState: React.CElement<Props, ModernComponentNoState> =
    React.createElement(ModernComponentNoState, props);
const elementNullProps: React.CElement<{}, ModernComponentNoPropsAndState> =
    React.createElement(ModernComponentNoPropsAndState, null);
const functionComponentElement: React.FunctionComponentElement<SCProps> =
    React.createElement(FunctionComponent, scProps);
const functionComponentElementNullProps: React.FunctionComponentElement<SCProps> =
    React.createElement(FunctionComponent4, null);
const legacyStatelessComponentElement: React.SFCElement<SCProps> =
    React.createElement(FunctionComponent, scProps);
const legacyStatelessComponentElementNullProps: React.SFCElement<SCProps> =
    React.createElement(FunctionComponent4, null);
const domElement: React.DOMElement<
...
const fragmentElement: React.ReactElement<{}> = React.createElement(
    React.Fragment,
    {},
    [React.createElement("div"), React.createElement("div")],
);
const fragmentElementNullProps: React.ReactElement<{}> = React.createElement(
    React.Fragment,
    null,
    [React.createElement("div"), React.createElement("div")],
);
...
function foo3(
    child:
        | React.ComponentClass<{ name: string }>
...
// React.cloneElement
const clonedElement: React.CElement<Props, ModernComponent> =
...
const clonedDOMElement: React.DOMElement<
    React.HTMLAttributes<HTMLDivElement>,
    HTMLDivElement
...
const componentElementOrNull: ModernComponent = ReactDOM.render(
    element,
    container,
);
const componentNoState: ModernComponentNoState = ReactDOM.render(
    elementNoState,
    container,
);
const componentNoStateElementOrNull: ModernComponentNoState = ReactDOM.render(
    elementNoState,
    container,
);
...
const ForwardingRefComponent = React.forwardRef(
    (props: ForwardingRefComponentProps, ref: React.Ref<RefComponent>) => {
        return React.createElement(RefComponent, { ref });
    },
);

// Declaring forwardRef render function separately (not inline).
const ForwardRefRenderFunction = (
    props: ForwardingRefComponentProps,
    ref: React.ForwardedRef<RefComponent>,
) => {
    return React.createElement(RefComponent, { ref });
};
...
const ForwardRefRenderFunctionWithPropTypes: {
    (): null;
    propTypes?: {} | undefined;
} = () => null;
...
const ForwardRefRenderFunctionWithDefaultProps: {
    (): null;
...
function RefCarryingComponent() {
    ...
    return React.createElement<
        React.RefAttributes<RefComponent> & ForwardingRefComponentProps
...
const LazyComponent = React.lazy(() =>
    Promise.resolve({ default: RefComponent }),
);

type ClassComponentAsRef = React.ElementRef<typeof RefComponent>; // $ExpectType RefComponent
type FunctionComponentWithoutPropsAsRef = React.ElementRef<
    typeof RefCarryingComponent
>; // $ExpectType never
type FunctionComponentWithPropsAsRef = React.ElementRef<
...
type ForwardingRefComponentAsRef = React.ElementRef<
    typeof ForwardingRefComponent
>; // $ExpectType RefComponent
type MemoizedForwardingRefComponentAsRef = React.ElementRef<
    typeof MemoizedForwardingRefComponent
>; // $ExpectType RefComponent
...
const mappedChildrenArray: number[] = React.Children.map(
    children,
    (child: any) => 42,
);
const childrenArray: Array<React.ReactElement<{ p: number }>> = children;
const mappedChildrenArrayWithKnownChildren: number[] = React.Children.map(
    childrenArray,
    (child) => child.props.p,
);
...
// $ExpectType Element[]
const mappedChildrenArray3 = React.Children.map(
    elementChildren,
    (element) => element,
);
// $ExpectType (string | Element)[]
const mappedChildrenArray4 = React.Children.map(
    mixedChildren,
...
// $ExpectType true
type mappedChildrenArray5Type = typeof mappedChildrenArray5 extends React.Key[]
    ? true
    : false;
// $ExpectType string[]
const mappedChildrenArray6 = React.Children.map(
    renderPropsChildren,
    (element) => element.name,
);
// The return type may not be an array
// @ts-expect-error
const mappedChildrenArray7 = React.Children.map(
    nodeChildren,
    (node) => node,
).map;
...
// defaultProps should be optional of props
{
    ...
    const VariableWithAClass: React.ComponentClass<ComponentProps> =
...
// ComponentPropsWithRef and JSXElementConstructor
{
    ...
    type InferredProps = React.ComponentPropsWithRef<
