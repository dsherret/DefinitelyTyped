...
const HasFoo2: React.ReactType<{ foo: boolean }> = (props: { foo: boolean }) =>
    null;
// @ts-expect-error
const HasFoo3: React.ReactType<{ foo: boolean }> = (props: { foo: string }) =>
    null;
...
function elementTypeTests() {
    ...
    // See ReturnSymbol definition for more information.
    // @ts-expect-error
    <ReturnSymbol />;
    // @ts-expect-error
