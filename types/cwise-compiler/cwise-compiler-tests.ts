...
tape("block tests", (t) => {
    ...
    const b1 = ndarray(
        [
            57, 17, 95, 78, 16, 96, 85, 93, 38, 42, 16, 66, 23, 77, 17, 36, 30,
            52, 16, 18, 23, 69, 67, 27,
        ],
        [2, 3, 4],
    );
    const ref1 = ndarray(
        [81, 95, 113, 115, 47, 149, 102, 112, 62, 112, 84, 94],
        [3, 4],
    );
    ...
    const ref2 = ndarray(
        [75, 174, 113, 179, 81, 83, 101, 54, 83, 35, 93, 95],
        [3, 4],
    );
    ...
    const b3 = ndarray(
        [
            48, 46, 89, 64, 72, 96, 38, 37, 79, 92, 89, 62, 84, 41, 13, 81, 53,
            30, 68, 78, 34, 81, 90, 50, 82, 97, 46, 18, 11, 79, 15, 68, 88, 58,
            71, 84, 76, 35, 74, 82, 27, 47, 59, 25, 78, 61, 10, 43, 96, 59, 21,
            74, 41, 67, 11, 72, 38, 62, 95, 66, 57, 44, 93, 10, 51, 59, 50, 85,
            71, 41, 79, 45,
        ],
        [3, 4, 2, 3],
    );
    const ref = ndarray(
        [
            14928, 11687, 9367, 14228, 6177, 13090, 10655, 7203, 10930, 10030,
            8301, 11960,
        ],
        [3, 4],
    );
