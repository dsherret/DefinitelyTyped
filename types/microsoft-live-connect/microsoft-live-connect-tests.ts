...
function loginStatus() {
    WL.getLoginStatus(function (response) {
        alert("Your status is: " + response.status);
    });
}
...
function onUploadFileCompleted(response: Microsoft.Live.IFilePickerResult) {
    WL.upload({
        ...
        function (response) {
            document.getElementById("info").innerText = "File uploaded.";
        },
        function (responseFailed: Microsoft.Live.IError) {
            document.getElementById("info").innerText =
                "Error uploading file: " + responseFailed.error.message;
...
function onDownloadFileCompleted(response: Microsoft.Live.IFilePickerResult) {
    ...
    document.getElementById("info").innerText = "Selected folders/files:" + msg;
}
    ...
    data: [
        {
            ...
            upload_location:
                "https://apis.live.net/v5.0/folder.de57f4126ed7e411.DE57F4126ED7E411!126/files/",
            is_embeddable: true,
            count: 4,
    ...
    data: [
        {
            ...
            size: 8414449,
            upload_location:
                "https://apis.live.net/v5.0/file.a6b2a7e8f2515e5e.A6B2A7E8F2515E5E!144/content/",
            comments_count: 0,
            ...
            duration: 225000,
            picture:
                "https://storage.live.com/items/A6B2A7E8F2515E5E!144:MobileReady/SampleAudio.mp3?psid=1&ck=0&ex=720",
            shared_with: {
                access: "Just me",
            },
        ...
        data: [
            {
                ...
                description:
                    "If you have birthdays listed for your contacts, they'll appear on this calendar. You can add more birthdays, but you can't add other types of events.",
    ...
    data: [
        {
            ...
            size: 12692,
            upload_location:
                "https://apis.live.net/v5.0/file.22688711f5410e6c.22688711F5410E6C!942/content/",
            comments_count: 0,
    ...
    data: [
        {
            ...
            is_embeddable: true,
            picture:
                "http://storage.live.com/s1pKk5vzd-gdPanbzKYhB0nQGn8wGq5DSgqvrgIHU1NTXA4e2-spGkAhQjW1d9pcgKAGLB4NsEsSvDoREmdx5w-JiFrinEJJuEoz08Ws_IFupkX2bPSvy5qmths9ijwvDrXi1OBCWk9GW9Kt-qNNOAA9g/Maui09_0034.JPG:Thumbnail",
            ...
            upload_location:
                "https://apis.live.net/v5.0/file.de57f4126ed7e411.DE57F4126ED7E411!128/content/",
            images: [
                {
                    height: 450,
                    width: 600,
    ...
    data: [
        {
            ...
            is_embeddable: true,
            picture:
                "http://storage.live.com/s1pKk5vzd-gdPaJ5Q1MKN34itsyRlUkAYzD_zsr0Dg-5r4bH8Qo8XRgsunA0M-V4G-XPpu1spowx4xwfjCuDcWQVa7aWld2WCdfeWjBK_coPqaQqzoE26BJP3OZAITB5i_DRPK8jK3ZLilSbNJd-onrOA/Wildlife.wmv:Thumbnail",
            ...
            upload_location:
                "https://apis.live.net/v5.0/file.de57f4126ed7e411.DE57F4126ED7E411!135/content/",
...
function getFiles() {
    ...
    WL.api<Microsoft.Live.IObjectCollection<Microsoft.Live.IObject>>({
        path: files_path,
        method: "GET",
    }).then(onGetFilesComplete, function (response) {
        log(
            "Cannot get files and folders: " +
...
function onGetFilesComplete(
    response: Microsoft.Live.IObjectCollection<Microsoft.Live.IObject>,
) {
    ...
    for (var i = 0; i < items.length; i++) {
        if (items[i].type === "folder") {
            log(
                "Found a folder with the following information: " +
...
function showUserContactInfo() {
    WL.api<Microsoft.Live.IUser>({ path: "/me", method: "GET" }).then(
        function (response) {
            log(
                "Addresses: " +
                    JSON.stringify(response.addresses).replace(/,/g, "\n"),
            );
            log(
                "Phone Numbers: " +
                    JSON.stringify(response.phones).replace(/,/g, "\n"),
            );
            log(
                "Email Addresses: " +
                    JSON.stringify(response.emails).replace(/,/g, "\n"),
            );
        },
        function (response) {
            log(
    ...
    WL.api<Microsoft.Live.IUser>({ path: "/me", method: "GET" }).then(
        function (response) {
            ...
            if (year - user.birth_year >= 18) {
                ...
                log(
                    "Purchase disabled. You are only " +
                        user.birth_year +
                        " year(s) old.",
                );
            }
...
function createEvent() {
    ...
    WL.api({
        ...
        function (response) {
            log(
                "Successfully created event. Response: " +
