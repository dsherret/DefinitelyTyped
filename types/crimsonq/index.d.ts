...
declare class CrimsonQEventEmitter extends EventEmitter {
    on(
        ...
        listener: (msg: RecievedMessage) => void,
    ): this;
}
...
declare class RecievedMessage {
    ...
    fail(
        errorMessage: string,
    ): Promise<CommandResult | typeof Error | undefined>;
}
...
interface Command {
    ...
    consumer_flush_failed(
        consumerId: string,
        messageId: string,
    ): Promise<CommandResult | typeof Error>;
    consumer_flush_completed(
        consumerId: string,
    ): Promise<CommandResult | typeof Error>;
    msg_retry(
        consumerId: string,
