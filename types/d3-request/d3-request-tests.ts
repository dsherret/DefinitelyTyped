...
let listenerXhr:
    | ((this: d3Request.Request, xhr: XMLHttpRequest) => void)
    | undefined;

let listenerProgress:
    | ((this: d3Request.Request, progEvent: ProgressEvent) => void)
    | undefined;

let listenerError: ((this: d3Request.Request, error: any) => void) | undefined;

let listenerResult:
    | ((this: d3Request.Request, result: ResponseDatumGET[]) => void)
    | undefined;
...
const requestWithCallback: d3Request.Request = d3Request.request(
    url,
    (error, xhr) => {
        if (!error) {
...
// with request datum
const r3: d3Request.Request = d3Request
    .request(url)
...
const r5: d3Request.Request = d3Request
    .request(url)
    .response(xhr2Listing)
    .get<RequestDatumGET, ResponseDatumGET[]>(
        { kind: "Listing" },
        (error, response) => {
            if (!error) {
                const r: ResponseDatumGET[] = response;
...
// with request datum
const r13: d3Request.Request = d3Request
    .request(url)
...
const r15: d3Request.Request = d3Request
    .request(url)
    .response(xhr2Success)
    .post<RequestDatumPOST, ResponseDatumPOST>(
        { test: "NewValue", value: 10 },
...
const r16: d3Request.Request = d3Request
    .request(url)
...
// get
const responseType: XMLHttpRequestResponseType | undefined = d3Request
    .request(url)
    .responseType();
// set
...
const r19: d3Request.Request = d3Request
    .request(url)
...
const r21: d3Request.Request = d3Request
    .request(url)
    .response(xhr2Listing)
    .send<RequestDatumGET, ResponseDatumGET[]>(
        "GET",
        { kind: "Listing" },
        (error, response) => {
            if (!error) {
...
const htmlWithCallback: d3Request.Request = d3Request.html(
    url,
    function (error, data) {
        const that: d3Request.Request = this;
        const err: any = error;
...
const jsonWithCallback: d3Request.Request = d3Request.json<ResponseDatumGET[]>(
    url,
    function (error, data) {
        const that: d3Request.Request = this;
        const err: any = error;
...
const textWithCallback: d3Request.Request = d3Request.text(
    url,
    function (error, data) {
        const that: d3Request.Request = this;
        const err: any = error;
...
const xmlWithCallback: d3Request.Request = d3Request.xml(
    url,
    function (error, data) {
        const that: d3Request.Request = this;
        const err: any = error;
...
const csvRequestWithCallback: d3Request.DsvRequest = d3Request.csv(
    url,
    function (error, data) {
...
const csvRequestWithRowWithCallback: d3Request.DsvRequest =
    d3Request.csv<ResponseDatumGET>(
        url,
...
// url and callback for response handling
const tsvRequestWithCallback: d3Request.DsvRequest = d3Request.tsv(
    url,
    function (error, data) {
        const that: d3Request.DsvRequest = this;
        const err: any = error;
...
// url, row mapping function and callback for response handling
const tsvRequestWithRowWithCallback: d3Request.DsvRequest =
    d3Request.tsv<ResponseDatumGET>(
        url,
        (rawRow, index, columns) => {
            const rr: DSVRowString = rawRow;
            const i: number = index;
