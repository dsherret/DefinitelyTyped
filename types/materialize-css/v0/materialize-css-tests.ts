...
let options = [
    { selector: ".class", offset: 200, callback: 'console.log(".class")' },
    {
        ...
        offset: 200,
        callback: 'console.log(".other-class")',
    },
];
...
$(tabsHtml).tabs({
    onShow: (currentTab: any) => console.log(currentTab),
    swipeable: false,
    responsiveThreshold: 5000,
});
...
let chipData: Materialize.ChipDataObject | Materialize.ChipDataObject[] =
