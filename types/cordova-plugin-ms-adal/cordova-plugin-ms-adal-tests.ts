function test_cordova_plugin_ms_adal() {
    var testConfiguration = {
        authority:
            "https://login.microsoftonline.com/testtenant.onmicrosoft.com",
    ...
    Microsoft.ADAL.AuthenticationContext.createAsync(
        testConfiguration.authority,
    ).then(
        (context) => {
                ...
                if (cacheItems.length >= 1) {
                    ...
                    context
                        ...
                        .then(
                            (authResult) => {
                                console.log(
                                    "Silently acquired token successfully",
                                );
                            },
                            (err) => {
                                console.log(
