    ...
    render() {
        return (
            <Tabs onChange={this.onChange} renderActiveTabContentOnly>
                <TabLink to="tab1" onClick={this.onClick}>
                    Tab1
                </TabLink>
                <TabLink to="tab2" default>
                    Tab2
                </TabLink>
                <TabLink to="tab3" activeStyle={{ color: "blue" }}>
                    Tab3
                </TabLink>

                <TabContent for="tab1" disableInlineStyles>
                    Content1
                </TabContent>
                <TabContent for="tab2" className="test">
                    Content2
                </TabContent>
                <TabContent for="tab3" isVisible={false}>
                    Content3
                </TabContent>
            </Tabs>
        );
