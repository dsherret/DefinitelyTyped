...
const propTypes: PropTypes.ValidationMap<Props> = {
    ...
    mapOfNoKey: ImmutablePropTypes.mapOf(PropTypes.number.isRequired)
        .isRequired,
    ...
    orderedSetOf: ImmutablePropTypes.orderedSetOf(PropTypes.string.isRequired)
        .isRequired,
    stackOf: ImmutablePropTypes.stackOf(PropTypes.string.isRequired).isRequired,
    iterableOf: ImmutablePropTypes.iterableOf(PropTypes.string.isRequired)
        .isRequired,
