...
export function mapOf<V, K = any>(
    valueType: Validator<V>,
    keyType?: Validator<K>,
): Requireable<Immutable.Map<K, V>>;
...
export function orderedSetOf<V>(
    type: Validator<V>,
): Requireable<Immutable.OrderedSet<V>>;
export function stackOf<V>(type: Validator<V>): Requireable<Immutable.Stack<V>>;
export function iterableOf<V>(
    type: Validator<V>,
): Requireable<Immutable.Iterable<any, V>>;
...
export function recordOf(
    type: ValidationMap<any>,
): Requireable<Immutable.Map<string, any>>;
export function shape(
    type: ValidationMap<any>,
): Requireable<Immutable.Iterable<any, any>>;
export function contains(
    type: ValidationMap<any>,
): Requireable<Immutable.Iterable<any, any>>;
export function mapContains(
    type: ValidationMap<any>,
): Requireable<Immutable.Map<any, any>>;
