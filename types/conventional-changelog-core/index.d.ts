...
import {
    ExecOptions as GitRawExecOptions,
    GitOptions as BaseGitRawCommitsOptions,
} from "git-raw-commits";
 ...
 * @param writerOpts
 */
declare function conventionalChangelogCore<
    TCommit extends Commit = Commit,
    TContext extends BaseContext = Context,
>(
    ...
    namespace Options {
        ...
        namespace Config {
            type FunctionType<
                TCommit extends Commit = Commit,
                TContext extends BaseContext = BaseContext,
            > = (callback: FunctionType.Callback<TCommit, TContext>) => void;

            namespace FunctionType {
                type Callback<
                    TCommit extends Commit = Commit,
                    TContext extends BaseContext = BaseContext,
                > = (error: any, config: ObjectType<TCommit, TContext>) => void;
            }
        ...
        interface Pkg {
             ...
             */
            transform?:
                | ((pkg: Record<string, any>) => Record<string, any>)
                | undefined;
        }
        ...
        interface Transform<T extends Commit = Commit> {
            ...
            (
                ...
                commit: Commit,
                cb: Transform.Callback<T>,
            ): void;
        }

        namespace Transform {
            type Callback<T extends Commit = Commit> = (
                error: any,
                commit: T,
            ) => void;
        }
