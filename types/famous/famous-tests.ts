import { FamousEngine, Node, Size } from "famous/core";
import { DOMElement } from "famous/dom-renderables";
import { Quaternion, Vec3 } from "famous/math";
import { Box, PhysicsEngine, RotationalSpring } from "famous/physics";
...
function test_seed() {
    ...
    new DOMElement(logo, { tagName: "img" }).setAttribute(
        "src",
        "./images/famous_logo.png",
    );
