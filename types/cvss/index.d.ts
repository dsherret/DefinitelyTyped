...
export function getBaseScore(
    input: string,
    options?: Omit<CVSSOptions, "baseOnly">,
): number;

//  Accepts the same arguments as getScore above, but enforces the temporal option.
export function getTemporalScore(
    input: string,
    options?: Omit<CVSSOptions, "temporal">,
): number;

//  Accepts the same arguments as getScore above, but enforces the temporal option.
export function getEnvironmentalScore(
    input: string,
    options?: Omit<CVSSOptions, "env">,
): number;
