...
function test_camera() {
    ...
    function onPhotoDataSuccess(imageData) {
        var smallImage = <HTMLImageElement>(
    ...
    function onPhotoURISuccess(imageURI) {
        var largeImage = <HTMLImageElement>(
...
function test_capture() {
    ...
    navigator.device.capture.captureImage(captureSuccess2, captureError2, {
        limit: 2,
    });
    ...
    function captureVideo() {
        navigator.device.capture.captureVideo(captureSuccess2, captureError2, {
            limit: 2,
        });
    }
}
...
function test_contacts() {
    ...
    console.log(
        "The contact, " + myContact.displayName + ", note: " + myContact.note,
    );
