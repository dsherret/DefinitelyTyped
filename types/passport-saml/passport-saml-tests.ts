...
const decryptMetadata: string =
    samlStrategy.generateServiceProviderMetadata("decryptionCert");
const signMetadata: string = samlStrategy.generateServiceProviderMetadata(
    null,
    "signingCert",
);
const metadata: string = samlStrategy.generateServiceProviderMetadata(
    "decryptionCert",
    "signingCert",
);
...
const multiSamlStrategy = new MultiSamlStrategy(
    {
        ...
        getSamlOptions(
            req: express.Request,
            callback: MultiSamlStrategy.SamlOptionsCallback,
        ) {
            callback(null, {
                name: "samlCustomName",
...
const multiDecryptionMetadata: never =
    multiSamlStrategy.generateServiceProviderMetadata("decryptionCert");
const multiSigningMetadata: never =
    multiSamlStrategy.generateServiceProviderMetadata(null, "signingCert");
const multiMetadata: never = multiSamlStrategy.generateServiceProviderMetadata(
    "decryptionCert",
    "signingCert",
);

const multiDecryptionMetadataAsync: string =
    multiSamlStrategy.generateServiceProviderMetadata(
        req,
        "decryptionCert",
        null,
        () => "",
    );
const multiSigningMetadataAsync: string =
    multiSamlStrategy.generateServiceProviderMetadata(
        req,
        null,
        "signingCert",
...
const multiMetadataAsync: string =
    multiSamlStrategy.generateServiceProviderMetadata(
        req,
        "decryptionCert",
        "signingCert",
