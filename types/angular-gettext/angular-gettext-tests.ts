...
angular
    ...
    .controller(
        "helloController",
        function (gettext: angular.gettext.gettextFunction) {
...
angular
    ...
    .controller(
        "helloController",
        function (gettextCatalog: angular.gettext.gettextCatalog) {
...
angular
    ...
    .controller(
        "helloController",
        function (gettextCatalog: angular.gettext.gettextCatalog) {
            var myString2: string = gettextCatalog.getPlural(
                3,
                "Bird",
                "Birds",
            );
            var myStringWithScope: string = gettextCatalog.getPlural(
                4,
                "{{color}} Bird",
                "{{color}} Birds",
                { color: "Blue" },
            );
            var myStringWithContext: string = gettextCatalog.getPlural(
                5,
                "pick",
                "picks",
                null,
...
angular
    ...
    .controller(
        "helloController",
        function (gettextCatalog: angular.gettext.gettextCatalog) {
            var translated: string = gettextCatalog.getString(
                "Hello {{name}}",
                {
                    name: "Ruben",
                },
