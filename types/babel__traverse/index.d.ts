...
export namespace visitors {
    ...
    function explode<S = unknown>(
        ...
        [Type in Exclude<Node, t.DeprecatedAliases>["type"]]?: VisitNodeObject<
            S,
            Extract<Node, { type: Type }>
        >;
    };
...
export type VisitNode<S, P extends Node> =
    | VisitNodeFunction<S, P>
    | VisitNodeObject<S, P>;

export type VisitNodeFunction<S, P extends Node> = (
    this: S,
    path: NodePath<P>,
    state: S,
) => void;
...
export type NodePaths<T extends Node | readonly Node[]> =
...
type NodeListType<N, K extends keyof N> = N[K] extends Array<infer P>
    ? P extends Node
        ? P
        : never
    : never;
...
export class NodePath<T = Node> {
    ...
    static get<C extends Node, L extends NodeKeyOfArrays<C>>(opts: {
        ...
        listKey: L;
        key: number;
    }): C[L] extends Array<Node | null | undefined>
        ? NodePath<C[L][number]>
        : never;
     ...
     */
    replaceWithMultiple<
        Nodes extends Node | readonly Node[] | [Node, ...Node[]],
    >(nodes: Nodes): NodePaths<Nodes>;
    ...
    replaceInline<Nodes extends Node | readonly Node[] | [Node, ...Node[]]>(
        nodes: Nodes,
    ): NodePaths<Nodes>;
    // #endregion
    ...
    arrowFunctionToExpression({
        ...
        | Exclude<t.Function, t.Method | t.ArrowFunctionExpression>
        | t.CallExpression
    >;
    ...
    insertBefore<Nodes extends NodesInsertionParam<Node>>(
        nodes: Nodes,
    ): NodePaths<Nodes>;
     ...
     */
    insertAfter<Nodes extends NodesInsertionParam<Node>>(
        nodes: Nodes,
    ): NodePaths<Nodes>;
