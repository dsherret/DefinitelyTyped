...
rest.get("http://twaud.io/api/v1/users/danwrong.json").on(
    "complete",
    function (data) {
...
rest.get("http://twaud.io/api/v1/users/danwrong.xml").on(
    "complete",
    function (data) {
...
var jsonData = { id: 334 };
rest.postJson("http://example.com/action", jsonData).on(
    "complete",
...
var jsonData = { id: 334 };
rest.putJson("http://example.com/action", jsonData).on(
    "complete",
    function (data, response) {
        // handle response
    },
...
rest.postJson("http://example.com/action", jsonData, options).on(
    "complete",
    function (data, response) {
        // handle response
    },
...
var jsonData = { id: 334 };
var options = { query: { "api-version": "1.0" } };
rest.putJson("http://example.com/action", jsonData, options).on(
    "complete",
    function (data, response) {
        // handle response
    },
