...
export function calculateEnvelope(geojson: GeoJSON.GeoJSON): {
    x: number;
    y: number;
    w: number;
    h: number;
};
export function positionToGeographic(
    position: GeoJSON.Position,
): GeoJSON.Position;
export function positionToMercator(
    position: GeoJSON.Position,
): GeoJSON.Position;
...
export function within(
    ...
    comparisonGeojson: GeoJSON.GeoJSON,
): boolean;
