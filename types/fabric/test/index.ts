...
function sample8() {
    ...
    function onObjectSelected(e: fabric.IEvent) {
        ...
        lockHorizontallyEl.innerHTML = selectedObject.lockMovementX
            ? "Unlock horizontal movement"
            : "Lock horizontal movement";
        lockVerticallyEl.innerHTML = selectedObject.lockMovementY
            ? "Unlock vertical movement"
            : "Lock vertical movement";
...
function sample15() {
    const canvas = new fabric.Canvas("c");
    const textRTL = new fabric.Text("שלום עולם", {
        left: 100,
        top: 100,
        direction: "rtl",
        originX: "right",
