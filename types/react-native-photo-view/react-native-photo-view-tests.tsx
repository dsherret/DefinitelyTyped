...
const test: React.FC = () => (
    <ReactNativePhotoView
        source={{
            uri: "https://assets-cdn.github.com/images/modules/logos_page/GitHub-Logo.png",
        }}
        loadingIndicatorSource={{
            uri: "https://assets-cdn.github.com/images/modules/logos_page/GitHub-Mark.png",
        }}
        fadeDuration={100}
        minimumZoomScale={0}
        maximumZoomScale={1}
