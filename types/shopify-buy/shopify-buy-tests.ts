...
client.product.fetch(productId).then((product) => {
    ...
    // $ExpectType string
    client.image.helpers.imageForSize(variant.image, {
        maxWidth: 50,
        maxHeight: 50,
    });
});
...
const checkoutId =
    "gid://shopify/Checkout/e3bd71f7248c806f33725a53e33931ef?key=47092e448529068d1be52e5051603af8";
...
client.checkout
    .addDiscount(checkoutId, "best-discount-ever")
    .then((checkout) => {
        // $ExpectType Checkout
        checkout;
        // $ExpectType CheckoutLineItem[]
