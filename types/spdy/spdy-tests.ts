...
describe("SPDY Client", () => {
    describe("regular", () => {
        fixtures.everyConfig(
            (protocol: any, npn: string, version: string, plain: boolean) => {
                let server: any;
                let agent: any;
                let hmodule: any;
                ...
                it("should send POST request", (done: any) => {
                    ...
                    agent._spdyState.socket.once(
                        plain ? "connect" : "secureConnect",
                        () => {
                            req.end("post body");
                        },
                    );
    ...
    describe("x-forwarded-for", () => {
        fixtures.everyConfig(
            (protocol: any, npn: any, version: string, plain: boolean) => {
                let server: any;
                let agent: any;
                let hmodule: any;
...
describe("SPDY Server", () => {
    fixtures.everyConfig(
        (protocol: any, npn: any, version: number, plain: boolean) => {
