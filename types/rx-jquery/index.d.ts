...
interface JQuery {
    ...
    bindAsObservable<T extends BaseJQueryEventObject>(
        eventType: string,
        eventData?: any,
    ): Rx.Observable<T>;
    ...
    focusoutAsObservable(
        eventData?: any,
    ): Rx.Observable<JQueryInputEventObject>;
    ...
    mouseoutAsObservable(
        eventData?: any,
    ): Rx.Observable<JQueryMouseEventObject>;
    mouseoverAsObservable(
        eventData?: any,
    ): Rx.Observable<JQueryMouseEventObject>;
