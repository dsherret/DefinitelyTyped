...
declare namespace VoxImplant {
    ...
    interface Client {
         ...
         */
        setVideoSettings(
            settings: VideoSettings | FlashVideoSettings,
            successCallback?: () => any,
            failedCallback?: () => any,
        ): void;
        /**
    ...
    interface Call {
        ...
        addEventListener(
            ...
            eventHandler: (eventObject: VoxImplantCallEvent) => any,
        ): void;
        /**
