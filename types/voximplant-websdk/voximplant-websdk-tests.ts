...
vox.addEventListener(
    ...
    function (event: VoxImplant.EventTypes.SDKReady) {
...
vox.addEventListener(
    ...
    function (event: VoxImplant.EventTypes.ConnectionClosed) {
...
vox.addEventListener(
    ...
    function (event: VoxImplant.EventTypes.ConnectionFailed) {
...
vox.addEventListener(
    ...
    function (event: VoxImplant.EventTypes.AuthResult) {
        if (event.result === true) {
            ...
            call.addEventListener(
                ...
                function (callevent: VoxImplant.CallEventTypes.Failed) {
            ...
            var msg_id: String = vox.sendInstantMessage(
                "other_user",
                "Hello World!",
            );
        } else {
...
vox.addEventListener(
    ...
    function (event: VoxImplant.EventTypes.MicAccessResult) {
...
vox.addEventListener(
    ...
    function (event: VoxImplant.EventTypes.IncomingCall) {
        call = event.call;
        call.addEventListener(
            VoxImplant.CallEvents.Connected,
            function (callevent: VoxImplant.CallEventTypes.Connected) {
...
vox.addEventListener(
    ...
    function (event: VoxImplant.IMEventTypes.MessageReceived) {
        console.log(
            "Message received: " +
                event.content +
                " from " +
...
vox.addEventListener(
    ...
    function (event: VoxImplant.EventTypes.SourcesInfoUpdated) {
...
vox.addEventListener(
    ...
    function (event: VoxImplant.IMEventTypes.RosterReceived) {
...
vox.addEventListener(
    ...
    function (event: VoxImplant.IMEventTypes.ChatRoomBanList) {
        console.log(
            "Banned participants: " +
                event.participants +
                " in room " +
