...
function test_Context(ctx: LocalMocha.Context, runnable: LocalMocha.Runnable) {
    ...
    ctx.retries(number).runnable(runnable).slow(number).timeout(number).skip();
}
...
function test_suite_events(suite: LocalMocha.Suite) {
    ...
    // $ExpectType Suite
    suite.on(
        LocalMocha.Suite.constants.EVENT_SUITE_ADD_HOOK_BEFORE_ALL,
        (hook) => {
            // $ExpectType Hook
            hook;
        },
    ...
    // $ExpectType Suite
    suite.on(
        LocalMocha.Suite.constants.EVENT_SUITE_ADD_HOOK_AFTER_ALL,
        (hook) => {
            // $ExpectType Hook
            hook;
        },
    ...
    // $ExpectType Suite
    suite.on(
        LocalMocha.Suite.constants.EVENT_SUITE_ADD_HOOK_BEFORE_EACH,
        (hook) => {
            // $ExpectType Hook
            hook;
        },
    ...
    // $ExpectType Suite
    suite.on(
        LocalMocha.Suite.constants.EVENT_SUITE_ADD_HOOK_AFTER_EACH,
        (hook) => {
            // $ExpectType Hook
            hook;
        },
    ...
    // $ExpectType Suite
    suite.on(
        LocalMocha.Suite.constants.EVENT_FILE_PRE_REQUIRE,
        (context, file, mocha) => {
            // $ExpectType MochaGlobals
            context;
            // $ExpectType string
    ...
    suite.on(
        LocalMocha.Suite.constants.EVENT_FILE_REQUIRE,
        (module, file, mocha) => {
            // $ExpectType any
            module;
            // $ExpectType string
    ...
    suite.on(
        LocalMocha.Suite.constants.EVENT_FILE_POST_REQUIRE,
        (context, file, mocha) => {
            // $ExpectType MochaGlobals
            context;
            // $ExpectType string
