...
export declare function check(uuid: string | Buffer): {
...
export declare function v1(options: {
    encoding: "ascii";
...
export declare function v1(
    options: { mac?: boolean | undefined },
    callback: ASCIICallback,
): void;
export declare function v1(
    options: { encoding: "ascii"; mac?: boolean | undefined },
    callback: ASCIICallback,
): void;
export declare function v1(
    options: { encoding: "binary"; mac?: boolean | undefined },
    callback: BinaryCallback,
): void;
export declare function v1(
    options: { encoding: "object"; mac?: boolean | undefined },
    callback: ObjectCallback,
): void;
export declare function v1(callback: ASCIICallback): void;

export declare function v3(options: {
    namespace: UuidTypes;
    name: string;
}): string;
export declare function v3(options: {
...
export declare function v3(
    options: { namespace: UuidTypes; name: string },
    callback: ASCIICallback,
): void;
export declare function v3(
...
export declare function v4fast(
    options: { encoding: "ascii" },
    callback: ASCIICallback,
): void;
export declare function v4fast(
...
export declare function v5(options: {
    namespace: UuidTypes;
    name: string;
}): string;
export declare function v5(options: {
