...
if (!state.isEnabled || !state.isDataValid) {
    console.log(
        "gyro X:" +
            state.gyroX.toString() +
            " Y:" +
            state.gyroY.toString() +
            " Z:" +
            state.gyroZ.toString(),
    );
    console.log(
        "angle X:" +
            state.angleX.toString() +
            " Y:" +
            state.angleY.toString() +
            " Z:" +
            state.angleZ.toString(),
    );
    console.log(
        "dirX X:" +
            state.dirXx.toString() +
            " Y:" +
            state.dirXy.toString() +
            " Z:" +
            state.dirXz.toString(),
    );
    console.log(
        "dirY X:" +
            state.dirYx.toString() +
            " Y:" +
            state.dirYy.toString() +
            " Z:" +
            state.dirYz.toString(),
    );
    console.log(
        "dirZ X:" +
            state.dirZx.toString() +
            " Y:" +
            state.dirZy.toString() +
            " Z:" +
            state.dirZz.toString(),
    );
    console.log(
        "acc X:" +
            state.accX.toString() +
    ...
    console.log(
        "LStick axis X:" +
            state.lStickX.toString() +
            " Y:" +
            state.lStickY.toString(),
    );
    console.log(
        "RStick axis X:" +
            state.rStickX.toString() +
            " Y:" +
            state.rStickY.toString(),
    );
    ...
    if (state.tpTouch && state.tpValidity == window.wiiu.TPValidity.VALID) {
        console.log(
            "touch X:" +
                state.contentX.toString() +
                " Y:" +
                state.contentY.toString(),
        );
    }
}
...
document
    ...
    .addEventListener("wiiu_videoplayer_end", (e) => {
        console.log(e);
