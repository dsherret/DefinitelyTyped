...
declare interface PublishCompositeConfig2<InLevel1, InLevel2, OutLevel> {
    collectionName?: string | undefined;
    children?:
        | Array<PublishCompositeConfig3<InLevel1, InLevel2, OutLevel, any>>
        | undefined;
...
declare interface PublishCompositeConfig1<InLevel1, OutLevel> {
    collectionName?: string | undefined;
    children?:
        | Array<PublishCompositeConfig2<InLevel1, OutLevel, any>>
        | undefined;
...
declare module "meteor/reywood:publish-composite" {
    function publishComposite(
        ...
        config:
            ...
            | Array<PublishCompositeConfig<any>>,
    ): void;
    ...
    function publishComposite(
        ...
        configFunc: (
            ...args: any[]
        ) => PublishCompositeConfig<any> | Array<PublishCompositeConfig<any>>,
    ): void;
}
