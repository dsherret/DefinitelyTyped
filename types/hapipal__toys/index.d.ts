...
export function onPreAuth(
    method: Lifecycle.Method,
    options?: ServerExtOptions,
): ServerExtEventsObject;
export function onCredentials(
    method: Lifecycle.Method,
    options?: ServerExtOptions,
): ServerExtEventsObject;
export function onPostAuth(
    method: Lifecycle.Method,
    options?: ServerExtOptions,
): ServerExtEventsObject;
export function onPreHandler(
    method: Lifecycle.Method,
    options?: ServerExtOptions,
): ServerExtEventsObject;
export function onPostHandler(
    method: Lifecycle.Method,
    options?: ServerExtOptions,
): ServerExtEventsObject;
export function onPreResponse(
    method: Lifecycle.Method,
    options?: ServerExtOptions,
): ServerExtEventsObject;
export function onPostResponse(
    method: Lifecycle.Method,
    options?: ServerExtOptions,
): ServerExtEventsObject;
...
export function reacher(
    chain: string | Array<string | number>,
    options?: ReacherOptions,
): PerformReach;
...
export function getHeaders(response: ResponseObject | Boom): {
...
export namespace auth {
    type ServerAuthSchemeAuthenticate = (
        request: Request,
        h: ResponseToolkit,
    ...
    function strategy(
        server: Server,
        name: string,
        authenticate: ServerAuthSchemeAuthenticate,
    ): ServerAuthScheme;
}
...
export function stream(
    stream: Stream,
    options?: StreamOptions & FinishedOptions,
): Promise<void>;

export type TypesWithRealmsAndOptions =
    | Server
    | Request
    | ResponseToolkit
    | ServerRealm
...
export function forEachAncestorRealm(
    realm: ServerRealm,
    fn: AncestorRealmIterator,
): void;

export function asyncStorage(identifier: string): any;
export function withAsyncStorage<T>(
    identifier: string,
    value: T,
    fn: () => void,
): Promise<T>;
