...
interface IArticleResourceClass
    extends ng.resource.IResourceClass<IArticleResource> {
...
function MainController($resource: ng.resource.IResourceService): void {
    ...
    const articleResource: IArticleResourceClass = $resource<
        IArticleResource,
        IArticleResourceClass
    >("/articles/:id", null, {
    ...
    const article: IArticleResource = articleResource.get(
        { id: 1 },
...
interface IMyResourceClass
    extends angular.resource.IResourceClass<IMyResource> {}
...
resourceArray.$promise.then(function (
    data: angular.resource.IResourceArray<IMyResource>,
) {});
...
resourceClass =
    resourceServiceFactoryFunction<IMyResourceClass>(resourceService);

resourceServiceFactoryFunction = function (
    resourceService: angular.resource.IResourceService,
) {
