...
const plonkProof: PlonkProof = {
    ...
    eval_s1:
        "979333877398830052547900274017506995596964833187983525661303685186244579490",
    eval_s2:
        "21443594391826970778175657320856415823268100462784076904799758237152719763447",
    eval_zw:
        "18406662926608046172692961509498301086368998024264748619459902470430300626404",
    protocol: "plonk",
    curve: "bn128",
};
