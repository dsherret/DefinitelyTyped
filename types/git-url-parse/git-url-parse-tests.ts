...
gitUrlParse("git@github.com:IonicaBizau/node-git-url-parse.git").toString(
    "git+ssh",
); // $ExpectType string

gitUrlParse.stringify(
    gitUrlParse("git@github.com:IonicaBizau/node-git-url-parse.git"),
); // $ExpectType string
gitUrlParse.stringify(
    gitUrlParse("git@github.com:IonicaBizau/node-git-url-parse.git"),
    "https",
