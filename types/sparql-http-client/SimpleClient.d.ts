...
declare namespace SimpleClient {
    type SimpleClientOptions<Q extends BaseQuad = Quad> = EndpointOptions &
        Pick<ClientOptions<RawQuery, Q>, "factory">;

    type SimpleClient<Q extends BaseQuad = Quad> = Client<RawQuery, Q>;
}

declare class SimpleClient<Q extends BaseQuad = Quad>
    extends BaseClient<RawQuery>
