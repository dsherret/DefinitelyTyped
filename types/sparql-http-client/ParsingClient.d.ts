...
declare namespace ParsingClient {
    type ParsingClientOptions<Q extends BaseQuad = Quad> = EndpointOptions &
        Pick<ClientOptions<ParsingQuery, Q>, "factory">;

    type ParsingClient<Q extends BaseQuad = Quad> = Client<ParsingQuery<Q>, Q>;
}

declare class ParsingClient<Q extends BaseQuad = Quad>
    extends BaseClient<ParsingQuery<Q>, Q>
