...
>;
export type TableauEventFilterChange = Extract<
    TableauEventName,
    TableauEventName.FILTER_CHANGE
>;
export type TableauEventMarks = Extract<
    TableauEventName,
    TableauEventName.MARKS_HIGHLIGHT | TableauEventName.MARKS_SELECTION
>;
export type TableauEventParameterChange = Extract<
    TableauEventName,
    TableauEventName.PARAMETER_VALUE_CHANGE
>;
export type TableauEventStoryPointSwitch = Extract<
    TableauEventName,
    TableauEventName.STORY_POINT_SWITCH
>;
export type TableauEventTabSwitch = Extract<
    TableauEventName,
    TableauEventName.TAB_SWITCH
>;
export type TableauEventToolbarStateChange = Extract<
    TableauEventName,
    TableauEventName.TOOLBAR_STATE_CHANGE
>;
export type TableauEventUrlAction = Extract<
    TableauEventName,
    TableauEventName.URL_ACTION
>;
export type TableauEventVizResize = Extract<
    TableauEventName,
    TableauEventName.VIZ_RESIZE
>;
...
export class Viz {
    ...
    // events
    addEventListener(
        type: TableauEventCustomView,
        listener: (event: CustomViewEvent) => void,
    ): void;
    addEventListener(
        type: TableauEventFilterChange,
        listener: (event: FilterEvent) => void,
    ): void;
    addEventListener(
        type: TableauEventMarks,
        listener: (event: MarksEvent) => void,
    ): void;
    addEventListener(
        type: TableauEventParameterChange,
        listener: (event: ParameterEvent) => void,
    ): void;
    addEventListener(
        type: TableauEventStoryPointSwitch,
        listener: (event: StoryPointSwitchEvent) => void,
    ): void;
    addEventListener(
        type: TableauEventTabSwitch,
        listener: (event: TabSwitchEvent) => void,
    ): void;
    addEventListener(
        type: TableauEventToolbarStateChange,
        listener: (event: ToolbarStateEvent) => void,
    ): void;
    addEventListener(
        type: TableauEventUrlAction,
        listener: (event: UrlActionEvent) => void,
    ): void;
    addEventListener(
        type: TableauEventVizResize,
        listener: (event: VizResizeEvent) => void,
    ): void;
    removeEventListener(
        type: TableauEventCustomView,
        listener: (event: CustomViewEvent) => void,
