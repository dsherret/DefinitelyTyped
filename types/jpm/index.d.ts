...
declare module "sdk/hotkeys" {
     ...
     */
    export function Hotkey(options: {
        combo: string;
        onPress: () => void;
    }): Hotkey;
}
        ...
        open: (
            options:
                ...
                | {
                      ...
                      onOpen?:
                          | ((window: FFAddonSDK.BrowserWindow) => any)
                          | undefined;
                      onClose?:
                          | ((window: FFAddonSDK.BrowserWindow) => any)
                          | undefined;
...
declare namespace FFAddonSDK {
    ...
    interface ToggleButton extends ToggleButtonState {
        ...
        on: (
            event: "click" | "change",
            handler: (state: ToggleButtonState) => any,
        ) => void;
        once: (
            event: "click" | "change",
            handler: (state: ToggleButtonState) => any,
    ...
    interface ActionButton extends ActionButtonState {
        ...
        on: (
            event: "click" | "click",
            handler: (state: ActionButtonState) => any,
        ) => void;
        once: (
            event: "click" | "click",
            handler: (state: ActionButtonState) => any,
