...
import initAsmDebugSqlJs, {
    Database as AsmDebugSqlJsDatabase,
} from "sql.js/dist/sql-asm-debug.js";
import initAsmMemoryGrowthSqlJs, {
    Database as AsmMemoryGrowthSqlJsDatabase,
} from "sql.js/dist/sql-asm-memory-growth.js";
import initAsmSqlJs, {
    Database as AsmSqlJsDatabase,
} from "sql.js/dist/sql-asm.js";
import initWasmDebugSqlJs, {
    Database as WasmDebugSqlJsDatabase,
} from "sql.js/dist/sql-wasm-debug.js";
import initWasmSqlJs, {
    Database as WasmSqlJsDatabase,
...
initSqlJs().then((SqlJs) => {
    ...
    const databaseData = fs.existsSync(DB_PATH)
