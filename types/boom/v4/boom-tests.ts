...
const proxyAuthRequiredError2: Boom.BoomError =
...
const preconditionFailedError2: Boom.BoomError =
...
const unsupportedMediaTypeError2: Boom.BoomError =
...
const rangeNotSatisfiableError2: Boom.BoomError =
...
const expectationFailedError2: Boom.BoomError =
...
const preconditionRequiredError2: Boom.BoomError =
...
const badImplementationError2: Boom.BoomError =
...
const serverUnavailableError2: Boom.BoomError =
...
const error1 = Boom.create(500, "Internal server error", {
    timestamp: Date.now(),
});
