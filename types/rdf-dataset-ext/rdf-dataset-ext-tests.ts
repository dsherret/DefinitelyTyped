...
const dataset2addAll2: DatasetCore<BaseQuad> = addAll<
    BaseQuad,
    DatasetCore<BaseQuad>
>(dataset2, iterable2);
const dataset2addAll3: DatasetCore<BaseQuad> = grouped.addAll(
    dataset2,
    iterable2,
);
const dataset2addAll4: DatasetCore<BaseQuad> = grouped.addAll<
    BaseQuad,
    DatasetCore<BaseQuad>
>(dataset2, iterable2);
...
const dataset1deleteMatch4: DatasetCore = deleteMatch(
    dataset1,
    term,
    term,
    term,
);
const dataset1deleteMatch5: DatasetCore = deleteMatch(
    dataset1,
    term,
    term,
    term,
...
const dataset1deleteMatch8: DatasetCore = grouped.deleteMatch(
    dataset1,
    term,
    term,
);
const dataset1deleteMatch9: DatasetCore = grouped.deleteMatch(
    dataset1,
    term,
    term,
    term,
);
const dataset1deleteMatch10: DatasetCore = grouped.deleteMatch(
    dataset1,
    term,
    term,
    term,
...
const dataset2deleteMatch2: DatasetCore<BaseQuad> =
    deleteMatch<DatasetCore<BaseQuad>>(dataset2);
const dataset2deleteMatch3: DatasetCore<BaseQuad> = deleteMatch(dataset2, term);
const dataset2deleteMatch4: DatasetCore<BaseQuad> = deleteMatch(
    dataset2,
    term,
    term,
);
const dataset2deleteMatch5: DatasetCore<BaseQuad> = deleteMatch(
    dataset2,
    term,
    term,
    term,
);
const dataset2deleteMatch6: DatasetCore<BaseQuad> = deleteMatch(
    dataset2,
    term,
    term,
    term,
...
const dataset2deleteMatch7: DatasetCore<BaseQuad> =
    grouped.deleteMatch(dataset2);
const dataset2deleteMatch8: DatasetCore<BaseQuad> =
    grouped.deleteMatch<DatasetCore<BaseQuad>>(dataset2);
const dataset2deleteMatch9: DatasetCore<BaseQuad> = grouped.deleteMatch(
    dataset2,
    term,
);
const dataset2deleteMatch10: DatasetCore<BaseQuad> = grouped.deleteMatch(
    dataset2,
    term,
    term,
);
const dataset2deleteMatch11: DatasetCore<BaseQuad> = grouped.deleteMatch(
    dataset2,
    term,
    term,
    term,
);
const dataset2deleteMatch12: DatasetCore<BaseQuad> = grouped.deleteMatch(
    dataset2,
    term,
    term,
    term,
...
const delete1MatchNulls: DatasetCore = grouped.deleteMatch(
    dataset1,
    null,
    null,
    null,
...
const delete2MatchNulls: DatasetCore<BaseQuad> = grouped.deleteMatch(
    dataset2,
    null,
    null,
    null,
...
const fromStream2: Promise<DatasetCore<BaseQuad>> = fromStream(
    dataset2,
    eventEmitter,
);
const fromStream3: Promise<DatasetCore<BaseQuad>> = fromStream<
    DatasetCore<BaseQuad>
>(dataset2, eventEmitter);
const fromStream4: Promise<DatasetCore> = grouped.fromStream(
    dataset1,
    eventEmitter,
);
const fromStream5: Promise<DatasetCore<BaseQuad>> = grouped.fromStream(
    dataset2,
    eventEmitter,
);
const fromStream6: Promise<DatasetCore<BaseQuad>> = grouped.fromStream<
    DatasetCore<BaseQuad>
>(dataset2, eventEmitter);
...
const toStream6: Readable & Stream<BaseQuad> =
    grouped.toStream<BaseQuad>(dataset2);
