...
var formEncoded2: string = OAuth.formEncode({
    name1: "value1",
    name2: "value2",
});

var formDecoded1: OAuth.ParameterList = OAuth.decodeForm(
    "name1=value1&name2=value2",
);

var message1: OAuth.Message = {
    action: "http://example.org/",
    method: "GET",
    parameters: [],
};
OAuth.setParameter(message1, "name1", "value1");
var message2: OAuth.Message = {
    action: "http://example.org/",
    method: "GET",
    parameters: {},
};
...
var accessor: OAuth.Accessor = {
    consumerKey: "ck",
    consumerSecret: "cs",
    token: "t",
    tokenSecret: "ts",
};
var message5: OAuth.Message = {
    action: "http://example.org/",
    method: "GET",
    parameters: [["name1", "value1"]],
};
OAuth.completeRequest(message5, accessor);
var message6: OAuth.Message = {
    action: "http://example.org/",
    method: "GET",
    parameters: { name1: "value1" },
};
...
var message7: OAuth.Message = {
    action: "http://example.org/",
    method: "GET",
    parameters: [["name1", "value1"]],
};
OAuth.setTimestampAndNonce(message7);
var message8: OAuth.Message = {
    action: "http://example.org/",
    method: "GET",
    parameters: { name1: "value1" },
};
...
var url2: string = OAuth.addToURL("http://example.org/?name1=value1", [
    ["name1", "value1"],
]);
var url3: string = OAuth.addToURL("http://example.org/", { name1: "value1" });
var url4: string = OAuth.addToURL("http://example.org/?name1=value1", {
    name1: "value1",
});
...
var authorizationHeader3: string = OAuth.getAuthorizationHeader(
    "realm",
    "name1=value1&oauth_param1=oauth_value1",
);
...
var message9: OAuth.Message = {
    method: "GET",
    action: "http://example.org/1",
    parameters: [],
};
var baseString: string = OAuth.SignatureMethod.getBaseString(message9);

var normalizedUrl: string = OAuth.SignatureMethod.normalizeUrl(
    "http://example.org:80/2",
);

var uri: OAuth.Uri = OAuth.SignatureMethod.parseUri(
    "http://example.org:80/3?name1=value1&name2=value2",
);
...
var normalizedParameters2: string = OAuth.SignatureMethod.normalizeParameters({
    name1: "value1",
    name2: "value2",
});

var message10: OAuth.Message = {
    action: "http://example.org/",
    method: "GET",
    parameters: [["name1", "value1"]],
};
...
OAuth.SignatureMethod.registerMethodClass(
    ["PLAINTEXT"],
    signatureMethodConstructor,
);

var signatureMethod1: OAuth.SignatureMethod = OAuth.SignatureMethod.newMethod(
    "PLAINTEXT",
    accessor,
);
var message11: OAuth.Message = {
    action: "http://example.org/",
    method: "GET",
    parameters: [["name1", "value1"]],
};
