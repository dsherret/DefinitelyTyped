...
export interface ojSunburst<K, D>
    extends dvtBaseComponent<ojSunburstSettableProperties<K, D>> {
    ...
    onAnimationDurationChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSunburst<K, D>["animationDuration"]
              >,
          ) => any)
        | null;
    onAnimationOnDataChangeChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSunburst<K, D>["animationOnDataChange"]
              >,
          ) => any)
        | null;
    onAnimationOnDisplayChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSunburst<K, D>["animationOnDisplay"]
              >,
          ) => any)
        | null;
    onAnimationUpdateColorChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSunburst<K, D>["animationUpdateColor"]
              >,
          ) => any)
        | null;
    onAsChanged:
        | ((event: JetElementCustomEvent<ojSunburst<K, D>["as"]>) => any)
        | null;
    onColorLabelChanged:
        | ((
              event: JetElementCustomEvent<ojSunburst<K, D>["colorLabel"]>,
          ) => any)
        | null;
    onDataChanged:
        | ((event: JetElementCustomEvent<ojSunburst<K, D>["data"]>) => any)
        | null;
    onDisplayLevelsChanged:
        | ((
              event: JetElementCustomEvent<ojSunburst<K, D>["displayLevels"]>,
          ) => any)
        | null;
    onDrillingChanged:
        | ((event: JetElementCustomEvent<ojSunburst<K, D>["drilling"]>) => any)
        | null;
    onExpandedChanged:
        | ((event: JetElementCustomEvent<ojSunburst<K, D>["expanded"]>) => any)
        | null;
    onHiddenCategoriesChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSunburst<K, D>["hiddenCategories"]
              >,
          ) => any)
        | null;
    onHighlightMatchChanged:
        | ((
              event: JetElementCustomEvent<ojSunburst<K, D>["highlightMatch"]>,
          ) => any)
        | null;
    onHighlightedCategoriesChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSunburst<K, D>["highlightedCategories"]
              >,
          ) => any)
        | null;
    onHoverBehaviorChanged:
        | ((
              event: JetElementCustomEvent<ojSunburst<K, D>["hoverBehavior"]>,
          ) => any)
        | null;
    onHoverBehaviorDelayChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSunburst<K, D>["hoverBehaviorDelay"]
              >,
          ) => any)
        | null;
    onNodeDefaultsChanged:
        | ((
              event: JetElementCustomEvent<ojSunburst<K, D>["nodeDefaults"]>,
          ) => any)
        | null;
    onRootNodeChanged:
        | ((event: JetElementCustomEvent<ojSunburst<K, D>["rootNode"]>) => any)
        | null;
    onRootNodeContentChanged:
        | ((
              event: JetElementCustomEvent<ojSunburst<K, D>["rootNodeContent"]>,
          ) => any)
        | null;
    onRotationChanged:
        | ((event: JetElementCustomEvent<ojSunburst<K, D>["rotation"]>) => any)
        | null;
    onSelectionChanged:
        | ((event: JetElementCustomEvent<ojSunburst<K, D>["selection"]>) => any)
        | null;
    onSelectionModeChanged:
        | ((
              event: JetElementCustomEvent<ojSunburst<K, D>["selectionMode"]>,
          ) => any)
        | null;
    onSizeLabelChanged:
        | ((event: JetElementCustomEvent<ojSunburst<K, D>["sizeLabel"]>) => any)
        | null;
    onSortingChanged:
        | ((event: JetElementCustomEvent<ojSunburst<K, D>["sorting"]>) => any)
        | null;
    onStartAngleChanged:
        | ((
              event: JetElementCustomEvent<ojSunburst<K, D>["startAngle"]>,
          ) => any)
        | null;
    onTooltipChanged:
        | ((event: JetElementCustomEvent<ojSunburst<K, D>["tooltip"]>) => any)
        | null;
    onTouchResponseChanged:
        | ((
              event: JetElementCustomEvent<ojSunburst<K, D>["touchResponse"]>,
          ) => any)
        | null;
    ...
    getProperty<T extends keyof ojSunburstSettableProperties<K, D>>(
        property: T,
    ): ojSunburst<K, D>[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojSunburstSettableProperties<K, D>>,
    ): void;
...
export interface ojSunburstEventMap<K, D>
    extends dvtBaseComponentEventMap<ojSunburstSettableProperties<K, D>> {
    ...
    touchResponseChanged: JetElementCustomEvent<
        ojSunburst<K, D>["touchResponse"]
    >;
}
export interface ojSunburstSettableProperties<K, D>
...
export interface ojSunburstSettablePropertiesLenient<K, D>
    extends Partial<ojSunburstSettableProperties<K, D>> {
    [key: string]: any;
}
export interface ojSunburstNode
    extends JetElement<ojSunburstNodeSettableProperties> {
    ...
    onBorderColorChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["borderColor"]>) => any)
        | null;
    onBorderWidthChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["borderWidth"]>) => any)
        | null;
    onCategoriesChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["categories"]>) => any)
        | null;
    onColorChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["color"]>) => any)
        | null;
    onDrillingChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["drilling"]>) => any)
        | null;
    onLabelChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["label"]>) => any)
        | null;
    onLabelDisplayChanged:
        | ((
              event: JetElementCustomEvent<ojSunburstNode["labelDisplay"]>,
          ) => any)
        | null;
    onLabelHalignChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["labelHalign"]>) => any)
        | null;
    onLabelStyleChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["labelStyle"]>) => any)
        | null;
    onPatternChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["pattern"]>) => any)
        | null;
    onRadiusChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["radius"]>) => any)
        | null;
    onSelectableChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["selectable"]>) => any)
        | null;
    onShortDescChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["shortDesc"]>) => any)
        | null;
    onShowDisclosureChanged:
        | ((
              event: JetElementCustomEvent<ojSunburstNode["showDisclosure"]>,
          ) => any)
        | null;
    onSvgClassNameChanged:
        | ((
              event: JetElementCustomEvent<ojSunburstNode["svgClassName"]>,
          ) => any)
        | null;
    onSvgStyleChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["svgStyle"]>) => any)
        | null;
    onValueChanged:
        | ((event: JetElementCustomEvent<ojSunburstNode["value"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojSunburstNodeSettableProperties>(
        property: T,
    ): ojSunburstNode[T];
    getProperty(property: string): any;
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojSunburstNodeSettableProperties>,
    ): void;
...
export interface ojSunburstNodeSettableProperties
...
export interface ojSunburstNodeSettablePropertiesLenient
    extends Partial<ojSunburstNodeSettableProperties> {
    [key: string]: any;
}
