export class Collection {
    ...
    customPagingOptions:
        | ((response: object) => Collection.CustomPagingOptionsReturn | null)
        | null;
    customURL:
        | ((
              param0: string,
    ...
    static extend(
        properties?: {
            ...
            initialize?:
                | ((models: Model[], options: object) => void)
                | undefined;
            comparator?:
                | null
                | string
                | ((model1: Model, model2?: Model) => number)
                | undefined;
    ...
    fetch(options?: {
        success?:
            | ((collection: Collection, response: any, options: object) => void)
            | undefined;
        error?:
            | ((collection: Collection, xhr: any, options: object) => void)
            | undefined;
    ...
    groupBy(
        iterator: string | ((param0: Model) => object),
        context?: object,
    ): object;
    include(model: object, options?: object): boolean | Promise<boolean>;
    indexBy(
        iterator: string | ((param0: Model) => void),
        context?: object,
    ): object;
    ...
    sortedIndex(
        comparator: string | ((param0: Model, param1?: Model) => object),
    ): number;
    stopListening(
        otherObj?: object,
        eventType?: string,
...
export class Model {
    ...
    urlRoot: string | null;
    validate:
        | ((param0: object, param1: object) => string | object | null)
        | null;
    ...
    static extend(
        properties?: {
            ...
            validate?:
                ...
                | object
                | string
                | ((attributes: object, options?: Model) => number)
                | undefined;
            [propName: string]: any;
        },
        classProperties?: object,
    ...
    destroy(options?: {
        success?:
            | ((model: Model, response: any, options: object) => void)
            | undefined;
    ...
    save(
        ...
        options?: {
            success?:
                ...
                | undefined;
            error?:
                | ((model: Model, xhr: any, options: object) => void)
                | undefined;
