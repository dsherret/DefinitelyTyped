...
export interface ojColorPalette
    extends editableValue<Color, ojColorPaletteSettableProperties> {
    ...
    onLabelDisplayChanged:
        | ((
              event: JetElementCustomEvent<ojColorPalette["labelDisplay"]>,
          ) => any)
        | null;
    onLabelledByChanged:
        | ((event: JetElementCustomEvent<ojColorPalette["labelledBy"]>) => any)
        | null;
    onLayoutChanged:
        | ((event: JetElementCustomEvent<ojColorPalette["layout"]>) => any)
        | null;
    onPaletteChanged:
        | ((event: JetElementCustomEvent<ojColorPalette["palette"]>) => any)
        | null;
    onSwatchSizeChanged:
        | ((event: JetElementCustomEvent<ojColorPalette["swatchSize"]>) => any)
        | null;
    onValueChanged:
        | ((event: JetElementCustomEvent<ojColorPalette["value"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojColorPaletteSettableProperties>(
        property: T,
    ): ojColorPalette[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojColorPaletteSettableProperties>,
    ): void;
...
export interface ojColorPaletteEventMap
    extends editableValueEventMap<Color, ojColorPaletteSettableProperties> {
...
export interface ojColorPaletteSettableProperties
    extends editableValueSettableProperties<Color> {
    labelDisplay: "auto" | "off";
    labelledBy: string | null;
    layout: "grid" | "list";
    palette: Array<{
...
export interface ojColorPaletteSettablePropertiesLenient
    extends Partial<ojColorPaletteSettableProperties> {
    [key: string]: any;
}
