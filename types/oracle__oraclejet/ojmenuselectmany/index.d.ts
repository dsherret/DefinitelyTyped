...
export interface ojMenuSelectMany
    extends JetElement<ojMenuSelectManySettableProperties> {
    disabled: boolean;
    options: ojMenuSelectMany.Option[] | DataProvider<any, any> | null;
    value: any[];
    onDisabledChanged:
        | ((event: JetElementCustomEvent<ojMenuSelectMany["disabled"]>) => any)
        | null;
    onOptionsChanged:
        | ((event: JetElementCustomEvent<ojMenuSelectMany["options"]>) => any)
        | null;
    onValueChanged:
        | ((event: JetElementCustomEvent<ojMenuSelectMany["value"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojMenuSelectManySettableProperties>(
        property: T,
    ): ojMenuSelectMany[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojMenuSelectManySettableProperties>,
    ): void;
...
export interface ojMenuSelectManySettableProperties
    extends JetSettableProperties {
    disabled: boolean;
    options: ojMenuSelectMany.Option[] | DataProvider<any, any> | null;
    value: any[];
}
export interface ojMenuSelectManySettablePropertiesLenient
    extends Partial<ojMenuSelectManySettableProperties> {
    [key: string]: any;
}
