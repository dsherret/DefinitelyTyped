...
export interface ojColorSpectrum
    extends editableValue<Color, ojColorSpectrumSettableProperties> {
    ...
    onLabelledByChanged:
        | ((event: JetElementCustomEvent<ojColorSpectrum["labelledBy"]>) => any)
        | null;
    onTransientValueChanged:
        | ((
              event: JetElementCustomEvent<ojColorSpectrum["transientValue"]>,
          ) => any)
        | null;
    onValueChanged:
        | ((event: JetElementCustomEvent<ojColorSpectrum["value"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojColorSpectrumSettableProperties>(
        property: T,
    ): ojColorSpectrum[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojColorSpectrumSettableProperties>,
    ): void;
...
export interface ojColorSpectrumEventMap
    extends editableValueEventMap<Color, ojColorSpectrumSettableProperties> {
    ...
    transientValueChanged: JetElementCustomEvent<
        ojColorSpectrum["transientValue"]
    >;
    valueChanged: JetElementCustomEvent<ojColorSpectrum["value"]>;
}
export interface ojColorSpectrumSettableProperties
...
export interface ojColorSpectrumSettablePropertiesLenient
    extends Partial<ojColorSpectrumSettableProperties> {
    [key: string]: any;
}
