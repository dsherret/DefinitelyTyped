...
export interface ojDefer extends JetElement<ojDeferSettableProperties> {
    ...
    getProperty<T extends keyof ojDeferSettableProperties>(
        property: T,
    ): ojDefer[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojDeferSettableProperties>(
        property: T,
        value: ojDeferSettableProperties[T],
    ): void;
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojDeferSettableProperties>,
    ): void;
...
export interface ojDeferSettablePropertiesLenient
    extends Partial<ojDeferSettableProperties> {
    [key: string]: any;
}
