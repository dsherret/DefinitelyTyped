...
export interface ojRadioset<K, D>
    extends editableValue<any, ojRadiosetSettableProperties<K, D>> {
    disabled: boolean;
    labelledBy: string | null;
    optionRenderer?:
        | ((param0: ojRadioset.OptionContext<D>) => Element)
        | null
        | undefined;
    ...
    onDisabledChanged:
        | ((event: JetElementCustomEvent<ojRadioset<K, D>["disabled"]>) => any)
        | null;
    onLabelledByChanged:
        | ((
              event: JetElementCustomEvent<ojRadioset<K, D>["labelledBy"]>,
          ) => any)
        | null;
    onOptionRendererChanged:
        | ((
              event: JetElementCustomEvent<ojRadioset<K, D>["optionRenderer"]>,
          ) => any)
        | null;
    onOptionsChanged:
        | ((event: JetElementCustomEvent<ojRadioset<K, D>["options"]>) => any)
        | null;
    onOptionsKeysChanged:
        | ((
              event: JetElementCustomEvent<ojRadioset<K, D>["optionsKeys"]>,
          ) => any)
        | null;
    onRequiredChanged:
        | ((event: JetElementCustomEvent<ojRadioset<K, D>["required"]>) => any)
        | null;
    onValueChanged:
        | ((event: JetElementCustomEvent<ojRadioset<K, D>["value"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojRadiosetSettableProperties<K, D>>(
        property: T,
    ): ojRadioset<K, D>[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojRadiosetSettableProperties<K, D>>,
    ): void;
...
export interface ojRadiosetEventMap<K, D>
    extends editableValueEventMap<any, ojRadiosetSettableProperties<K, D>> {
...
export interface ojRadiosetSettableProperties<K, D>
    extends editableValueSettableProperties<any> {
    disabled: boolean;
    labelledBy: string | null;
    optionRenderer?:
        | ((param0: ojRadioset.OptionContext<D>) => Element)
...
export interface ojRadiosetSettablePropertiesLenient<K, D>
    extends Partial<ojRadiosetSettableProperties<K, D>> {
    [key: string]: any;
}
