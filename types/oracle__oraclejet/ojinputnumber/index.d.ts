...
export interface ojInputNumber
    ...
    onAsyncValidatorsChanged:
        | ((
              event: JetElementCustomEvent<ojInputNumber["asyncValidators"]>,
          ) => any)
        | null;
    onAutocompleteChanged:
        | ((event: JetElementCustomEvent<ojInputNumber["autocomplete"]>) => any)
        | null;
    onAutofocusChanged:
        | ((event: JetElementCustomEvent<ojInputNumber["autofocus"]>) => any)
        | null;
    onConverterChanged:
        | ((event: JetElementCustomEvent<ojInputNumber["converter"]>) => any)
        | null;
    onMaxChanged:
        | ((event: JetElementCustomEvent<ojInputNumber["max"]>) => any)
        | null;
    onMinChanged:
        | ((event: JetElementCustomEvent<ojInputNumber["min"]>) => any)
        | null;
    onPlaceholderChanged:
        | ((event: JetElementCustomEvent<ojInputNumber["placeholder"]>) => any)
        | null;
    onRawValueChanged:
        | ((event: JetElementCustomEvent<ojInputNumber["rawValue"]>) => any)
        | null;
    onReadonlyChanged:
        | ((event: JetElementCustomEvent<ojInputNumber["readonly"]>) => any)
        | null;
    onRequiredChanged:
        | ((event: JetElementCustomEvent<ojInputNumber["required"]>) => any)
        | null;
    onStepChanged:
        | ((event: JetElementCustomEvent<ojInputNumber["step"]>) => any)
        | null;
    onValidatorsChanged:
        | ((event: JetElementCustomEvent<ojInputNumber["validators"]>) => any)
        | null;
    onValueChanged:
        | ((event: JetElementCustomEvent<ojInputNumber["value"]>) => any)
        | null;
    onVirtualKeyboardChanged:
        | ((
              event: JetElementCustomEvent<ojInputNumber["virtualKeyboard"]>,
          ) => any)
        | null;
    ...
    getProperty<T extends keyof ojInputNumberSettableProperties>(
        property: T,
    ): ojInputNumber[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojInputNumberSettableProperties>,
    ): void;
...
export interface ojInputNumberEventMap
    ...
    virtualKeyboardChanged: JetElementCustomEvent<
        ojInputNumber["virtualKeyboard"]
    >;
}
export interface ojInputNumberSettableProperties
    extends editableValueSettableProperties<
        number | null,
        number | null,
        string
    > {
...
export interface ojInputNumberSettablePropertiesLenient
    extends Partial<ojInputNumberSettableProperties> {
    [key: string]: any;
}
