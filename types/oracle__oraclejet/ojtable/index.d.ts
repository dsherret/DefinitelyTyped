...
export interface ojTable<K, D>
    extends baseComponent<ojTableSettableProperties<K, D>> {
    accessibility: {
        rowHeader: string;
    };
    as: string;
        ...
        drag: {
            rows: {
                ...
                dragStart?:
                    | ((
                          param0: DragEvent,
                          param1: ojTable.DragRowContext<K, D>,
                      ) => void)
                    | undefined;
        ...
        drop: {
            columns: {
                ...
                dragEnter?:
                    | ((
                          param0: DragEvent,
                          param1: ojTable.DropColumnContext,
                      ) => void)
                    | undefined;
                dragOver?:
                    | ((
    ...
    rowRenderer:
        | ((
              context: ojTable.RowRendererContext<K, D>,
    ...
    selection:
        ...
        | Array<
              ojTable.ColumnSelectionStart<K> & ojTable.ColumnSelectionEnd<K>
          >;
    selectionMode: {
    ...
    onAccessibilityChanged:
        | ((
              event: JetElementCustomEvent<ojTable<K, D>["accessibility"]>,
          ) => any)
        | null;
    onAsChanged:
        | ((event: JetElementCustomEvent<ojTable<K, D>["as"]>) => any)
        | null;
    onColumnsChanged:
        | ((event: JetElementCustomEvent<ojTable<K, D>["columns"]>) => any)
        | null;
    onColumnsDefaultChanged:
        | ((
              event: JetElementCustomEvent<ojTable<K, D>["columnsDefault"]>,
          ) => any)
        | null;
    onCurrentRowChanged:
        | ((event: JetElementCustomEvent<ojTable<K, D>["currentRow"]>) => any)
        | null;
    onDataChanged:
        | ((event: JetElementCustomEvent<ojTable<K, D>["data"]>) => any)
        | null;
    onDisplayChanged:
        | ((event: JetElementCustomEvent<ojTable<K, D>["display"]>) => any)
        | null;
    onDndChanged:
        | ((event: JetElementCustomEvent<ojTable<K, D>["dnd"]>) => any)
        | null;
    onEditModeChanged:
        | ((event: JetElementCustomEvent<ojTable<K, D>["editMode"]>) => any)
        | null;
    onFirstSelectedRowChanged:
        | ((
              event: JetElementCustomEvent<ojTable<K, D>["firstSelectedRow"]>,
          ) => any)
        | null;
    onHorizontalGridVisibleChanged:
        | ((
              event: JetElementCustomEvent<
                  ojTable<K, D>["horizontalGridVisible"]
              >,
          ) => any)
        | null;
    onRowRendererChanged:
        | ((event: JetElementCustomEvent<ojTable<K, D>["rowRenderer"]>) => any)
        | null;
    onScrollPolicyChanged:
        | ((event: JetElementCustomEvent<ojTable<K, D>["scrollPolicy"]>) => any)
        | null;
    onScrollPolicyOptionsChanged:
        | ((
              event: JetElementCustomEvent<
                  ojTable<K, D>["scrollPolicyOptions"]
              >,
          ) => any)
        | null;
    onScrollPositionChanged:
        | ((
              event: JetElementCustomEvent<ojTable<K, D>["scrollPosition"]>,
          ) => any)
        | null;
    onSelectionChanged:
        | ((event: JetElementCustomEvent<ojTable<K, D>["selection"]>) => any)
        | null;
    onSelectionModeChanged:
        | ((
              event: JetElementCustomEvent<ojTable<K, D>["selectionMode"]>,
          ) => any)
        | null;
    onSelectionRequiredChanged:
        | ((
              event: JetElementCustomEvent<ojTable<K, D>["selectionRequired"]>,
          ) => any)
        | null;
    onVerticalGridVisibleChanged:
        | ((
              event: JetElementCustomEvent<
                  ojTable<K, D>["verticalGridVisible"]
              >,
          ) => any)
        | null;
    onOjAnimateEnd: ((event: ojTable.ojAnimateEnd) => any) | null;
    onOjAnimateStart: ((event: ojTable.ojAnimateStart) => any) | null;
    onOjBeforeCurrentRow:
        | ((event: ojTable.ojBeforeCurrentRow<K>) => any)
        | null;
    ...
    getProperty<T extends keyof ojTableSettableProperties<K, D>>(
        property: T,
    ): ojTable<K, D>[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojTableSettableProperties<K, D>>,
    ): void;
...
export namespace ojTable {
    ...
    interface ojBeforeCurrentRow<K>
        extends CustomEvent<{
            currentRow: CurrentRow<K>;
            previousCurrentRow: CurrentRow<K>;
            [propName: string]: any;
        }> {}
    interface ojBeforeRowEdit
        extends CustomEvent<{
            rowContext: object;
            [propName: string]: any;
        }> {}
    interface ojBeforeRowEditEnd
        extends CustomEvent<{
            rowContext: object;
            cancelEdit: object;
            [propName: string]: any;
    ...
    type HeaderRendererContext<K, D> = {
        ...
        columnHeaderDefaultRenderer?:
            | ((param0: object, param1: (param0: object) => void) => void)
            | undefined;
        columnHeaderSortableIconRenderer?:
            | ((param0: object, param1: (param0: object) => void) => void)
            | undefined;
        componentElement: Element;
        data: string;
...
export interface ojTableEventMap<K, D>
    extends baseComponentEventMap<ojTableSettableProperties<K, D>> {
    ...
    columnsDefaultChanged: JetElementCustomEvent<
        ojTable<K, D>["columnsDefault"]
    >;
    ...
    firstSelectedRowChanged: JetElementCustomEvent<
        ojTable<K, D>["firstSelectedRow"]
    >;
    horizontalGridVisibleChanged: JetElementCustomEvent<
        ojTable<K, D>["horizontalGridVisible"]
    >;
    ...
    scrollPolicyOptionsChanged: JetElementCustomEvent<
        ojTable<K, D>["scrollPolicyOptions"]
    >;
    scrollPositionChanged: JetElementCustomEvent<
        ojTable<K, D>["scrollPosition"]
    >;
    ...
    selectionRequiredChanged: JetElementCustomEvent<
        ojTable<K, D>["selectionRequired"]
    >;
    verticalGridVisibleChanged: JetElementCustomEvent<
        ojTable<K, D>["verticalGridVisible"]
    >;
}
export interface ojTableSettableProperties<K, D>
...
export interface ojTableSettablePropertiesLenient<K, D>
    extends Partial<ojTableSettableProperties<K, D>> {
    [key: string]: any;
}
