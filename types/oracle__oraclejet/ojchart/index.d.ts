...
export interface ojChart<K, D>
    extends dvtBaseComponent<ojChartSettableProperties<K, D>> {
    ...
    onAnimationOnDataChangeChanged:
        | ((
              event: JetElementCustomEvent<
                  ojChart<K, D>["animationOnDataChange"]
              >,
          ) => any)
        | null;
    onAnimationOnDisplayChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["animationOnDisplay"]>,
          ) => any)
        | null;
    onAsChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["as"]>) => any)
        | null;
    onCoordinateSystemChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["coordinateSystem"]>,
          ) => any)
        | null;
    onDataChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["data"]>) => any)
        | null;
    onDataCursorChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["dataCursor"]>) => any)
        | null;
    onDataCursorBehaviorChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["dataCursorBehavior"]>,
          ) => any)
        | null;
    onDataCursorPositionChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["dataCursorPosition"]>,
          ) => any)
        | null;
    onDataLabelChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["dataLabel"]>) => any)
        | null;
    onDndChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["dnd"]>) => any)
        | null;
    onDragModeChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["dragMode"]>) => any)
        | null;
    onDrillingChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["drilling"]>) => any)
        | null;
    onGroupComparatorChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["groupComparator"]>,
          ) => any)
        | null;
    onHiddenCategoriesChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["hiddenCategories"]>,
          ) => any)
        | null;
    onHideAndShowBehaviorChanged:
        | ((
              event: JetElementCustomEvent<
                  ojChart<K, D>["hideAndShowBehavior"]
              >,
          ) => any)
        | null;
    onHighlightMatchChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["highlightMatch"]>,
          ) => any)
        | null;
    onHighlightedCategoriesChanged:
        | ((
              event: JetElementCustomEvent<
                  ojChart<K, D>["highlightedCategories"]
              >,
          ) => any)
        | null;
    onHoverBehaviorChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["hoverBehavior"]>,
          ) => any)
        | null;
    onInitialZoomingChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["initialZooming"]>,
          ) => any)
        | null;
    onLegendChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["legend"]>) => any)
        | null;
    onOrientationChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["orientation"]>) => any)
        | null;
    onOtherThresholdChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["otherThreshold"]>,
          ) => any)
        | null;
    onOverviewChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["overview"]>) => any)
        | null;
    onPieCenterChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["pieCenter"]>) => any)
        | null;
    onPlotAreaChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["plotArea"]>) => any)
        | null;
    onPolarGridShapeChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["polarGridShape"]>,
          ) => any)
        | null;
    onSelectionChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["selection"]>) => any)
        | null;
    onSelectionModeChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["selectionMode"]>,
          ) => any)
        | null;
    onSeriesComparatorChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["seriesComparator"]>,
          ) => any)
        | null;
    onSortingChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["sorting"]>) => any)
        | null;
    onSplitDualYChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["splitDualY"]>) => any)
        | null;
    onSplitterPositionChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["splitterPosition"]>,
          ) => any)
        | null;
    onStackChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["stack"]>) => any)
        | null;
    onStackLabelChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["stackLabel"]>) => any)
        | null;
    onStyleDefaultsChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["styleDefaults"]>,
          ) => any)
        | null;
    onTimeAxisTypeChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["timeAxisType"]>) => any)
        | null;
    onTooltipChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["tooltip"]>) => any)
        | null;
    onTouchResponseChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["touchResponse"]>,
          ) => any)
        | null;
    onTypeChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["type"]>) => any)
        | null;
    onValueFormatsChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["valueFormats"]>) => any)
        | null;
    onXAxisChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["xAxis"]>) => any)
        | null;
    onY2AxisChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["y2Axis"]>) => any)
        | null;
    onYAxisChanged:
        | ((event: JetElementCustomEvent<ojChart<K, D>["yAxis"]>) => any)
        | null;
    onZoomAndScrollChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["zoomAndScroll"]>,
          ) => any)
        | null;
    onZoomDirectionChanged:
        | ((
              event: JetElementCustomEvent<ojChart<K, D>["zoomDirection"]>,
          ) => any)
        | null;
    ...
    onOjViewportChangeInput:
        | ((event: ojChart.ojViewportChangeInput) => any)
        | null;
    ...
    getProperty<T extends keyof ojChartSettableProperties<K, D>>(
        property: T,
    ): ojChart<K, D>[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojChartSettableProperties<K, D>>,
    ): void;
...
export namespace ojChart {
    ...
    interface ojViewportChangeInput
        extends CustomEvent<{
            endGroup: string;
            startGroup: string;
            xMax: number;
...
export interface ojChartEventMap<K, D>
    extends dvtBaseComponentEventMap<ojChartSettableProperties<K, D>> {
    ...
    animationOnDataChangeChanged: JetElementCustomEvent<
        ojChart<K, D>["animationOnDataChange"]
    >;
    animationOnDisplayChanged: JetElementCustomEvent<
        ojChart<K, D>["animationOnDisplay"]
    >;
    asChanged: JetElementCustomEvent<ojChart<K, D>["as"]>;
    coordinateSystemChanged: JetElementCustomEvent<
        ojChart<K, D>["coordinateSystem"]
    >;
    dataChanged: JetElementCustomEvent<ojChart<K, D>["data"]>;
    dataCursorChanged: JetElementCustomEvent<ojChart<K, D>["dataCursor"]>;
    dataCursorBehaviorChanged: JetElementCustomEvent<
        ojChart<K, D>["dataCursorBehavior"]
    >;
    dataCursorPositionChanged: JetElementCustomEvent<
        ojChart<K, D>["dataCursorPosition"]
    >;
    ...
    groupComparatorChanged: JetElementCustomEvent<
        ojChart<K, D>["groupComparator"]
    >;
    hiddenCategoriesChanged: JetElementCustomEvent<
        ojChart<K, D>["hiddenCategories"]
    >;
    hideAndShowBehaviorChanged: JetElementCustomEvent<
        ojChart<K, D>["hideAndShowBehavior"]
    >;
    highlightMatchChanged: JetElementCustomEvent<
        ojChart<K, D>["highlightMatch"]
    >;
    highlightedCategoriesChanged: JetElementCustomEvent<
        ojChart<K, D>["highlightedCategories"]
    >;
    hoverBehaviorChanged: JetElementCustomEvent<ojChart<K, D>["hoverBehavior"]>;
    initialZoomingChanged: JetElementCustomEvent<
        ojChart<K, D>["initialZooming"]
    >;
    ...
    polarGridShapeChanged: JetElementCustomEvent<
        ojChart<K, D>["polarGridShape"]
    >;
    ...
    seriesComparatorChanged: JetElementCustomEvent<
        ojChart<K, D>["seriesComparator"]
    >;
    sortingChanged: JetElementCustomEvent<ojChart<K, D>["sorting"]>;
    splitDualYChanged: JetElementCustomEvent<ojChart<K, D>["splitDualY"]>;
    splitterPositionChanged: JetElementCustomEvent<
        ojChart<K, D>["splitterPosition"]
    >;
...
export interface ojChartSettableProperties<K, D>
...
export interface ojChartSettablePropertiesLenient<K, D>
    extends Partial<ojChartSettableProperties<K, D>> {
    [key: string]: any;
}
export interface ojChartGroup
    extends JetElement<ojChartGroupSettableProperties> {
    drilling?: "on" | "off" | "inherit" | undefined;
    labelStyle?: object | undefined;
    name?: string | undefined;
    shortDesc?: string | undefined;
    onDrillingChanged:
        | ((event: JetElementCustomEvent<ojChartGroup["drilling"]>) => any)
        | null;
    onLabelStyleChanged:
        | ((event: JetElementCustomEvent<ojChartGroup["labelStyle"]>) => any)
        | null;
    onNameChanged:
        | ((event: JetElementCustomEvent<ojChartGroup["name"]>) => any)
        | null;
    onShortDescChanged:
        | ((event: JetElementCustomEvent<ojChartGroup["shortDesc"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojChartGroupSettableProperties>(
        property: T,
    ): ojChartGroup[T];
    getProperty(property: string): any;
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojChartGroupSettableProperties>,
    ): void;
...
export interface ojChartGroupSettablePropertiesLenient
    extends Partial<ojChartGroupSettableProperties> {
    [key: string]: any;
}
export interface ojChartItem extends JetElement<ojChartItemSettableProperties> {
    ...
    onBorderColorChanged:
        | ((event: JetElementCustomEvent<ojChartItem["borderColor"]>) => any)
        | null;
    onBorderWidthChanged:
        | ((event: JetElementCustomEvent<ojChartItem["borderWidth"]>) => any)
        | null;
    onBoxPlotChanged:
        | ((event: JetElementCustomEvent<ojChartItem["boxPlot"]>) => any)
        | null;
    onCategoriesChanged:
        | ((event: JetElementCustomEvent<ojChartItem["categories"]>) => any)
        | null;
    onCloseChanged:
        | ((event: JetElementCustomEvent<ojChartItem["close"]>) => any)
        | null;
    onColorChanged:
        | ((event: JetElementCustomEvent<ojChartItem["color"]>) => any)
        | null;
    onDrillingChanged:
        | ((event: JetElementCustomEvent<ojChartItem["drilling"]>) => any)
        | null;
    onGroupIdChanged:
        | ((event: JetElementCustomEvent<ojChartItem["groupId"]>) => any)
        | null;
    onHighChanged:
        | ((event: JetElementCustomEvent<ojChartItem["high"]>) => any)
        | null;
    onItemsChanged:
        | ((event: JetElementCustomEvent<ojChartItem["items"]>) => any)
        | null;
    onLabelChanged:
        | ((event: JetElementCustomEvent<ojChartItem["label"]>) => any)
        | null;
    onLabelPositionChanged:
        | ((event: JetElementCustomEvent<ojChartItem["labelPosition"]>) => any)
        | null;
    onLabelStyleChanged:
        | ((event: JetElementCustomEvent<ojChartItem["labelStyle"]>) => any)
        | null;
    onLowChanged:
        | ((event: JetElementCustomEvent<ojChartItem["low"]>) => any)
        | null;
    onMarkerDisplayedChanged:
        | ((
              event: JetElementCustomEvent<ojChartItem["markerDisplayed"]>,
          ) => any)
        | null;
    onMarkerShapeChanged:
        | ((event: JetElementCustomEvent<ojChartItem["markerShape"]>) => any)
        | null;
    onMarkerSizeChanged:
        | ((event: JetElementCustomEvent<ojChartItem["markerSize"]>) => any)
        | null;
    onOpenChanged:
        | ((event: JetElementCustomEvent<ojChartItem["open"]>) => any)
        | null;
    onPatternChanged:
        | ((event: JetElementCustomEvent<ojChartItem["pattern"]>) => any)
        | null;
    onQ1Changed:
        | ((event: JetElementCustomEvent<ojChartItem["q1"]>) => any)
        | null;
    onQ2Changed:
        | ((event: JetElementCustomEvent<ojChartItem["q2"]>) => any)
        | null;
    onQ3Changed:
        | ((event: JetElementCustomEvent<ojChartItem["q3"]>) => any)
        | null;
    onSeriesIdChanged:
        | ((event: JetElementCustomEvent<ojChartItem["seriesId"]>) => any)
        | null;
    onShortDescChanged:
        | ((event: JetElementCustomEvent<ojChartItem["shortDesc"]>) => any)
        | null;
    onSourceChanged:
        | ((event: JetElementCustomEvent<ojChartItem["source"]>) => any)
        | null;
    onSourceHoverChanged:
        | ((event: JetElementCustomEvent<ojChartItem["sourceHover"]>) => any)
        | null;
    onSourceHoverSelectedChanged:
        | ((
              event: JetElementCustomEvent<ojChartItem["sourceHoverSelected"]>,
          ) => any)
        | null;
    onSourceSelectedChanged:
        | ((event: JetElementCustomEvent<ojChartItem["sourceSelected"]>) => any)
        | null;
    onSvgClassNameChanged:
        | ((event: JetElementCustomEvent<ojChartItem["svgClassName"]>) => any)
        | null;
    onSvgStyleChanged:
        | ((event: JetElementCustomEvent<ojChartItem["svgStyle"]>) => any)
        | null;
    onTargetValueChanged:
        | ((event: JetElementCustomEvent<ojChartItem["targetValue"]>) => any)
        | null;
    onValueChanged:
        | ((event: JetElementCustomEvent<ojChartItem["value"]>) => any)
        | null;
    onVolumeChanged:
        | ((event: JetElementCustomEvent<ojChartItem["volume"]>) => any)
        | null;
    onXChanged:
        | ((event: JetElementCustomEvent<ojChartItem["x"]>) => any)
        | null;
    onYChanged:
        | ((event: JetElementCustomEvent<ojChartItem["y"]>) => any)
        | null;
    onZChanged:
        | ((event: JetElementCustomEvent<ojChartItem["z"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojChartItemSettableProperties>(
        property: T,
    ): ojChartItem[T];
    getProperty(property: string): any;
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojChartItemSettableProperties>,
    ): void;
...
export interface ojChartItemEventMap extends HTMLElementEventMap {
    ...
    markerDisplayedChanged: JetElementCustomEvent<
        ojChartItem["markerDisplayed"]
    >;
    ...
    sourceHoverSelectedChanged: JetElementCustomEvent<
        ojChartItem["sourceHoverSelected"]
    >;
...
export interface ojChartItemSettablePropertiesLenient
    extends Partial<ojChartItemSettableProperties> {
    [key: string]: any;
}
export interface ojChartSeries
    extends JetElement<ojChartSeriesSettableProperties> {
    ...
    type?:
        ...
        | undefined;
    onAreaColorChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["areaColor"]>) => any)
        | null;
    onAreaSvgClassNameChanged:
        | ((
              event: JetElementCustomEvent<ojChartSeries["areaSvgClassName"]>,
          ) => any)
        | null;
    onAreaSvgStyleChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["areaSvgStyle"]>) => any)
        | null;
    onAssignedToY2Changed:
        | ((event: JetElementCustomEvent<ojChartSeries["assignedToY2"]>) => any)
        | null;
    onBorderColorChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["borderColor"]>) => any)
        | null;
    onBorderWidthChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["borderWidth"]>) => any)
        | null;
    onBoxPlotChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["boxPlot"]>) => any)
        | null;
    onCategoriesChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["categories"]>) => any)
        | null;
    onColorChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["color"]>) => any)
        | null;
    onDisplayInLegendChanged:
        | ((
              event: JetElementCustomEvent<ojChartSeries["displayInLegend"]>,
          ) => any)
        | null;
    onDrillingChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["drilling"]>) => any)
        | null;
    onLineStyleChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["lineStyle"]>) => any)
        | null;
    onLineTypeChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["lineType"]>) => any)
        | null;
    onLineWidthChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["lineWidth"]>) => any)
        | null;
    onMarkerColorChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["markerColor"]>) => any)
        | null;
    onMarkerDisplayedChanged:
        | ((
              event: JetElementCustomEvent<ojChartSeries["markerDisplayed"]>,
          ) => any)
        | null;
    onMarkerShapeChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["markerShape"]>) => any)
        | null;
    onMarkerSizeChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["markerSize"]>) => any)
        | null;
    onMarkerSvgClassNameChanged:
        | ((
              event: JetElementCustomEvent<ojChartSeries["markerSvgClassName"]>,
          ) => any)
        | null;
    onMarkerSvgStyleChanged:
        | ((
              event: JetElementCustomEvent<ojChartSeries["markerSvgStyle"]>,
          ) => any)
        | null;
    onNameChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["name"]>) => any)
        | null;
    onPatternChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["pattern"]>) => any)
        | null;
    onPieSliceExplodeChanged:
        | ((
              event: JetElementCustomEvent<ojChartSeries["pieSliceExplode"]>,
          ) => any)
        | null;
    onShortDescChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["shortDesc"]>) => any)
        | null;
    onSourceChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["source"]>) => any)
        | null;
    onSourceHoverChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["sourceHover"]>) => any)
        | null;
    onSourceHoverSelectedChanged:
        | ((
              event: JetElementCustomEvent<
                  ojChartSeries["sourceHoverSelected"]
              >,
          ) => any)
        | null;
    onSourceSelectedChanged:
        | ((
              event: JetElementCustomEvent<ojChartSeries["sourceSelected"]>,
          ) => any)
        | null;
    onStackCategoryChanged:
        | ((
              event: JetElementCustomEvent<ojChartSeries["stackCategory"]>,
          ) => any)
        | null;
    onSvgClassNameChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["svgClassName"]>) => any)
        | null;
    onSvgStyleChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["svgStyle"]>) => any)
        | null;
    onTypeChanged:
        | ((event: JetElementCustomEvent<ojChartSeries["type"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojChartSeriesSettableProperties>(
        property: T,
    ): ojChartSeries[T];
    getProperty(property: string): any;
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojChartSeriesSettableProperties>,
    ): void;
...
export interface ojChartSeriesEventMap extends HTMLElementEventMap {
    ...
    areaSvgClassNameChanged: JetElementCustomEvent<
        ojChartSeries["areaSvgClassName"]
    >;
    ...
    displayInLegendChanged: JetElementCustomEvent<
        ojChartSeries["displayInLegend"]
    >;
    ...
    markerSvgClassNameChanged: JetElementCustomEvent<
        ojChartSeries["markerSvgClassName"]
    >;
    markerSvgStyleChanged: JetElementCustomEvent<
        ojChartSeries["markerSvgStyle"]
    >;
    nameChanged: JetElementCustomEvent<ojChartSeries["name"]>;
    patternChanged: JetElementCustomEvent<ojChartSeries["pattern"]>;
    pieSliceExplodeChanged: JetElementCustomEvent<
        ojChartSeries["pieSliceExplode"]
    >;
    ...
    sourceHoverSelectedChanged: JetElementCustomEvent<
        ojChartSeries["sourceHoverSelected"]
    >;
    sourceSelectedChanged: JetElementCustomEvent<
        ojChartSeries["sourceSelected"]
    >;
...
export interface ojChartSeriesSettablePropertiesLenient
    extends Partial<ojChartSeriesSettableProperties> {
    [key: string]: any;
}
export interface ojSparkChart<K, D>
    extends dvtBaseComponent<ojSparkChartSettableProperties<K, D>> {
    ...
    onAnimationDurationChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSparkChart<K, D>["animationDuration"]
              >,
          ) => any)
        | null;
    onAnimationOnDataChangeChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSparkChart<K, D>["animationOnDataChange"]
              >,
          ) => any)
        | null;
    onAnimationOnDisplayChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSparkChart<K, D>["animationOnDisplay"]
              >,
          ) => any)
        | null;
    onAreaColorChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["areaColor"]>,
          ) => any)
        | null;
    onAreaSvgClassNameChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSparkChart<K, D>["areaSvgClassName"]
              >,
          ) => any)
        | null;
    onAreaSvgStyleChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["areaSvgStyle"]>,
          ) => any)
        | null;
    onAsChanged:
        | ((event: JetElementCustomEvent<ojSparkChart<K, D>["as"]>) => any)
        | null;
    onBarGapRatioChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["barGapRatio"]>,
          ) => any)
        | null;
    onBaselineScalingChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSparkChart<K, D>["baselineScaling"]
              >,
          ) => any)
        | null;
    onColorChanged:
        | ((event: JetElementCustomEvent<ojSparkChart<K, D>["color"]>) => any)
        | null;
    onDataChanged:
        | ((event: JetElementCustomEvent<ojSparkChart<K, D>["data"]>) => any)
        | null;
    onFirstColorChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["firstColor"]>,
          ) => any)
        | null;
    onHighColorChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["highColor"]>,
          ) => any)
        | null;
    onLastColorChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["lastColor"]>,
          ) => any)
        | null;
    onLineStyleChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["lineStyle"]>,
          ) => any)
        | null;
    onLineTypeChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["lineType"]>,
          ) => any)
        | null;
    onLineWidthChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["lineWidth"]>,
          ) => any)
        | null;
    onLowColorChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["lowColor"]>,
          ) => any)
        | null;
    onMarkerShapeChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["markerShape"]>,
          ) => any)
        | null;
    onMarkerSizeChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["markerSize"]>,
          ) => any)
        | null;
    onReferenceObjectsChanged:
        | ((
              event: JetElementCustomEvent<
                  ojSparkChart<K, D>["referenceObjects"]
              >,
          ) => any)
        | null;
    onSvgClassNameChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["svgClassName"]>,
          ) => any)
        | null;
    onSvgStyleChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["svgStyle"]>,
          ) => any)
        | null;
    onTooltipChanged:
        | ((event: JetElementCustomEvent<ojSparkChart<K, D>["tooltip"]>) => any)
        | null;
    onTypeChanged:
        | ((event: JetElementCustomEvent<ojSparkChart<K, D>["type"]>) => any)
        | null;
    onVisualEffectsChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChart<K, D>["visualEffects"]>,
          ) => any)
        | null;
    ...
    getProperty<T extends keyof ojSparkChartSettableProperties<K, D>>(
        property: T,
    ): ojSparkChart<K, D>[T];
    getProperty(property: string): any;
    ...
    setProperties(
        properties: ojSparkChartSettablePropertiesLenient<K, D>,
    ): void;
    getDataItem(itemIndex: number): ojSparkChart.ItemContext | null;
}
export interface ojSparkChartEventMap<K, D>
    extends dvtBaseComponentEventMap<ojSparkChartSettableProperties<K, D>> {
    animationDurationChanged: JetElementCustomEvent<
        ojSparkChart<K, D>["animationDuration"]
    >;
    animationOnDataChangeChanged: JetElementCustomEvent<
        ojSparkChart<K, D>["animationOnDataChange"]
    ...
    areaSvgStyleChanged: JetElementCustomEvent<
        ojSparkChart<K, D>["areaSvgStyle"]
    >;
    asChanged: JetElementCustomEvent<ojSparkChart<K, D>["as"]>;
    barGapRatioChanged: JetElementCustomEvent<
        ojSparkChart<K, D>["barGapRatio"]
    >;
    baselineScalingChanged: JetElementCustomEvent<
        ojSparkChart<K, D>["baselineScaling"]
    >;
    ...
    markerShapeChanged: JetElementCustomEvent<
        ojSparkChart<K, D>["markerShape"]
    >;
    markerSizeChanged: JetElementCustomEvent<ojSparkChart<K, D>["markerSize"]>;
    referenceObjectsChanged: JetElementCustomEvent<
        ojSparkChart<K, D>["referenceObjects"]
    >;
    svgClassNameChanged: JetElementCustomEvent<
        ojSparkChart<K, D>["svgClassName"]
    >;
    ...
    visualEffectsChanged: JetElementCustomEvent<
        ojSparkChart<K, D>["visualEffects"]
    >;
}
export interface ojSparkChartSettableProperties<K, D>
    extends dvtBaseComponentSettableProperties {
    animationDuration: number | null;
    animationOnDataChange: "auto" | "none";
    animationOnDisplay: "auto" | "none";
...
export interface ojSparkChartSettablePropertiesLenient<K, D>
    extends Partial<ojSparkChartSettableProperties<K, D>> {
    [key: string]: any;
}
...
export interface ojSparkChartItem
    extends JetElement<ojSparkChartItemSettableProperties> {
    borderColor: string;
    color: string;
    date: string;
    high: number | null;
    ...
    onBorderColorChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChartItem["borderColor"]>,
          ) => any)
        | null;
    onColorChanged:
        | ((event: JetElementCustomEvent<ojSparkChartItem["color"]>) => any)
        | null;
    onDateChanged:
        | ((event: JetElementCustomEvent<ojSparkChartItem["date"]>) => any)
        | null;
    onHighChanged:
        | ((event: JetElementCustomEvent<ojSparkChartItem["high"]>) => any)
        | null;
    onLowChanged:
        | ((event: JetElementCustomEvent<ojSparkChartItem["low"]>) => any)
        | null;
    onMarkerDisplayedChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChartItem["markerDisplayed"]>,
          ) => any)
        | null;
    onMarkerShapeChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChartItem["markerShape"]>,
          ) => any)
        | null;
    onMarkerSizeChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChartItem["markerSize"]>,
          ) => any)
        | null;
    onSvgClassNameChanged:
        | ((
              event: JetElementCustomEvent<ojSparkChartItem["svgClassName"]>,
          ) => any)
        | null;
    onSvgStyleChanged:
        | ((event: JetElementCustomEvent<ojSparkChartItem["svgStyle"]>) => any)
        | null;
    onValueChanged:
        | ((event: JetElementCustomEvent<ojSparkChartItem["value"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojSparkChartItemSettableProperties>(
        property: T,
    ): ojSparkChartItem[T];
    getProperty(property: string): any;
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojSparkChartItemSettableProperties>,
    ): void;
...
export interface ojSparkChartItemEventMap extends HTMLElementEventMap {
    ...
    markerDisplayedChanged: JetElementCustomEvent<
        ojSparkChartItem["markerDisplayed"]
    >;
...
export interface ojSparkChartItemSettablePropertiesLenient
    extends Partial<ojSparkChartItemSettableProperties> {
    [key: string]: any;
}
