...
export interface ojNavigationList<K, D>
    extends baseComponent<ojNavigationListSettableProperties<K, D>> {
    as: string;
    currentItem: K;
    ...
    item: {
        renderer?:
            | (((context: ojNavigationList.ItemContext<K, D>) => void) | null)
            | undefined;
        selectable?:
            | (
                  | ((context: ojNavigationList.ItemContext<K, D>) => boolean)
                  | boolean
              )
            | undefined;
    };
    ...
    onAsChanged:
        | ((event: JetElementCustomEvent<ojNavigationList<K, D>["as"]>) => any)
        | null;
    onCurrentItemChanged:
        | ((
              event: JetElementCustomEvent<
                  ojNavigationList<K, D>["currentItem"]
              >,
          ) => any)
        | null;
    onDataChanged:
        | ((
              event: JetElementCustomEvent<ojNavigationList<K, D>["data"]>,
          ) => any)
        | null;
    onDisplayChanged:
        | ((
              event: JetElementCustomEvent<ojNavigationList<K, D>["display"]>,
          ) => any)
        | null;
    onDrillModeChanged:
        | ((
              event: JetElementCustomEvent<ojNavigationList<K, D>["drillMode"]>,
          ) => any)
        | null;
    onEdgeChanged:
        | ((
              event: JetElementCustomEvent<ojNavigationList<K, D>["edge"]>,
          ) => any)
        | null;
    onExpandedChanged:
        | ((
              event: JetElementCustomEvent<ojNavigationList<K, D>["expanded"]>,
          ) => any)
        | null;
    onHierarchyMenuThresholdChanged:
        | ((
              event: JetElementCustomEvent<
                  ojNavigationList<K, D>["hierarchyMenuThreshold"]
              >,
          ) => any)
        | null;
    onItemChanged:
        | ((
              event: JetElementCustomEvent<ojNavigationList<K, D>["item"]>,
          ) => any)
        | null;
    onOverflowChanged:
        | ((
              event: JetElementCustomEvent<ojNavigationList<K, D>["overflow"]>,
          ) => any)
        | null;
    onRootLabelChanged:
        | ((
              event: JetElementCustomEvent<ojNavigationList<K, D>["rootLabel"]>,
          ) => any)
        | null;
    onSelectionChanged:
        | ((
              event: JetElementCustomEvent<ojNavigationList<K, D>["selection"]>,
          ) => any)
        | null;
    ...
    onOjBeforeCollapse:
        | ((event: ojNavigationList.ojBeforeCollapse) => any)
        | null;
    onOjBeforeCurrentItem:
        | ((event: ojNavigationList.ojBeforeCurrentItem) => any)
        | null;
    ...
    addEventListener<T extends keyof ojNavigationListEventMap<K, D>>(
        ...
        listener: (
            this: HTMLElement,
            ev: ojNavigationListEventMap<K, D>[T],
        ) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(
    ...
    getProperty<T extends keyof ojNavigationListSettableProperties<K, D>>(
        property: T,
    ): ojNavigationList<K, D>[T];
    ...
    setProperties(
        properties: ojNavigationListSettablePropertiesLenient<K, D>,
    ): void;
...
export interface ojNavigationListEventMap<K, D>
    ...
    drillModeChanged: JetElementCustomEvent<
        ojNavigationList<K, D>["drillMode"]
    >;
    ...
    hierarchyMenuThresholdChanged: JetElementCustomEvent<
        ojNavigationList<K, D>["hierarchyMenuThreshold"]
    >;
    ...
    rootLabelChanged: JetElementCustomEvent<
        ojNavigationList<K, D>["rootLabel"]
    >;
    selectionChanged: JetElementCustomEvent<
        ojNavigationList<K, D>["selection"]
    >;
}
export interface ojNavigationListSettableProperties<K, D>
...
export interface ojTabBar<K, D>
    extends baseComponent<ojTabBarSettableProperties<K, D>> {
    as: string;
    currentItem: any;
    data: DataProvider<K, D> | null;
    display: "all" | "icons";
    ...
    item: {
        renderer?:
            | (((context: ojTabBar.ItemContext<K, D>) => void) | null)
            | undefined;
        selectable?:
            | (((context: ojTabBar.ItemContext<K, D>) => boolean) | boolean)
            | undefined;
    };
    overflow: "popup" | "hidden";
    ...
    onAsChanged:
        | ((event: JetElementCustomEvent<ojTabBar<K, D>["as"]>) => any)
        | null;
    onCurrentItemChanged:
        | ((event: JetElementCustomEvent<ojTabBar<K, D>["currentItem"]>) => any)
        | null;
    onDataChanged:
        | ((event: JetElementCustomEvent<ojTabBar<K, D>["data"]>) => any)
        | null;
    onDisplayChanged:
        | ((event: JetElementCustomEvent<ojTabBar<K, D>["display"]>) => any)
        | null;
    onEdgeChanged:
        | ((event: JetElementCustomEvent<ojTabBar<K, D>["edge"]>) => any)
        | null;
    onItemChanged:
        | ((event: JetElementCustomEvent<ojTabBar<K, D>["item"]>) => any)
        | null;
    onOverflowChanged:
        | ((event: JetElementCustomEvent<ojTabBar<K, D>["overflow"]>) => any)
        | null;
    onReorderableChanged:
        | ((event: JetElementCustomEvent<ojTabBar<K, D>["reorderable"]>) => any)
        | null;
    onSelectionChanged:
        | ((event: JetElementCustomEvent<ojTabBar<K, D>["selection"]>) => any)
        | null;
    onTruncationChanged:
        | ((event: JetElementCustomEvent<ojTabBar<K, D>["truncation"]>) => any)
        | null;
    onOjAnimateEnd: ((event: ojTabBar.ojAnimateEnd) => any) | null;
    onOjAnimateStart: ((event: ojTabBar.ojAnimateStart) => any) | null;
    onOjBeforeCurrentItem:
        | ((event: ojTabBar.ojBeforeCurrentItem) => any)
        | null;
    ...
    getProperty<T extends keyof ojTabBarSettableProperties<K, D>>(
        property: T,
    ): ojTabBar<K, D>[T];
    getProperty(property: string): any;
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojTabBarSettableProperties<K, D>>,
    ): void;
...
export interface ojTabBarEventMap<K, D>
    extends baseComponentEventMap<ojTabBarSettableProperties<K, D>> {
...
export interface ojTabBarSettableProperties<K, D>
    extends baseComponentSettableProperties {
    as: string;
    currentItem: any;
    data: DataProvider<K, D> | null;
...
export interface ojTabBarSettablePropertiesLenient<K, D>
    extends Partial<ojTabBarSettableProperties<K, D>> {
    [key: string]: any;
}
