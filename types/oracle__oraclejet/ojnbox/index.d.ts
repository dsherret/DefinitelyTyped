...
export interface ojNBox<K, D>
    extends dvtBaseComponent<ojNBoxSettableProperties<K, D>> {
    ...
    onAnimationOnDataChangeChanged:
        | ((
              event: JetElementCustomEvent<
                  ojNBox<K, D>["animationOnDataChange"]
              >,
          ) => any)
        | null;
    onAnimationOnDisplayChanged:
        | ((
              event: JetElementCustomEvent<ojNBox<K, D>["animationOnDisplay"]>,
          ) => any)
        | null;
    onAsChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["as"]>) => any)
        | null;
    onCellContentChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["cellContent"]>) => any)
        | null;
    onCellMaximizeChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["cellMaximize"]>) => any)
        | null;
    onCellsChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["cells"]>) => any)
        | null;
    onColumnsChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["columns"]>) => any)
        | null;
    onColumnsTitleChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["columnsTitle"]>) => any)
        | null;
    onCountLabelChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["countLabel"]>) => any)
        | null;
    onDataChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["data"]>) => any)
        | null;
    onGroupAttributesChanged:
        | ((
              event: JetElementCustomEvent<ojNBox<K, D>["groupAttributes"]>,
          ) => any)
        | null;
    onGroupBehaviorChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["groupBehavior"]>) => any)
        | null;
    onHiddenCategoriesChanged:
        | ((
              event: JetElementCustomEvent<ojNBox<K, D>["hiddenCategories"]>,
          ) => any)
        | null;
    onHighlightMatchChanged:
        | ((
              event: JetElementCustomEvent<ojNBox<K, D>["highlightMatch"]>,
          ) => any)
        | null;
    onHighlightedCategoriesChanged:
        | ((
              event: JetElementCustomEvent<
                  ojNBox<K, D>["highlightedCategories"]
              >,
          ) => any)
        | null;
    onHoverBehaviorChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["hoverBehavior"]>) => any)
        | null;
    onLabelTruncationChanged:
        | ((
              event: JetElementCustomEvent<ojNBox<K, D>["labelTruncation"]>,
          ) => any)
        | null;
    onMaximizedColumnChanged:
        | ((
              event: JetElementCustomEvent<ojNBox<K, D>["maximizedColumn"]>,
          ) => any)
        | null;
    onMaximizedRowChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["maximizedRow"]>) => any)
        | null;
    onOtherColorChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["otherColor"]>) => any)
        | null;
    onOtherThresholdChanged:
        | ((
              event: JetElementCustomEvent<ojNBox<K, D>["otherThreshold"]>,
          ) => any)
        | null;
    onRowsChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["rows"]>) => any)
        | null;
    onRowsTitleChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["rowsTitle"]>) => any)
        | null;
    onSelectionChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["selection"]>) => any)
        | null;
    onSelectionModeChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["selectionMode"]>) => any)
        | null;
    onStyleDefaultsChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["styleDefaults"]>) => any)
        | null;
    onTooltipChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["tooltip"]>) => any)
        | null;
    onTouchResponseChanged:
        | ((event: JetElementCustomEvent<ojNBox<K, D>["touchResponse"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojNBoxSettableProperties<K, D>>(
        property: T,
    ): ojNBox<K, D>[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojNBoxSettableProperties<K, D>>,
    ): void;
...
export interface ojNBoxEventMap<K, D>
    extends dvtBaseComponentEventMap<ojNBoxSettableProperties<K, D>> {
    animationOnDataChangeChanged: JetElementCustomEvent<
        ojNBox<K, D>["animationOnDataChange"]
    >;
    animationOnDisplayChanged: JetElementCustomEvent<
        ojNBox<K, D>["animationOnDisplay"]
    >;
...
export interface ojNBoxSettableProperties<K, D>
...
export interface ojNBoxSettablePropertiesLenient<K, D>
    extends Partial<ojNBoxSettableProperties<K, D>> {
    [key: string]: any;
}
...
export interface ojNBoxNode extends JetElement<ojNBoxNodeSettableProperties> {
    ...
    onBorderColorChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["borderColor"]>) => any)
        | null;
    onBorderWidthChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["borderWidth"]>) => any)
        | null;
    onCategoriesChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["categories"]>) => any)
        | null;
    onColorChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["color"]>) => any)
        | null;
    onColumnChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["column"]>) => any)
        | null;
    onGroupCategoryChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["groupCategory"]>) => any)
        | null;
    onIconChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["icon"]>) => any)
        | null;
    onIndicatorColorChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["indicatorColor"]>) => any)
        | null;
    onIndicatorIconChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["indicatorIcon"]>) => any)
        | null;
    onLabelChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["label"]>) => any)
        | null;
    onRowChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["row"]>) => any)
        | null;
    onSecondaryLabelChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["secondaryLabel"]>) => any)
        | null;
    onShortDescChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["shortDesc"]>) => any)
        | null;
    onSvgClassNameChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["svgClassName"]>) => any)
        | null;
    onSvgStyleChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["svgStyle"]>) => any)
        | null;
    onXPercentageChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["xPercentage"]>) => any)
        | null;
    onYPercentageChanged:
        | ((event: JetElementCustomEvent<ojNBoxNode["yPercentage"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojNBoxNodeSettableProperties>(
        property: T,
    ): ojNBoxNode[T];
    getProperty(property: string): any;
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojNBoxNodeSettableProperties>,
    ): void;
...
export interface ojNBoxNodeSettablePropertiesLenient
    extends Partial<ojNBoxNodeSettableProperties> {
    [key: string]: any;
}
