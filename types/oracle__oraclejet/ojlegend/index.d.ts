...
export interface ojLegend<K, D>
    extends dvtBaseComponent<ojLegendSettableProperties<K, D>> {
    as: string;
    ...
    onAsChanged:
        | ((event: JetElementCustomEvent<ojLegend<K, D>["as"]>) => any)
        | null;
    onDataChanged:
        | ((event: JetElementCustomEvent<ojLegend<K, D>["data"]>) => any)
        | null;
    onDrillingChanged:
        | ((event: JetElementCustomEvent<ojLegend<K, D>["drilling"]>) => any)
        | null;
    onExpandedChanged:
        | ((event: JetElementCustomEvent<ojLegend<K, D>["expanded"]>) => any)
        | null;
    onHalignChanged:
        | ((event: JetElementCustomEvent<ojLegend<K, D>["halign"]>) => any)
        | null;
    onHiddenCategoriesChanged:
        | ((
              event: JetElementCustomEvent<ojLegend<K, D>["hiddenCategories"]>,
          ) => any)
        | null;
    onHideAndShowBehaviorChanged:
        | ((
              event: JetElementCustomEvent<
                  ojLegend<K, D>["hideAndShowBehavior"]
              >,
          ) => any)
        | null;
    onHighlightedCategoriesChanged:
        | ((
              event: JetElementCustomEvent<
                  ojLegend<K, D>["highlightedCategories"]
              >,
          ) => any)
        | null;
    onHoverBehaviorChanged:
        | ((
              event: JetElementCustomEvent<ojLegend<K, D>["hoverBehavior"]>,
          ) => any)
        | null;
    onHoverBehaviorDelayChanged:
        | ((
              event: JetElementCustomEvent<
                  ojLegend<K, D>["hoverBehaviorDelay"]
              >,
          ) => any)
        | null;
    onOrientationChanged:
        | ((event: JetElementCustomEvent<ojLegend<K, D>["orientation"]>) => any)
        | null;
    onScrollingChanged:
        | ((event: JetElementCustomEvent<ojLegend<K, D>["scrolling"]>) => any)
        | null;
    onSymbolHeightChanged:
        | ((
              event: JetElementCustomEvent<ojLegend<K, D>["symbolHeight"]>,
          ) => any)
        | null;
    onSymbolWidthChanged:
        | ((event: JetElementCustomEvent<ojLegend<K, D>["symbolWidth"]>) => any)
        | null;
    onTextStyleChanged:
        | ((event: JetElementCustomEvent<ojLegend<K, D>["textStyle"]>) => any)
        | null;
    onValignChanged:
        | ((event: JetElementCustomEvent<ojLegend<K, D>["valign"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojLegendSettableProperties<K, D>>(
        property: T,
    ): ojLegend<K, D>[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojLegendSettableProperties<K, D>>,
    ): void;
...
export interface ojLegendEventMap<K, D>
    extends dvtBaseComponentEventMap<ojLegendSettableProperties<K, D>> {
...
export interface ojLegendSettableProperties<K, D>
...
export interface ojLegendSettablePropertiesLenient<K, D>
    extends Partial<ojLegendSettableProperties<K, D>> {
    [key: string]: any;
}
export interface ojLegendItem
    extends JetElement<ojLegendItemSettableProperties> {
    ...
    onBorderColorChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["borderColor"]>) => any)
        | null;
    onCategoriesChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["categories"]>) => any)
        | null;
    onCategoryVisibilityChanged:
        | ((
              event: JetElementCustomEvent<ojLegendItem["categoryVisibility"]>,
          ) => any)
        | null;
    onColorChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["color"]>) => any)
        | null;
    onDrillingChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["drilling"]>) => any)
        | null;
    onLineStyleChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["lineStyle"]>) => any)
        | null;
    onLineWidthChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["lineWidth"]>) => any)
        | null;
    onMarkerColorChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["markerColor"]>) => any)
        | null;
    onMarkerShapeChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["markerShape"]>) => any)
        | null;
    onMarkerSvgClassNameChanged:
        | ((
              event: JetElementCustomEvent<ojLegendItem["markerSvgClassName"]>,
          ) => any)
        | null;
    onMarkerSvgStyleChanged:
        | ((
              event: JetElementCustomEvent<ojLegendItem["markerSvgStyle"]>,
          ) => any)
        | null;
    onPatternChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["pattern"]>) => any)
        | null;
    onShortDescChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["shortDesc"]>) => any)
        | null;
    onSourceChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["source"]>) => any)
        | null;
    onSvgClassNameChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["svgClassName"]>) => any)
        | null;
    onSvgStyleChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["svgStyle"]>) => any)
        | null;
    onSymbolTypeChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["symbolType"]>) => any)
        | null;
    onTextChanged:
        | ((event: JetElementCustomEvent<ojLegendItem["text"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojLegendItemSettableProperties>(
        property: T,
    ): ojLegendItem[T];
    getProperty(property: string): any;
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojLegendItemSettableProperties>,
    ): void;
...
export interface ojLegendItemEventMap extends HTMLElementEventMap {
    ...
    categoryVisibilityChanged: JetElementCustomEvent<
        ojLegendItem["categoryVisibility"]
    >;
    ...
    markerSvgClassNameChanged: JetElementCustomEvent<
        ojLegendItem["markerSvgClassName"]
    >;
    markerSvgStyleChanged: JetElementCustomEvent<
        ojLegendItem["markerSvgStyle"]
    >;
...
export interface ojLegendItemSettablePropertiesLenient
    extends Partial<ojLegendItemSettableProperties> {
    [key: string]: any;
}
export interface ojLegendSection
    extends JetElement<ojLegendSectionSettableProperties> {
    ...
    onCollapsibleChanged:
        | ((
              event: JetElementCustomEvent<ojLegendSection["collapsible"]>,
          ) => any)
        | null;
    onTextChanged:
        | ((event: JetElementCustomEvent<ojLegendSection["text"]>) => any)
        | null;
    onTextHalignChanged:
        | ((event: JetElementCustomEvent<ojLegendSection["textHalign"]>) => any)
        | null;
    onTextStyleChanged:
        | ((event: JetElementCustomEvent<ojLegendSection["textStyle"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojLegendSectionSettableProperties>(
        property: T,
    ): ojLegendSection[T];
    getProperty(property: string): any;
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojLegendSectionSettableProperties>,
    ): void;
...
export interface ojLegendSectionSettableProperties
...
export interface ojLegendSectionSettablePropertiesLenient
    extends Partial<ojLegendSectionSettableProperties> {
    [key: string]: any;
}
