...
export interface ojPopup extends baseComponent<ojPopupSettableProperties> {
    ...
    onAutoDismissChanged:
        | ((event: JetElementCustomEvent<ojPopup["autoDismiss"]>) => any)
        | null;
    onChromeChanged:
        | ((event: JetElementCustomEvent<ojPopup["chrome"]>) => any)
        | null;
    onInitialFocusChanged:
        | ((event: JetElementCustomEvent<ojPopup["initialFocus"]>) => any)
        | null;
    onModalityChanged:
        | ((event: JetElementCustomEvent<ojPopup["modality"]>) => any)
        | null;
    onPositionChanged:
        | ((event: JetElementCustomEvent<ojPopup["position"]>) => any)
        | null;
    onTailChanged:
        | ((event: JetElementCustomEvent<ojPopup["tail"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojPopupSettableProperties>(
        property: T,
    ): ojPopup[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojPopupSettableProperties>(
        property: T,
        value: ojPopupSettableProperties[T],
    ): void;
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojPopupSettableProperties>,
    ): void;
...
export interface ojPopupEventMap
    extends baseComponentEventMap<ojPopupSettableProperties> {
...
export interface ojPopupSettableProperties
...
export interface ojPopupSettablePropertiesLenient
    extends Partial<ojPopupSettableProperties> {
    [key: string]: any;
}
