...
export interface ojTimeAxis
    extends dvtBaseComponent<ojTimeAxisSettableProperties> {
    ...
    onConverterChanged:
        | ((event: JetElementCustomEvent<ojTimeAxis["converter"]>) => any)
        | null;
    onEndChanged:
        | ((event: JetElementCustomEvent<ojTimeAxis["end"]>) => any)
        | null;
    onScaleChanged:
        | ((event: JetElementCustomEvent<ojTimeAxis["scale"]>) => any)
        | null;
    onStartChanged:
        | ((event: JetElementCustomEvent<ojTimeAxis["start"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojTimeAxisSettableProperties>(
        property: T,
    ): ojTimeAxis[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojTimeAxisSettableProperties>,
    ): void;
    setProperties(properties: ojTimeAxisSettablePropertiesLenient): void;
}
export interface ojTimeAxisEventMap
    extends dvtBaseComponentEventMap<ojTimeAxisSettableProperties> {
...
export interface ojTimeAxisSettableProperties
...
export interface ojTimeAxisSettablePropertiesLenient
    extends Partial<ojTimeAxisSettableProperties> {
    [key: string]: any;
}
