...
export interface ojProgressList
    extends JetElement<ojProgressListSettableProperties> {
    data: DataProvider<any, any> | null;
    onDataChanged:
        | ((event: JetElementCustomEvent<ojProgressList["data"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojProgressListSettableProperties>(
        property: T,
    ): ojProgressList[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojProgressListSettableProperties>,
    ): void;
...
export interface ojProgressListSettableProperties
    extends JetSettableProperties {
    data: DataProvider<any, any> | null;
}
export interface ojProgressListSettablePropertiesLenient
    extends Partial<ojProgressListSettableProperties> {
    [key: string]: any;
}
export interface ProgressItem {
    addEventListener(
        eventType: ProgressItem.EventType,
