...
export interface ojListView<K, D>
    extends baseComponent<ojListViewSettableProperties<K, D>> {
    as: string;
    currentItem: K;
            ...
            | {
                  items: {
                      ...
                      drop?:
                          | ((
                                param0: Event,
                                param1: ojListView.ItemsDropContext,
                            ) => void)
                          | undefined;
                  };
              }
    ...
    item: {
        focusable?:
            | ((param0: ojListView.ItemContext<K, D>) => boolean)
            | boolean
            | undefined;
        renderer?:
    ...
    onAsChanged:
        | ((event: JetElementCustomEvent<ojListView<K, D>["as"]>) => any)
        | null;
    onCurrentItemChanged:
        | ((
              event: JetElementCustomEvent<ojListView<K, D>["currentItem"]>,
          ) => any)
        | null;
    onDataChanged:
        | ((event: JetElementCustomEvent<ojListView<K, D>["data"]>) => any)
        | null;
    onDndChanged:
        | ((event: JetElementCustomEvent<ojListView<K, D>["dnd"]>) => any)
        | null;
    onDrillModeChanged:
        | ((event: JetElementCustomEvent<ojListView<K, D>["drillMode"]>) => any)
        | null;
    onExpandedChanged:
        | ((event: JetElementCustomEvent<ojListView<K, D>["expanded"]>) => any)
        | null;
    onFirstSelectedItemChanged:
        | ((
              event: JetElementCustomEvent<
                  ojListView<K, D>["firstSelectedItem"]
              >,
          ) => any)
        | null;
    onGroupHeaderPositionChanged:
        | ((
              event: JetElementCustomEvent<
                  ojListView<K, D>["groupHeaderPosition"]
              >,
          ) => any)
        | null;
    onItemChanged:
        | ((event: JetElementCustomEvent<ojListView<K, D>["item"]>) => any)
        | null;
    onScrollPolicyChanged:
        | ((
              event: JetElementCustomEvent<ojListView<K, D>["scrollPolicy"]>,
          ) => any)
        | null;
    onScrollPolicyOptionsChanged:
        | ((
              event: JetElementCustomEvent<
                  ojListView<K, D>["scrollPolicyOptions"]
              >,
          ) => any)
        | null;
    onScrollPositionChanged:
        | ((
              event: JetElementCustomEvent<ojListView<K, D>["scrollPosition"]>,
          ) => any)
        | null;
    onSelectionChanged:
        | ((event: JetElementCustomEvent<ojListView<K, D>["selection"]>) => any)
        | null;
    onSelectionModeChanged:
        | ((
              event: JetElementCustomEvent<ojListView<K, D>["selectionMode"]>,
          ) => any)
        | null;
    onSelectionRequiredChanged:
        | ((
              event: JetElementCustomEvent<
                  ojListView<K, D>["selectionRequired"]
              >,
          ) => any)
        | null;
    ...
    onOjBeforeCurrentItem:
        | ((event: ojListView.ojBeforeCurrentItem<K>) => any)
        | null;
    ...
    getProperty<T extends keyof ojListViewSettableProperties<K, D>>(
        property: T,
    ): ojListView<K, D>[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojListViewSettableProperties<K, D>>,
    ): void;
...
export namespace ojListView {
    ...
    interface ojBeforeCollapse<K>
        extends CustomEvent<{
            key: K;
            item: Element;
            [propName: string]: any;
        }> {}
    interface ojBeforeCurrentItem<K>
        extends CustomEvent<{
            previousKey: K;
    ...
    interface ojBeforeExpand<K>
        extends CustomEvent<{
            key: K;
            item: Element;
            [propName: string]: any;
        }> {}
    interface ojCollapse<K>
        extends CustomEvent<{
            key: K;
            item: Element;
            [propName: string]: any;
...
export interface ojListViewEventMap<K, D>
    extends baseComponentEventMap<ojListViewSettableProperties<K, D>> {
...
export interface ojListViewSettablePropertiesLenient<K, D>
    extends Partial<ojListViewSettableProperties<K, D>> {
    [key: string]: any;
}
