...
export interface ojMessage extends JetElement<ojMessageSettableProperties> {
    ...
    onDisplayOptionsChanged:
        | ((event: JetElementCustomEvent<ojMessage["displayOptions"]>) => any)
        | null;
    onMessageChanged:
        | ((event: JetElementCustomEvent<ojMessage["message"]>) => any)
        | null;
    onTranslationsChanged:
        | ((event: JetElementCustomEvent<ojMessage["translations"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojMessageSettableProperties>(
        property: T,
    ): ojMessage[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojMessageSettableProperties>(
        property: T,
        value: ojMessageSettableProperties[T],
    ): void;
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojMessageSettableProperties>,
    ): void;
...
export interface ojMessageSettablePropertiesLenient
    extends Partial<ojMessageSettableProperties> {
    [key: string]: any;
}
