...
export interface ojSlider
    extends editableValue<number | null, ojSliderSettableProperties> {
    disabled: boolean;
    max: number | null;
    min: number | null;
    ...
    onDisabledChanged:
        | ((event: JetElementCustomEvent<ojSlider["disabled"]>) => any)
        | null;
    onMaxChanged:
        | ((event: JetElementCustomEvent<ojSlider["max"]>) => any)
        | null;
    onMinChanged:
        | ((event: JetElementCustomEvent<ojSlider["min"]>) => any)
        | null;
    onOrientationChanged:
        | ((event: JetElementCustomEvent<ojSlider["orientation"]>) => any)
        | null;
    onStepChanged:
        | ((event: JetElementCustomEvent<ojSlider["step"]>) => any)
        | null;
    onTransientValueChanged:
        | ((event: JetElementCustomEvent<ojSlider["transientValue"]>) => any)
        | null;
    onTypeChanged:
        | ((event: JetElementCustomEvent<ojSlider["type"]>) => any)
        | null;
    onValueChanged:
        | ((event: JetElementCustomEvent<ojSlider["value"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojSliderSettableProperties>(
        property: T,
    ): ojSlider[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojSliderSettableProperties>(
        property: T,
        value: ojSliderSettableProperties[T],
    ): void;
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojSliderSettableProperties>,
    ): void;
...
export interface ojSliderEventMap
    extends editableValueEventMap<number | null, ojSliderSettableProperties> {
...
export interface ojSliderSettableProperties
    extends editableValueSettableProperties<number | null> {
    disabled: boolean;
    max: number | null;
    min: number | null;
    orientation: "horizontal" | "vertical";
...
export interface ojSliderSettablePropertiesLenient
    extends Partial<ojSliderSettableProperties> {
    [key: string]: any;
}
