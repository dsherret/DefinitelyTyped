...
export interface baseComponent<
    SP extends
        baseComponentSettableProperties = baseComponentSettableProperties,
> extends JetElement<SP> {
    translations: object | null;
    onTranslationsChanged:
        | ((
              event: JetElementCustomEvent<baseComponent<SP>["translations"]>,
          ) => any)
        | null;
    ...
    getProperty<T extends keyof baseComponentSettableProperties>(
        property: T,
    ): baseComponent<SP>[T];
...
export interface baseComponentEventMap<
    SP extends
        baseComponentSettableProperties = baseComponentSettableProperties,
> extends HTMLElementEventMap {
    translationsChanged: JetElementCustomEvent<
        baseComponent<SP>["translations"]
    >;
}
export interface baseComponentSettableProperties extends JetSettableProperties {
    translations: object | null;
}
export interface baseComponentSettablePropertiesLenient
    extends Partial<baseComponentSettableProperties> {
    [key: string]: any;
}
...
export type JetSetPropertyType<
    K,
    U extends JetSettableProperties,
