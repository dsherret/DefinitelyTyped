...
export interface ojDiagram<K1, K2, D1, D2>
    extends dvtBaseComponent<ojDiagramSettableProperties<K1, K2, D1, D2>> {
    ...
    onAnimationOnDataChangeChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["animationOnDataChange"]
              >,
          ) => any)
        | null;
    onAnimationOnDisplayChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["animationOnDisplay"]
              >,
          ) => any)
        | null;
    onAsChanged:
        | ((
              event: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>["as"]>,
          ) => any)
        | null;
    onDndChanged:
        | ((
              event: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>["dnd"]>,
          ) => any)
        | null;
    onExpandedChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["expanded"]
              >,
          ) => any)
        | null;
    onFocusRendererChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["focusRenderer"]
              >,
          ) => any)
        | null;
    onHiddenCategoriesChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["hiddenCategories"]
              >,
          ) => any)
        | null;
    onHighlightMatchChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["highlightMatch"]
              >,
          ) => any)
        | null;
    onHighlightedCategoriesChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["highlightedCategories"]
              >,
          ) => any)
        | null;
    onHoverBehaviorChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["hoverBehavior"]
              >,
          ) => any)
        | null;
    onHoverRendererChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["hoverRenderer"]
              >,
          ) => any)
        | null;
    onLayoutChanged:
        | ((
              event: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>["layout"]>,
          ) => any)
        | null;
    onLinkDataChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["linkData"]
              >,
          ) => any)
        | null;
    onLinkHighlightModeChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["linkHighlightMode"]
              >,
          ) => any)
        | null;
    onMaxZoomChanged:
    ...
    onNodeDataChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["nodeData"]
              >,
          ) => any)
        | null;
    onNodeHighlightModeChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["nodeHighlightMode"]
              >,
          ) => any)
        | null;
    onOverviewChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["overview"]
              >,
          ) => any)
        | null;
    onPanDirectionChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["panDirection"]
              >,
          ) => any)
        | null;
    onPanningChanged:
    ...
    onPromotedLinkBehaviorChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["promotedLinkBehavior"]
              >,
          ) => any)
        | null;
    onRendererChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["renderer"]
              >,
          ) => any)
        | null;
    onSelectionChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["selection"]
              >,
          ) => any)
        | null;
    onSelectionModeChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["selectionMode"]
              >,
          ) => any)
        | null;
    onSelectionRendererChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["selectionRenderer"]
              >,
          ) => any)
        | null;
    onStyleDefaultsChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["styleDefaults"]
              >,
          ) => any)
        | null;
    onTooltipChanged:
    ...
    onTouchResponseChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["touchResponse"]
              >,
          ) => any)
        | null;
    onZoomRendererChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagram<K1, K2, D1, D2>["zoomRenderer"]
              >,
          ) => any)
        | null;
    onZoomingChanged:
    ...
    addEventListener<T extends keyof ojDiagramEventMap<K1, K2, D1, D2>>(
        ...
        listener: (
            this: HTMLElement,
            ev: ojDiagramEventMap<K1, K2, D1, D2>[T],
        ) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(
    ...
    getProperty<T extends keyof ojDiagramSettableProperties<K1, K2, D1, D2>>(
        property: T,
    ): ojDiagram<K1, K2, D1, D2>[T];
    ...
    setProperties(
        properties: ojDiagramSettablePropertiesLenient<K1, K2, D1, D2>,
    ): void;
...
export interface ojDiagramEventMap<K1, K2, D1, D2>
    ...
    expandedChanged: JetElementCustomEvent<
        ojDiagram<K1, K2, D1, D2>["expanded"]
    >;
    ...
    linkDataChanged: JetElementCustomEvent<
        ojDiagram<K1, K2, D1, D2>["linkData"]
    >;
    linkHighlightModeChanged: JetElementCustomEvent<
        ojDiagram<K1, K2, D1, D2>["linkHighlightMode"]
    >;
    ...
    nodeDataChanged: JetElementCustomEvent<
        ojDiagram<K1, K2, D1, D2>["nodeData"]
    >;
    nodeHighlightModeChanged: JetElementCustomEvent<
        ojDiagram<K1, K2, D1, D2>["nodeHighlightMode"]
    >;
    overviewChanged: JetElementCustomEvent<
        ojDiagram<K1, K2, D1, D2>["overview"]
    >;
    panDirectionChanged: JetElementCustomEvent<
        ojDiagram<K1, K2, D1, D2>["panDirection"]
    >;
    panningChanged: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>["panning"]>;
    promotedLinkBehaviorChanged: JetElementCustomEvent<
        ojDiagram<K1, K2, D1, D2>["promotedLinkBehavior"]
    >;
...
export interface ojDiagramSettableProperties<K1, K2, D1, D2>
...
export interface ojDiagramLink
    extends JetElement<ojDiagramLinkSettableProperties> {
    categories: string[];
    ...
    onCategoriesChanged:
        | ((event: JetElementCustomEvent<ojDiagramLink["categories"]>) => any)
        | null;
    onColorChanged:
        | ((event: JetElementCustomEvent<ojDiagramLink["color"]>) => any)
        | null;
    onEndConnectorTypeChanged:
        | ((
              event: JetElementCustomEvent<ojDiagramLink["endConnectorType"]>,
          ) => any)
        | null;
    onEndNodeChanged:
        | ((event: JetElementCustomEvent<ojDiagramLink["endNode"]>) => any)
        | null;
    onLabelChanged:
        | ((event: JetElementCustomEvent<ojDiagramLink["label"]>) => any)
        | null;
    onLabelStyleChanged:
        | ((event: JetElementCustomEvent<ojDiagramLink["labelStyle"]>) => any)
        | null;
    onSelectableChanged:
        | ((event: JetElementCustomEvent<ojDiagramLink["selectable"]>) => any)
        | null;
    onShortDescChanged:
        | ((event: JetElementCustomEvent<ojDiagramLink["shortDesc"]>) => any)
        | null;
    onStartConnectorTypeChanged:
        | ((
              event: JetElementCustomEvent<ojDiagramLink["startConnectorType"]>,
          ) => any)
        | null;
    onStartNodeChanged:
        | ((event: JetElementCustomEvent<ojDiagramLink["startNode"]>) => any)
        | null;
    onSvgClassNameChanged:
        | ((event: JetElementCustomEvent<ojDiagramLink["svgClassName"]>) => any)
        | null;
    onSvgStyleChanged:
        | ((event: JetElementCustomEvent<ojDiagramLink["svgStyle"]>) => any)
        | null;
    onWidthChanged:
        | ((event: JetElementCustomEvent<ojDiagramLink["width"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojDiagramLinkSettableProperties>(
        property: T,
    ): ojDiagramLink[T];
    getProperty(property: string): any;
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojDiagramLinkSettableProperties>,
    ): void;
...
export interface ojDiagramLinkEventMap extends HTMLElementEventMap {
    ...
    endConnectorTypeChanged: JetElementCustomEvent<
        ojDiagramLink["endConnectorType"]
    >;
    ...
    startConnectorTypeChanged: JetElementCustomEvent<
        ojDiagramLink["startConnectorType"]
    >;
...
export interface ojDiagramLinkSettablePropertiesLenient
    extends Partial<ojDiagramLinkSettableProperties> {
    [key: string]: any;
}
export interface ojDiagramNode
    extends JetElement<ojDiagramNodeSettableProperties> {
    ...
    onCategoriesChanged:
        | ((event: JetElementCustomEvent<ojDiagramNode["categories"]>) => any)
        | null;
    onDescendantsConnectivityChanged:
        | ((
              event: JetElementCustomEvent<
                  ojDiagramNode["descendantsConnectivity"]
              >,
          ) => any)
        | null;
    onIconChanged:
        | ((event: JetElementCustomEvent<ojDiagramNode["icon"]>) => any)
        | null;
    onLabelChanged:
        | ((event: JetElementCustomEvent<ojDiagramNode["label"]>) => any)
        | null;
    onLabelStyleChanged:
        | ((event: JetElementCustomEvent<ojDiagramNode["labelStyle"]>) => any)
        | null;
    onOverviewChanged:
        | ((event: JetElementCustomEvent<ojDiagramNode["overview"]>) => any)
        | null;
    onSelectableChanged:
        | ((event: JetElementCustomEvent<ojDiagramNode["selectable"]>) => any)
        | null;
    onShortDescChanged:
        | ((event: JetElementCustomEvent<ojDiagramNode["shortDesc"]>) => any)
        | null;
    onShowDisclosureChanged:
        | ((
              event: JetElementCustomEvent<ojDiagramNode["showDisclosure"]>,
          ) => any)
        | null;
    ...
    getProperty<T extends keyof ojDiagramNodeSettableProperties>(
        property: T,
    ): ojDiagramNode[T];
    getProperty(property: string): any;
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojDiagramNodeSettableProperties>,
    ): void;
...
export interface ojDiagramNodeEventMap extends HTMLElementEventMap {
    ...
    descendantsConnectivityChanged: JetElementCustomEvent<
        ojDiagramNode["descendantsConnectivity"]
    >;
    ...
    showDisclosureChanged: JetElementCustomEvent<
        ojDiagramNode["showDisclosure"]
    >;
}
...
export interface ojDiagramNodeSettablePropertiesLenient
    extends Partial<ojDiagramNodeSettableProperties> {
    [key: string]: any;
}
