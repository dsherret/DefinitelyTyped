...
export interface dvtTimeComponent<
    SP extends
        dvtTimeComponentSettableProperties = dvtTimeComponentSettableProperties,
> extends dvtBaseComponent<SP> {
    addEventListener<T extends keyof dvtTimeComponentEventMap<SP>>(
        type: T,
        listener: (
            this: HTMLElement,
            ev: dvtTimeComponentEventMap<SP>[T],
        ) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(
    ...
    getProperty<T extends keyof dvtTimeComponentSettableProperties>(
        property: T,
    ): dvtTimeComponent<SP>[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, dvtTimeComponentSettableProperties>,
    ): void;
...
export interface dvtTimeComponentSettableProperties
    extends dvtBaseComponentSettableProperties {}
export interface dvtTimeComponentSettablePropertiesLenient
    extends Partial<dvtTimeComponentSettableProperties> {
    [key: string]: any;
}
