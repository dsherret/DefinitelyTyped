...
export interface ojFilePicker
    extends JetElement<ojFilePickerSettableProperties> {
    accept: string[] | null;
    selectOn: "auto" | "click" | "drop" | "clickAndDrop";
    selectionMode: "multiple" | "single";
    onAcceptChanged:
        | ((event: JetElementCustomEvent<ojFilePicker["accept"]>) => any)
        | null;
    onSelectOnChanged:
        | ((event: JetElementCustomEvent<ojFilePicker["selectOn"]>) => any)
        | null;
    onSelectionModeChanged:
        | ((event: JetElementCustomEvent<ojFilePicker["selectionMode"]>) => any)
        | null;
    ...
    getProperty<T extends keyof ojFilePickerSettableProperties>(
        property: T,
    ): ojFilePicker[T];
    ...
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojFilePickerSettableProperties>,
    ): void;
...
export interface ojFilePickerSettablePropertiesLenient
    extends Partial<ojFilePickerSettableProperties> {
    [key: string]: any;
}
