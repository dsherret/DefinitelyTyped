...
const _noop_callback_with_data = (err: BranchSDK.BranchError, data: any) =>
    null;
const _noop_callback_without_data = (err: BranchSDK.BranchError) => null;

const _base_deep_link_data: BranchSDK.DeepLinkData = {};
const _channel_deep_link_data: BranchSDK.DeepLinkData = {
...
const _custom_data_deep_link_data: BranchSDK.DeepLinkData = {
    ...
    data: {
        ...
        my_custom_key: "anything I want",
    },
};

const _journey_event_listener = (event: BranchSDK.JourneyEvent, data: any) =>
    null;
...
BranchSDK.sendSMS(
    "+1234567890",
    _base_deep_link_data,
    undefined,
    _noop_callback_without_data,
); // $ExpectType void
BranchSDK.sendSMS(
    "+1234567890",
    _channel_deep_link_data,
    undefined,
    _noop_callback_without_data,
); // $ExpectType void
BranchSDK.sendSMS(
    "+1234567890",
    _branch_data_deep_link_data,
    { make_new_link: true },
    _noop_callback_without_data,
); // $ExpectType void
BranchSDK.sendSMS(
    "+1234567890",
    _custom_data_deep_link_data,
    { make_new_link: false },
    _noop_callback_without_data,
); // $ExpectType void
...
BranchSDK.deepview(
    _channel_deep_link_data,
    { make_new_link: false, open_app: true },
    _noop_callback_without_data,
); // $ExpectType void
BranchSDK.deepview(
    _branch_data_deep_link_data,
    { make_new_link: false, open_app: false },
    _noop_callback_without_data,
); // $ExpectType void
BranchSDK.deepview(
    _custom_data_deep_link_data,
    { make_new_link: true, open_app: false },
    _noop_callback_without_data,
); // $ExpectType void
...
BranchSDK.addListener(
    BranchSDK.JourneyEvent.willShowJourney,
    _journey_event_listener,
); // $ExpectType void
BranchSDK.addListener(
    BranchSDK.JourneyEvent.didShowJourney,
    _journey_event_listener,
); // $ExpectType void
BranchSDK.addListener(
    BranchSDK.JourneyEvent.willNotShowJourney,
    _journey_event_listener,
); // $ExpectType void
BranchSDK.addListener(
    BranchSDK.JourneyEvent.didClickJourneyCTA,
    _journey_event_listener,
); // $ExpectType void
BranchSDK.addListener(
    BranchSDK.JourneyEvent.didClickJourneyClose,
    _journey_event_listener,
); // $ExpectType void
BranchSDK.addListener(
    BranchSDK.JourneyEvent.willCloseJourney,
    _journey_event_listener,
); // $ExpectType void
BranchSDK.addListener(
    BranchSDK.JourneyEvent.didCloseJourney,
    _journey_event_listener,
); // $ExpectType void
BranchSDK.addListener(
    BranchSDK.JourneyEvent.didCallJourneyClose,
    _journey_event_listener,
); // $ExpectType void
...
BranchSDK.autoAppIndex(
    { androidPackageName: "typescript" },
    _noop_callback_without_data,
); // $ExpectType void
