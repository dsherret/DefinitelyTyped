...
const regionOptions: RegionParams = {
    start: 7,
    end: 13,
    data: { label: "Hello, World!", fontSize: 99 },
};
...
waveSurferWithRegionsPlugin.on(
    "region-updated",
    (region: Region, eventParams: RegionUpdatedEventParams) => {
        eventParams.action;
...
region.update({
    ...
    data: { text: "Hello", label: "Bye, World!", fontSize: 24 },
});
