 ...
 */
export type DropDownItems<T> = Array<
    (T & (string | number)) | DropDownOption<T>
>;
...
export interface QuickSettingsPanel<M = AnyModel, S = string> {
    ...
    addBoolean(
        title: KeyWhereType<M, boolean>,
        value: boolean,
        callback?: ChangeHandler<boolean>,
    ): this;
    bindBoolean<K extends KeyWhereType<M, boolean>>(
        title: K,
        value: boolean,
        object: Record<K, boolean>,
    ): this;
    ...
    bindColor<K extends KeyWhereType<M, string>>(
        title: K,
        color: string,
        object: Record<K, string>,
    ): this;
    ...
    bindDate<K extends KeyWhereType<M, string | Date>, V extends M[K]>(
        title: K,
        date: V,
        object: Record<K, V>,
    ): this;
    ...
    bindTime<K extends KeyWhereType<M, string | Date>, V extends M[K]>(
        title: K,
        date: V,
        object: Record<K, V>,
    ): this;
    ...
    bindDropDown<K extends keyof M>(
        title: K,
        items: DropDownItems<M[K]>,
        object: Pick<M, K>,
    ): this;
    ...
    bindPassword<K extends KeyWhereType<M, string>>(
        title: K,
        text: string,
        object: Record<K, string>,
    ): this;
    ...
    bindText<K extends KeyWhereType<M, string>>(
        title: K,
        text: string,
        object: Record<K, string>,
    ): this;
    ...
    bindTextArea<K extends KeyWhereType<M, string>>(
        title: K,
        text: string,
        object: Record<K, string>,
    ): this;
