...
const httpErrorC = new restifyErrors.HttpError(
    { statusCode: 404 },
    "Hello %s!",
    "World",
);
...
const httpErrorF = new restifyErrors.HttpError(
    prevErr,
    { statusCode: 404 },
    "Hello %s!",
    "World",
...
const restErrorC = new restifyErrors.RestError(
    { statusCode: 404, restCode: "TEST" },
    "Hello %s!",
    "World",
);
...
const restErrorF = new restifyErrors.RestError(
    prevErr,
    { statusCode: 404, restCode: "TEST" },
    "Hello %s!",
    "World",
