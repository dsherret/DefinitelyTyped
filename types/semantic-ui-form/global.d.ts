...
declare namespace SemanticUI {
    interface Form {
        ...
        (
            behavior: "add rule",
            field: string,
            rules: string | string[] | Form.Rules,
        ): JQuery;
        /**
         * Adds rule to existing rules for field
         * @since 2.2.11
        ...
        <K extends keyof FormSettings>(
            behavior: "setting",
            name: K,
            value?: undefined,
        ): FormSettings._Impl[K];
        <K extends keyof FormSettings>(
            behavior: "setting",
            name: K,
            value: FormSettings._Impl[K],
        ): JQuery;
    ...
    namespace Form {
        ...
        namespace TemplatesSettings {
            type Param = (Pick<_Impl, "error"> | Pick<_Impl, "prompt">) &
                Partial<Pick<_Impl, keyof _Impl>>;
