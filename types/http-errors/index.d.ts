...
declare const createHttpError: createHttpError.CreateHttpError &
...
declare namespace createHttpError {
    ...
    type NamedConstructors = {
        ...
        Record<
            ...
            HttpErrorConstructor<431>
        > &
        Record<
            "UnavailableForLegalReasons" | "451",
            HttpErrorConstructor<451>
        > &
