...
describe("getCssProperty command demo", function () {
    ...
    test("async demo test", async function (browser) {
        const result = await browser.getCssProperty(
            "input[type=text]",
            "background-color",
        );
...
describe("getShadowRoot command demo", function () {
    ...
    test("async demo test", async function (browser) {
        ...
        const result2 = await browser.getShadowRoot(
            await element("selector").getWebElement(),
        );
...
describe("setValue command demo", function () {
    ...
    test("async demo test", async function (browser) {
        const result = await browser.setValue(
            "input[type=text]",
            "nightwatchjs",
        );
        isType<null>(result);
...
describe("sendKeys command demo", function () {
    ...
    test("async demo test", async function (browser) {
        const result = await browser.setValue("input[type=text]", [
            "nightwatchjs",
            browser.Keys.ENTER,
        ]);
        isType<null>(result);
...
describe("setPassword command demo", function () {
    ...
    test("async demo test", async function (browser) {
        const result = await browser.setPassword("input[type=text]", [
            "nightwatchjs",
            browser.Keys.ENTER,
        ]);
        isType<null>(result);
...
describe("setAttribute command demo", function () {
    ...
    test("async demo test", async function (browser) {
        const result = await browser.setAttribute(
            "input[type=text]",
            "disabled",
            "false",
        );
...
describe("getElementProperty command demo", function () {
    ...
    test("async demo test", async function (browser) {
        const result = await browser.getElementProperty(
            "input[type=text]",
            "disabled",
        );
        isType<any>(result);
...
describe("waitForElementVisible command demo", function () {
    ...
    test("async demo test", async function (browser) {
        const result = await browser.waitForElementVisible(
            "input[type=text]",
            undefined,
            undefined,
            true,
...
describe("dragAndDrop command demo", function () {
    ...
    test("async demo test", async function (browser) {
        const result = await browser.dragAndDrop("input[type=text]", {
            x: 50,
            y: 50,
        });
        isType<null>(result);
