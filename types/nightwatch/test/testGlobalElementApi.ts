...
describe("global element() api", function () {
    it("test element()", async function () {
        ...
        // with options
        isType<ElementGlobal>(
            element("selector", { isComponent: true, type: "vue" }),
        );
    });
    ...
    it("test element() methods and properties", async function () {
        ...
        isNightwatchAPI(
            elem.findElement("child-selector", function (result) {
                isNightwatchAPI(this);
        ...
        isNightwatchAPI(
            elem.find("child-selector", function (result) {
                isNightwatchAPI(this);
        ...
        isNightwatchAPI(
            elem.get("child-selector", function (result) {
                isNightwatchAPI(this);
                isNightwatchCallbackResult<ElementGlobal | null>(result);
            }),
        );
        ...
        // .findElements()
        isNightwatchAPI(
            elem.findElements("child-selector", function (result) {
                isNightwatchAPI(this);
                isNightwatchCallbackResult<WebElement[]>(result);
            }),
        );
        ...
        // .findAll()
        isNightwatchAPI(
            elem.findAll("child-selector", function (result) {
                isNightwatchAPI(this);
        ...
        // .getAccessibleName()
        isNightwatchAPI(
            elem.getAccessibleName(function (result) {
                isNightwatchAPI(this);
                isNightwatchCallbackResult<string>(result);
            }),
        );
        ...
        // .getAriaRole()
        isNightwatchAPI(
            elem.getAriaRole(function (result) {
                isNightwatchAPI(this);
                isNightwatchCallbackResult<string>(result);
            }),
        );
        ...
        // .getAttribute()
        isNightwatchAPI(
            elem.getAttribute("attribute-name", function (result) {
                isNightwatchAPI(this);
        ...
        // .getCssValue()
        isNightwatchAPI(
            elem.getCssValue("prop-name", function (result) {
                isNightwatchAPI(this);
                isNightwatchCallbackResult<string>(result);
            }),
        );
        ...
        // .getProperty()
        isNightwatchAPI(
            elem.getProperty("prop-name", function (result) {
                isNightwatchAPI(this);
                isNightwatchCallbackResult<string | null>(result);
            }),
        );
        ...
        // .getTagName()
        isNightwatchAPI(
            elem.getTagName(function (result) {
                isNightwatchAPI(this);
                isNightwatchCallbackResult<string>(result);
            }),
        );
        ...
        // .takeScreenshot()
        isNightwatchAPI(
            elem.takeScreenshot(function (result) {
                isNightwatchAPI(this);
                isNightwatchCallbackResult<string>(result);
            }),
        );
        ...
        // .isDisplayed()
        isNightwatchAPI(
            elem.isDisplayed(function (result) {
                isNightwatchAPI(this);
        ...
        // .isEnabled()
        isNightwatchAPI(
            elem.isEnabled(function (result) {
                isNightwatchAPI(this);
                isNightwatchCallbackResult<boolean>(result);
            }),
        );
        ...
        // .isSelected()
        isNightwatchAPI(
            elem.isSelected(function (result) {
                isNightwatchAPI(this);
                isNightwatchCallbackResult<boolean>(result);
            }),
        );
