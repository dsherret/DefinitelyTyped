...
function test_app() {
    ...
    app.contextMatchesOptions(context, {
        path: ["#/otherpath", "#/thirdpath"],
    });
    app.contextMatchesOptions(context, {
        only: { path: ["#/mypath", "#/otherpath"] },
    });
    app.contextMatchesOptions(context, {
        only: { path: ["#/otherpath", "#/thirdpath"] },
    });
    app.contextMatchesOptions(context, {
        except: { path: ["#/mypath", "#/otherpath"] },
    });
    app.contextMatchesOptions(context, {
        except: { path: ["#/otherpath", "#/thirdpath"] },
    });
...
function test_misc() {
    var app = $.sammy(function () {
        var _this: Sammy.Application;
        _this.setLocationProxy(
            new Sammy.DataLocationProxy(_this, "location", "rel"),
        );
    ...
    function evtContextTests() {
        ...
        _this.renderEach("mytemplate.mustache", [
            { name: "quirkey" },
            { name: "endor" },
        ]);
        ...
        var app = $.sammy(function () {
            ...
            _this.use("Handlebars", "hb");
            _this.get(
                "#/hello/:name/to/:friend",
                function (context: Sammy.Handlebars) {
        ...
        var app = $.sammy(function () {
            ...
            _this.get(
                "#/hello/:name/to/:friend",
                function (context: Sammy.Mustache) {
