...
MyTelegramBot.sendMessage(1234, "test-text", {
...
MyTelegramBot.answerInlineQuery("queryId", [res, res, res], {
    is_personal: true,
});
MyTelegramBot.forwardMessage(1234, 5678, 90, { disable_notification: true });
MyTelegramBot.copyMessage(1234, 5678, 90, {
...
MyTelegramBot.sendPoll(1234, "question", ["answer1", "answer2"], {
    type: "regular",
});
...
MyTelegramBot.sendVenue(1234, 100, 200, "Venue Title", "123 Fake St.", {
    reply_to_message_id: 1234,
});
MyTelegramBot.sendContact(1234, "345-555-0192", "John", {
    last_name: "Smith",
    vcard: "vcard_data",
});
...
MyTelegramBot.answerPreCheckoutQuery("preCheckoutQueryId", true, {
    error_message: "Bar",
});
MyTelegramBot.addListener(
    "message",
    (message: TelegramBot.Message, { type }) => {},
);
MyTelegramBot.addListener(
    "callback_query",
...
MyTelegramBot.addListener(
    "shipping_query",
    (query: TelegramBot.ShippingQuery) => {},
);
MyTelegramBot.addListener(
    "pre_checkout_query",
...
MyTelegramBot.on(
    "chat_join_request",
    (query: TelegramBot.ChatJoinRequest) => {},
);
...
MyTelegramBot.prependOnceListener(
    "message",
    (message: TelegramBot.Message, { type }) => {},
);
MyTelegramBot.prependOnceListener(
...
MyTelegramBot.createNewStickerSet(
    1234,
    "short_name",
    "my sticker set name",
    "my_png_sticker_file",
