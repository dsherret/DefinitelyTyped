...
export default class ParserRuleContext extends RuleContext {
    ...
    getTypedRuleContext<T extends ParserRuleContext>(
        cxtType: { new (...args: any[]): T },
        i: number,
    ): T;

    getTypedRuleContexts<T extends ParserRuleContext>(cxtType: {
        new (...args: any[]): T;
    }): T[];
}
