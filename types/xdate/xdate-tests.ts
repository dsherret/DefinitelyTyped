...
namespace XDate_Test {
    ...
    class adding extends test_base {
        ...
        private addMonths_prevent_overflow_backwards_january_bug(): boolean {
            ...
            return (
                d1.addMonths(-1, true).toString("yyyy-MM-dd") == "2012-12-28" && // Dec 28
                d2.addMonths(-1, true).toString("yyyy-MM-dd") == "2012-12-14"
            ); // Dec 14
        }
        ...
        private addWeeks(): boolean {
            return (
                new XDate(2011, 7, 12).addWeeks(2).getDate() == 26 &&
        ...
        public constructor() {
            ...
            super.assert(
                this.addMonths_prevent_overflow_backwards_january_bug(),
            );
    ...
    class constructors extends test_base {
        public no_args(): boolean {
            ...
            var time = +new Date();
            return (
                Math.abs(xdate.getTime() - time) < 1000 && !xdate.getUTCMode()
            );
        }
        ...
        public from_native_Date_utcMode_true(): boolean {
            ...
            return date.getTime() == xdate.getTime() && xdate.getUTCMode();
        }
        ...
        public toString_utcMode_undefined_true(): boolean {
            ...
            return (
                xdate1.toString("yyyy-MM-dd HH-mm-ss") ==
                    "2012-09-21 00-00-00" &&
    ...
    */
        ...
        public constructor() {
            ...
            super.assert(
                this.year_month_date_minutes_seconds_milliseconds_utcMode_false(),
            );
            super.assert(this.year_month_date_utcMode_true());
            super.assert(
                this.year_month_date_minutes_seconds_milliseconds_utcMode_true(),
            );
        }
    }
    ...
    class diffing extends test_base {
        public diffWeeks(): boolean {
            return (
                Math.floor(
                    new XDate(2011, 4, 18).diffWeeks(new XDate(2011, 4, 26)),
                ) == 1 &&
                // Math.abs(new XDate(2011, 4, 18).diffWeeks(new XDate(2011, 4, 26), true) - (1+1/7)) < .001 &&
                Math.floor(
                    new XDate(2011, 4, 18).diffWeeks(new XDate(2011, 4, 24)),
                ) == 0 &&
                // Math.abs(new XDate(2011, 4, 18).diffWeeks(new XDate(2011, 4, 24), true) - (1-1/7)) < .001 &&
                Math.floor(
                    new XDate(2011, 4, 18).diffWeeks(new XDate("2011-05-26")),
                ) == 1
            );
        }
        ...
        public diffYears(): boolean {
            return (
                new XDate("2011-04-10").diffYears("2013-04-10") == 2 &&
                new XDate("2011-01-01T06:06:06").diffYears(
                    "2013-07-01T06:06:06",
                ) == 2.5
            );
        }
        ...
        public diffMonths(): boolean {
            return (
                new XDate("2011-06-05").diffMonths("2012-07-05") == 13 &&
        ...
        public diffHours(): boolean {
            return (
                new XDate("2012-05-05T06:30:00").diffHours(
                    "2012-05-05T04:00:00",
                ) == -2.5
            );
        }
        ...
        public diffMinutes(): boolean {
            return (
                new XDate("2012-05-01T05:50").diffMinutes(
                    "2012-05-01T06:10:30",
                ) == 20.5
            );
        }
        ...
        public diffSeconds(): boolean {
            return (
                new XDate("2012-03-01T00:00:45").diffSeconds(
                    "2012-03-01T00:01:15",
                ) == 30
            );
        }
        ...
        public diffMilliseconds(): boolean {
            return (
                new XDate("2011-06-06T05:05:05").diffMilliseconds(
                    "2011-06-06T05:05:08.100",
                ) == 3100
            );
        }
    ...
    class formatting extends test_base {
        public numbers_am(): boolean {
            return (
                new XDate(1986, 5, 8, 4, 3, 2).toString(
                    "MM/dd/yyyy hh:mm:ss tt",
                ) == "06/08/1986 04:03:02 am"
            );
        }
        ...
        public numbers_am_mini(): boolean {
            return (
                new XDate(1986, 5, 8, 4, 3, 2).toString("M/d/yy h:m:s t") ==
                "6/8/86 4:3:2 a"
            );
        }
        ...
        public numbers_pm(): boolean {
            return (
                new XDate(1986, 5, 8, 14, 3, 2).toString(
                    "MM/dd/yyyy hh:mm:ss tt",
                ) == "06/08/1986 02:03:02 pm"
            );
        }
        ...
        public numbers_pm_mini(): boolean {
            return (
                new XDate(1986, 5, 8, 14, 3, 2).toString("M/d/yy h:m:s t") ==
                "6/8/86 2:3:2 p"
            );
        }
        ...
        public no_am_pm_confusion(): boolean {
            return (
                new XDate(2012, 5, 8).toString("tt") == "am" &&
        ...
        public short_names(): boolean {
            return (
                new XDate(2011, 10, 5).toString("ddd, MMM dd, yyyy") ==
                "Sat, Nov 05, 2011"
            );
        }
        ...
        public long_namesu(): boolean {
            return (
                new XDate(2011, 10, 5).toString("dddd, MMMM dd, yyyy") ==
        ...
        public ordinals(): boolean {
            return (
                new XDate(2011, 1, 1).toString("dS") == "1st" &&
        ...
        public non_zero_parenthesis(): boolean {
            ...
            return (
                d1.toString("M/d/yyyy h(:mm)tt") == "6/8/2010 1am" &&
        ...
        public non_zero_parenthesis_nested(): boolean {
            return (
                new XDate(2011, 5, 8).toString("(h(:mm)tt)") == "12am" &&
        ...
        public non_zero_parenthesis_crazy_quotes(): boolean {
            return (
                new XDate(2010, 5, 8, 14, 30).toString(
                    "M/d/yyyy h(:mm')')tt",
                ) == "6/8/2010 2:30)pm"
            );
        }
        ...
        public toString_toUTCString_settings_param(): boolean {
            ...
            return (
                new XDate(2011, 3, 29).toString("dddd yyyy", settings) ==
                    "Primeday 2011" &&
                new XDate(2011, 3, 4, 12).toUTCString("dddd yyyy", settings) ==
                    "Benduday 2011"
            );
        }
        ...
        public iso_week_correct_digits(): boolean {
            return (
                new XDate(2011, 2, 1).toString("w") == "9" &&
        ...
        public toString_toUTCString_different_locale(): boolean {
            ...
            return (
                new XDate(2011, 3, 29).toString("dddd yyyy", "starwars") ==
                    "Primeday 2011" &&
                new XDate(2011, 3, 4, 12).toUTCString(
                    "dddd yyyy",
                    "starwars",
                ) == "Benduday 2011"
            );
        ...
        public toString_toUTCString_new_default_locale(): boolean {
            ...
            var good =
                new XDate(2011, 3, 29).toString("dddd yyyy") ==
                    "Primeday 2011" &&
                new XDate(2011, 3, 4, 12).toUTCString("dddd yyyy") ==
                    "Benduday 2011";
            XDate.defaultLocale = "";
            return good;
        }
        ...
        public toString_methods_hasLocalTimezone_yes(): boolean {
            ...
            return (
                realDate.toString() == xdate.toString() &&
        ...
        public toString_methods_hasLocalTimezone_no(): boolean {
            ...
            return (
                realDate.toString().indexOf(xdate.toString()) == 0 &&
                realDate.toTimeString().indexOf(xdate.toTimeString()) == 0 &&
                realDate.toLocaleString().indexOf(xdate.toLocaleString()) ==
                    0 &&
                realDate
                    .toLocaleDateString()
                    .indexOf(xdate.toLocaleDateString()) == 0 &&
                realDate
                    .toLocaleTimeString()
                    .indexOf(xdate.toLocaleTimeString()) == 0
            );
        }
    ...
    */
    ...
    class setters extends test_base {
        ...
        public setWeek_underflow(): boolean {
            ...
            return (
                +xdate.clone().setWeek(0) == +xdate.clone().addWeeks(-1) &&
        ...
        public setUTCWeek_correctly_handles_UTC_week_numbering_edge_case(): boolean {
            ...
            return (
                wasWeek53 &&
                "Mon, 28 Dec 2009 00:00:00 GMT" === date.toUTCString()
            );
        }
    }
    ...
    class utc_mode extends test_base {
        public identical_methods(): boolean {
            var xdate = new XDate(true);
            return (
                xdate.getFullYear() == xdate.getUTCFullYear() &&
        ...
        public getTimezoneOffset(): boolean {
            ...
            return (
                xdate1.getTimezoneOffset() == date.getTimezoneOffset() &&
    ...
    class utilities extends test_base {
        ...
        public getDaysInMonth(): boolean {
            return (
                XDate.getDaysInMonth(2011, 1) == 28 && // feb
                XDate.getDaysInMonth(2012, 1) == 29 && // feb, leap year
                XDate.getDaysInMonth(2012, 8) == 30 && // sep
                XDate.getDaysInMonth(2012, 6) == 31
            ); // jul
        }

        public UTC_class_method(): boolean {
            return (
                Date.UTC(2011, 3, 20, 12, 30) == XDate.UTC(2011, 3, 20, 12, 30)
            );
        }
        ...
        public today_class_method(): boolean {
            ...
            var d = new Date();
            return (
                xdate.getFullYear() == d.getFullYear() &&
