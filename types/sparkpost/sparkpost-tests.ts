...
client.sendingDomains.create(
    {
        ...
        dkim: {
            private:
                "MIICXgIBAAKBgQC+W6scd3XWwvC/hPRksfDYFi3ztgyS9OSqnnjtNQeDdTSD1DRx/==",
...
client.sendingDomains.update(
    "example1.com",
    {
        dkim: {
            private:
                "MIICXgIBAAKBgQC+W6scd3XWwvC/hPRksfDYFi3ztgyS9OSqnnjtNQeDdTSD1DRx/Y1g==",
            public: "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC+W6scd3XWwvC/==",
...
client.transmissions.send(
        ...
        recipients: [
            ...
            },
            {
                address: {
                    ...
                    header_to:
                        '"Original Recipient" <original.recipient@example.com>',
                },
                substitution_data: {
                    recipient_type: "BCC",
                },
    ...
    (err, res) => {
        if (err) {
            ...
            console.log(res.body);
            console.log(
                "Congrats! You sent an email with bcc using SparkPost!",
            );
        }
    },
);
...
client.transmissions.send(
    {
        ...
        recipients: [
            {
                address: {
                    email: "rick.sanchez@rickandmorty100years.com",
                    name: "Rick Sanchez",
                },
            },
        ],
...
// Promise
client.webhooks
    .getBatchStatus("TEST_WEBHOOK_UUID", {
        limit: 1000,
    })
    .then((data) => {
        console.log("Congrats you can use our client library!");
