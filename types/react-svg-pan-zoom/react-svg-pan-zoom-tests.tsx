    ...
    render() {
        ...
        return (
            <div>
                <button
                    onClick={(event) => {
                        if (this.Viewer) this.Viewer.zoomOnViewerCenter(1.1);
                    }}
                >
                    Zoom in
                </button>
                ...
                <ReactSVGPanZoom
                    ...
                    onMouseUp={(event: ViewerMouseEvent<any>) =>
                        console.log("up", event.x, event.y)
                    }
                    onMouseMove={(event: ViewerMouseEvent<any>) =>
                        console.log("move", event.x, event.y)
                    }
                    onMouseDown={(event: ViewerMouseEvent<any>) =>
