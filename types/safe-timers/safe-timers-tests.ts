...
const timeoutWithArgs: Timeout = setTimeout(
    (hero: string, powerLevel: number) => {},
    1000,
    "Goku",
    9000,
);
...
const timeoutAtWithArgs: Timeout = setTimeoutAt(
    (hero: string, powerLevel: number) => {},
    1000,
    "Goku",
    9000,
...
const intervalWithArgs: Interval = setInterval(
    (hero: string, powerLevel: number) => {},
    1000,
    "Goku",
    9000,
