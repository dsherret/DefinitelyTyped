...
(() => {
    ...
    if (data1 === data2) {
        ...
        console.log(
            `[ERR] ${title} => Expected ${data1} to be equal to ${data2}.`,
        );
    }
})();
// #endregion as
...
(() => {
    ...
    jBinary.load(inputStream, undefined, (err, jb) => {
        if (err) {
            ...
            console.log(
                `[OK.] ${title} => Loaded ${jb.view.buffer.length} bytes of data.`,
            );
        }
    });
})();
    ...
    jBinary
        ...
        .catch((reason) => {
            if (reason instanceof Error) {
                console.log(
                    `[ERR] ${title} => Error reading file: ${reason.message}`,
                );
            }
        });
})();
...
(() => {
    ...
    jBinary.loadData("./test.bin", (err, data) => {
        if (err) {
            ...
            console.log(
                `[OK.] ${title} => Loaded ${data.length} bytes of data.`,
            );
        } else {
...
(() => {
    const title =
        '"saveAs" (with Promise, WritableStream and Array<number> as data)';
    ...
    binary
        ...
        .catch((reason) => {
            if (reason instanceof Error) {
                console.log(
                    `[ERR] ${title} => Error writing file: ${reason.message}`,
                );
            }
        })
        .finally(() => {
...
(() => {
    ...
    if (data === 30) {
        ...
        console.log(
            `[ERR] ${title} => Expected 30 after seek but got ${data}.`,
        );
    }
})();
...
(() => {
    ...
    if (data === 127) {
        ...
        console.log(
            `[ERR] ${title} => Expected 127 after skip but got ${data}.`,
        );
    }
})();
...
(() => {
    ...
    if (data === 3) {
        ...
        console.log(
            `[ERR] ${title} => Expected 3 after slice but got ${data}.`,
        );
    }
})();
// #endregion slice
...
(() => {
    ...
    if (pos === 1) {
        ...
        console.log(
            `[ERR] ${title} => Expected position in binary to be 1 after skip but was ${pos}.`,
        );
    }
})();
// #endregion tell
...
(() => {
    ...
    if (
        ...
        console.log(
            `[OK.] ${title} => Reading data using template type went fine.`,
        );
    } else {
        console.log(`[ERR] ${title} => Unexpected result.`);
    }
...
(() => {
    ...
    if (
        ...
        console.log(
            `[OK.] ${title} => Reading data using custom type went fine.`,
        );
    } else {
        console.log(`[ERR] ${title} => Unexpected result.`);
    }
...
(() => {
    ...
    if (data === 21) {
        ...
        console.log(
            `[ERR] ${title} => Unexpected result when reading updated data.`,
        );
    }
})();
