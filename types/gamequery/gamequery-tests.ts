...
$(function () {
    var simpleVerticalAnimation = new $.gameQuery.Animation({
        imageURL: "sv.png",
    ...
    var simpleHorizontalAnimation = new $.gameQuery.Animation({
        imageURL: "sh.png",
    ...
    var multiVerticalAnimation = new $.gameQuery.Animation({
        imageURL: "mv.png",
        type: $.gameQuery.ANIMATION_VERTICAL | $.gameQuery.ANIMATION_MULTI,
        numberOfFrame: 4,
        delta: 32,
        rate: 300,
        distance: 32,
    });
    var multiHorizontalAnimation = new $.gameQuery.Animation({
        imageURL: "mh.png",
    ...
    var simpleOffsetVerticalAnimation = new $.gameQuery.Animation({
        imageURL: "sov.png",
        type: $.gameQuery.ANIMATION_VERTICAL,
        offsetx: 100,
        offsety: 100,
    ...
    var simpleOffsetHorizontalAnimation = new $.gameQuery.Animation({
        imageURL: "soh.png",
        type: $.gameQuery.ANIMATION_HORIZONTAL,
        offsetx: 100,
        offsety: 100,
    ...
    var multiOffsetVerticalAnimation = new $.gameQuery.Animation({
        imageURL: "mov.png",
        type: $.gameQuery.ANIMATION_VERTICAL | $.gameQuery.ANIMATION_MULTI,
        offsetx: 100,
        offsety: 100,
    ...
    var multiOffsetHorizontalAnimation = new $.gameQuery.Animation({
        imageURL: "moh.png",
        type: $.gameQuery.ANIMATION_HORIZONTAL | $.gameQuery.ANIMATION_MULTI,
        offsetx: 100,
        offsety: 100,
    ...
    var pingpongAnimation = new $.gameQuery.Animation({
    ...
    var multiPingpongAnimation = new $.gameQuery.Animation({
        imageURL: "reboundm.png",
        type:
            $.gameQuery.ANIMATION_HORIZONTAL |
            $.gameQuery.ANIMATION_PINGPONG |
            $.gameQuery.ANIMATION_MULTI,
        numberOfFrame: 9,
        delta: 64,
        rate: 60,
        distance: 64,
    ...
    var callbackAnim = new $.gameQuery.Animation({
        imageURL: "sv.png",
        type:
...
$(function () {
    ...
    var tileFun = function (i, j) {
        return 1 + ((i + j) % 3);
    };
    $("#playground").playground({ height: 64, width: 350 });

    $.playground()
        .addTilemap("multiArray", tileDef, multiAnimation, {
            width: 10,
            height: 10,
            sizex: 3,
            sizey: 3,
        ...
        .end()
        .addTilemap("multiFunction", tileFun, multiAnimation, {
            width: 10,
            height: 10,
            sizex: 3,
            sizey: 3,
        ...
        .end()
        .addTilemap("arrayArray", tileDef, animations, {
            width: 10,
            height: 10,
            sizex: 3,
            sizey: 3,
        ...
        .end()
        .addTilemap("arrayFunction", tileFun, animations, {
            width: 10,
            height: 10,
            sizex: 3,
            sizey: 3,
        ...
        .end()
        .addTilemap("multiArrayPingpong", tileDef, multiAnimationPingpong, {
            width: 10,
            height: 10,
            sizex: 3,
            sizey: 3,
        ...
        .end()
        .addTilemap("arrayArrayPingpong", tileDef, animationsPingpong, {
            width: 10,
            height: 10,
            sizex: 3,
            sizey: 3,
        ...
        .end()
        .addGroup("testGroup", { height: 30, width: 30, posx: -40 })
        .addTilemap("outside", tileDef, multiAnimation, {
            width: 10,
            height: 10,
            sizex: 3,
            sizey: 3,
...
$(function () {
    ...
    $.playground()
        ...
        .addTilemap("map1", tileDef, multiAnimation, {
            width: 10,
            height: 10,
            sizex: 9,
            sizey: 3,
        ...
        .end()
        .addTilemap("map2", tileDef, multiAnimation, {
            width: 10,
            height: 10,
            sizex: 9,
            sizey: 3,
        ...
        .addTilemap("map3", tileDef, multiAnimation, {
            width: 10,
            height: 10,
            sizex: 9,
            sizey: 3,
