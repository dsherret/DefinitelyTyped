 ...
 * ```
 */
export interface UnderlyingTypeOverrideRegistry {
...
export interface UnderlyingTypeRegistry
    extends Omit<
            ...
            keyof UnderlyingTypeOverrideRegistry
        >,
        UnderlyingTypeOverrideRegistry {}
 ...
 */
export type UnderlyingType<T extends TypeLike> = T extends Type<infer U>
    ? U
    : // Allow for user-defined type overrides
      T extends keyof UnderlyingTypeOverrideRegistry
      ? UnderlyingTypeOverrideRegistry[T]
      : // Use default type map
        T extends keyof UnderlyingTypeRegistry
        ? UnderlyingTypeRegistry[T]
        : // Coerce pointer types into relevant references.
          T extends `${infer U}*`
          ? Trim<U> extends "char"
              ? string | null // `char*` is a string type
              : Trim<U> extends "byte"
                ? Buffer | Pointer<number> // `byte*` is either a `Buffer` or a `Pointer` to a single byte
                : Trim<U> extends "void"
                  ? Pointer<unknown> // `void*` is a `Pointer` to some unknown value.
...
export type UnderlyingTypes<T extends readonly TypeLike[]> = Extract<
    {
        [P in keyof T]: P extends `${number}`
            ? UnderlyingType<Extract<T[P], TypeLike>>
            : T[P];
    },
    any[]
>;
...
export type CoerceTypes<T extends readonly TypeLike[]> = Extract<
    {
        [P in keyof T]: P extends `${number}`
            ? CoerceType<Extract<T[P], TypeLike>>
            : T[P];
    },
    any[]
>;
 ...
 * Dereferences a type
 */
export type DerefType<T extends TypeLike> = UnderlyingType<T> extends Pointer<
    infer U
>
    ? Type<U>
    : never;
...
export type DerefTypes<T extends readonly TypeLike[]> = Extract<
    {
        [P in keyof T]: P extends `${number}`
            ? DerefType<Extract<T[P], TypeLike>>
            : T[P];
    },
    any[]
>;
...
): [UnderlyingType<TType>] extends [never] | [0]
    ? Pointer<any>
    : UnderlyingType<TType> extends Buffer
 ...
 */
export declare function allocCString(
    string: string,
...
export declare function coerceType<T extends NamedType>(
    type: T,
): Type<UnderlyingType<T>>;
export declare function coerceType<T extends TypeLike>(
    type: T,
): Type<UnderlyingType<T>>;
...
export declare function get<T extends TypeLike>(
    buffer: Buffer,
    offset: number | undefined,
    type: T,
): UnderlyingType<T>;
 ...
 */
export declare function readInt64BE(
    buffer: Buffer,
    offset?: number,
): number | string;
 ...
 * @return {number|string}
 */
export declare function readInt64LE(
    buffer: Buffer,
    offset?: number,
): number | string;
...
export declare function readPointer(
    buffer: Buffer,
    offset?: number,
    length?: number,
): Buffer;
 ...
 * @return {number|string}
 */
export declare function readUInt64BE(
    buffer: Buffer,
    offset?: number,
): string | number;
 ...
 * @return {number|string}
 */
export declare function readUInt64LE(
    buffer: Buffer,
    offset?: number,
): string | number;
...
export declare function refType<T extends NamedTypeLike>(
    type: T,
): Type<Pointer<UnderlyingType<T>>>;
export declare function refType<T extends TypeLike>(
    type: T,
): Type<Pointer<UnderlyingType<T>>>;
 ...
 */
export declare function reinterpret(
    buffer: Buffer,
    size: number,
    offset?: number,
): Buffer;
 ...
 */
export declare function reinterpretUntilZeros(
    buffer: Buffer,
    size: number,
    offset?: number,
): Buffer;
...
export declare function writeCString(
    buffer: Buffer,
    offset: number,
    string: string,
    encoding?: BufferEncoding,
...
export declare function writeInt64BE(
    buffer: Buffer,
    offset: number,
    input: string | number,
): void;
...
export declare function writeInt64LE(
    buffer: Buffer,
    offset: number,
    input: string | number,
): void;
 ...
 */
export declare function writeObject<T>(
    buffer: Pointer<T>,
    offset: 0,
    object: T,
): void;
 ...
 */
export declare function writePointer(
    buffer: Buffer,
    offset: number,
    pointer: Buffer,
): void;
...
export declare function writeUInt64BE(
    buffer: Buffer,
    offset: number,
    input: string | number,
): void;
...
export declare function _reinterpret(
    buffer: Buffer,
    size: number,
    offset?: number,
): Buffer;
...
export declare function _reinterpretUntilZeros(
    buffer: Buffer,
    size: number,
    offset?: number,
): Buffer;
...
export declare function _writePointer(
    buffer: Buffer,
    offset: number,
    pointer: Buffer,
): void;
...
export declare function _writeObject<T>(
    buffer: Pointer<T>,
    offset: 0,
    object: T,
): void;
export declare function _writeObject(
    buffer: Buffer,
    offset: number,
    object: Object,
): void;
 ...
 * ```
 */
export interface TypesOverrideRegistry {
    // eslint-disable-line @typescript-eslint/no-empty-interface
}
...
export interface TypesRegistry
    extends Omit<TypesDefaultRegistry, keyof TypesOverrideRegistry>,
        TypesOverrideRegistry {}
