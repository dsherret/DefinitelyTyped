...
declare namespace kurento {
    ...
    interface ClientInstance {
        ...
        create(
            type: "WebRtcEndpoint",
            options?: { useDataChannels?: boolean | undefined },
        ...
        getMediaobjectById<T extends MediaObject = MediaObject>(
            objectId: string,
        ): Promise<T>;
        getServerManager: (
            callback?: Callback<ServerManager>,
    ...
    interface ServerManager {
        ...
        getPipelines(
            callback?: Callback<MediaPipeline[]>,
        ): Promise<MediaPipeline[]>;
        on(
            event: "ObjectCreated",
            callback: (
                event: Event<"ObjectCreated", { object: string }>,
            ) => void,
        ...
        on(
            ...
            callback: (
                event: Event<"ObjectDestroyed", { objectId: string }>,
            ) => void,
        ): ServerManager;
    }
    ...
    interface UriEndpoint extends Endpoint {
        ...
        getState(
            callback?: Callback<UriEndpointState>,
    ...
    interface RecorderEndpoint extends UriEndpoint {
        ...
        on(
            eventName: "Recording",
            callback: (event: Event<"Recording">) => void,
        ): RecorderEndpoint;
        on(
            eventName: "Paused",
            callback: (event: Event<"Paused">) => void,
        ): RecorderEndpoint;
        on(
            eventName: "Stopped",
            callback: (event: Event<"Stopped">) => void,
        ): RecorderEndpoint;
    ...
    interface RtpEndpoint extends BaseRtpEndpoint {
        ...
        on(
            ...
            callback: (
                event: Event<
                    "MediaStateChanged",
                    { oldState: MediaState; newState: MediaState }
                >,
            ) => void,
        ): RtpEndpoint;
        ...
        on(
            eventName: "OnKeySoftLimit",
            callback: (event: Event<"OnKeySoftLimit">) => void,
        ): RtpEndpoint;
    }
    ...
    interface PlayerEndpoint extends UriEndpoint {
        ...
        on(
            eventName: "EndOfStream",
            callback: (event: Event<"EndOfStream">) => void,
        ): PlayerEndpoint;
    ...
    interface BaseRtpEndpoint extends SdpEndpoint {
        getConnectionState(
            callback?: Callback<ConnectionState>,
    ...
    interface WebRtcEndpoint extends BaseRtpEndpoint {
        ...
        getIceConnectionState: (
            callback?: Callback<IceConnection>,
        ...
        on(
            ...
            callback: (
                event: Event<"DataChannelClose", { channelId: number }>,
            ) => void,
        ): WebRtcEndpoint;
        on(
            event: "DataChannelOpen",
            callback: (
                event: Event<"DataChannelOpen", { channelId: number }>,
            ) => void,
        ): WebRtcEndpoint;
        on(
            event: "IceCandidateFound",
            callback: (
                event: Event<"IceCandidateFound", { candidate: IceCandidate }>,
            ) => void,
        ): WebRtcEndpoint;
        on(
        ...
        on(
            event: "IceGatheringDone",
            callback: (event: Event<"IceGatheringDone">) => void,
        ): WebRtcEndpoint;
        on(
