...
instance.addPlayList(
    ...
    (error: Error, mutateResponses: pm.MutateResponses) => {
        ...
        if (mutateResponses && mutateResponses.mutate_response) {
            mutateResponses.mutate_response.forEach(
                (mutateResponse: pm.MutateResponse) => {
...
instance.incrementTrackPlaycount(
    "songId",
    (error: Error, mutateResponses: pm.MutateResponses) => {
        console.log(error.message);
        console.log(error.name);
