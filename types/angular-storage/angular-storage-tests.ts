...
angular
    .module("angular-storage-tests")
    .controller(
        "StoreController",
        function (store: angular.a0.storage.IStoreService) {
            var myObj = {
                name: "mgonto",
            };
    ...
    .controller(
        "NamespacedStoreController",
        function (Auth0Store: angular.a0.storage.INamespacedStoreService) {
            var myObj = {
                name: "mgonto",
            };
