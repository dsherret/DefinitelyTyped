...
export type RowCustomComponentProps<
...
declare function Row<T extends keyof JSX.IntrinsicElements>(
    props: RowIntrinsicProps<T>,
): FCReturn;
declare function Row<T extends ReactComponentConstructor<never>>(
    props: RowCustomComponentProps<T>,
): FCReturn;
