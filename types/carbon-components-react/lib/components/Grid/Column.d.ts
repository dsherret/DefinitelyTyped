...
declare function Column<T extends keyof JSX.IntrinsicElements>(
    props: ColumnIntrinsicProps<T>,
): FCReturn;
declare function Column<T extends ReactComponentConstructor<never>>(
    props: ColumnCustomComponentProps<T>,
): FCReturn;
