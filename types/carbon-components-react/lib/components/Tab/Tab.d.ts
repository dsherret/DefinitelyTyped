 ...
 */
export interface TabCustomAnchorProviderProps
    extends TabCustomButtonProvidedProps {}

export interface TabStandaloneProps
    extends Omit<ReactLIAttr, ExcludedAttributes> {
    disabled?: boolean | undefined;
    handleTabClick?(
        index: TabStandaloneProps["index"],
     ...
     */
    renderAnchor?:
        | ((props: TabCustomButtonProvidedProps) => React.ReactNode)
        | undefined;
    renderButton?:
        | ((props: TabCustomButtonProvidedProps) => React.ReactNode)
        | undefined;
...
export interface TabProps
    extends Omit<TabStandaloneProps, TabsProvidedPropKeys> {
    ...
    renderContent?:
        | React.ComponentType<TabCustomContentProvidedProps>
        | undefined;
}
