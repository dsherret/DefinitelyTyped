...
export type HeaderMenuItemProps<E extends object = ReactAnchorAttr> = Omit<
    LinkProps<E>,
    ExcludedAttributes
> &
    HeaderMenuItemPropsBase;

declare function HeaderMenuItem<
    E extends object = ReactAnchorAttr,
    R = HTMLElement,
>(props: ForwardRefProps<R, HeaderMenuItemProps<E>>): FCReturn;
