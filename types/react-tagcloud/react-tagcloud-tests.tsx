...
export function MyTagCloud() {
    return (
        <TagCloud
            ...
            onClick={(tag, event) =>
                console.log("click on:", tag.value, event.target)
            }
            onDoubleClick={(tag, event) =>
                console.log("dbl-click on:", tag.value, event.target)
            }
            onMouseMove={(tag, event) =>
                console.log("hover on:", tag.value, event.target)
            }
