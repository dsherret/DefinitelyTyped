...
export function write(
    ...
    length: number,
    position: number,
    callback?: (err: Error, written: number, buffer: Buffer) => void,
): void;
...
export function writeJsonAsync(
    file: string,
    object: any,
    options?: OpenOptions,
): Promise<void>;
...
export function chownAsync(
    path: string,
    uid: number,
    gid: number,
): Promise<void>;
export function fchownAsync(
    fd: number,
    uid: number,
    gid: number,
): Promise<void>;
export function lchownAsync(
    path: string,
    uid: number,
    gid: number,
): Promise<void>;
...
export function openAsync(
    path: string,
    flags: string,
    mode?: string,
): Promise<number>;
export function utimesAsync(
    path: string,
    atime: number,
    mtime: number,
): Promise<void>;
export function futimesAsync(
    fd: number,
    atime: number,
    mtime: number,
): Promise<void>;
...
export function appendFileAsync(
    filename: string,
    data: any,
    option?: OpenOptions | string,
): Promise<void>;
