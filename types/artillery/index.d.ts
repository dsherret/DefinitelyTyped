...
export type ActionFn<
    ...
    TContextFuncs extends Record<string, (...args: any[]) => any> = Record<
        string,
        (...args: any[]) => any
    >,
> = (
...
export interface EventEmitter extends events.EventEmitter {
    ...
    addListener(
        eventName: "match",
        listener: (success: boolean, match: Match) => void,
    ): this;
    addListener(
        eventName: "response",
        listener: (delta: number, code: number, uid: string) => void,
    ): this;
    addListener(
