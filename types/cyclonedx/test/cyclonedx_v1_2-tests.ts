...
export const sbom1_2: CycloneDXBomV1_2 = {
    ...
    metadata: {
        ...
        component: {
            "bom-ref":
                "pkg:composer/cyclonedx/cyclonedx-php-composer-demo@dev-master",
            type: "application",
            name: "cyclonedx-php-composer-demo",
            version: "dev-master",
            group: "cyclonedx",
            description:
                "demo of cyclonedx/cyclonedx-php-composer with a pinned version of laravel/framework",
    ...
    components: [
        {
            ...
            externalReferences: [
                ...
                },
                {
                    ...
                    comment:
                        "As set via `homepage` in composer package definition.",
                },
                {
                    type: "issue-tracker",
                    url: "https://github.com/asm89/stack-cors/issues",
                    comment:
                        "As set via `support.issues` in composer package definition.",
                },
                {
                    type: "distribution",
                    url: "https://github.com/asm89/stack-cors/tree/1.3.0",
                    comment:
                        "As set via `support.source` in composer package definition.",
                },
            ],
        },
        {
            ...
            externalReferences: [
                ...
                },
                {
                    ...
                    comment:
                        "As set via `funding` in composer package definition. (type=github)",
                },
                {
                    type: "other",
                    url: "https://tidelift.com/funding/github/packagist/brick/math",
                    comment:
                        "As set via `funding` in composer package definition. (type=tidelift)",
                },
            ],
        },
        {
            ...
            externalReferences: [
                ...
                },
                {
                    ...
                    comment:
                        "As set via `funding` in composer package definition. (type=custom)",
                },
                {
                    type: "other",
                    url: "https://www.patreon.com/phpdoctrine",
                    comment:
                        "As set via `funding` in composer package definition. (type=patreon)",
                },
                {
                    type: "other",
        ...
        },
        {
            ...
            externalReferences: [
                ...
                },
                {
                    ...
                    url: "https://commonmark.thephpleague.com/",
                    comment:
                        "As set via `support.docs` in composer package definition.",
                },
                {
                    type: "issue-tracker",
                ...
                },
                {
                    ...
                    comment:
                        "As set via `support.rss` in composer package definition.",
                },
                {
                    type: "distribution",
        ...
        },
        {
            ...
            externalReferences: [
                ...
                },
                {
                    ...
                    comment:
                        "As set via `funding` in composer package definition. (type=other)",
                },
            ],
        },
        {
        ...
        },
        {
            ...
            externalReferences: [
                ...
                },
                {
                    ...
                    comment:
                        "As set via `funding` in composer package definition. (type=open_collective)",
                },
                {
                    type: "other",
    ...
    dependencies: [
        ...
        },
        {
            ...
            dependsOn: ["pkg:composer/league/mime-type-detection@1.9.0"],
        },
        {
        ...
        },
        {
            ...
            dependsOn: ["pkg:composer/psr/log@1.1.4"],
        },
        {
        ...
        },
        {
            ...
            dependsOn: ["pkg:composer/symfony/polyfill-php81@1.23.0"],
        },
        {
        ...
        },
        {
            ...
            dependsOn: ["pkg:composer/symfony/polyfill-php80@1.23.1"],
        },
        {
        ...
        },
        {
            ...
            dependsOn: ["pkg:composer/psr/event-dispatcher@1.0.0"],
        },
        {
        ...
        },
        {
            ...
            dependsOn: ["pkg:composer/symfony/css-selector@5.4.0"],
        },
        {
        ...
        },
        {
            ...
            dependsOn: ["pkg:composer/laravel/laravel@7.12.0"],
        },
    ],
};
