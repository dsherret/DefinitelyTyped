...
declare namespace Vex {
    ...
    function SortAndUnique<T extends any[]>(
        arr: T,
        cmp: Function,
        eq: Function,
    ): T;
    ...
    function Inherit<T extends Object>(
        child: T,
        parent: Object,
        object: Object,
    ): T;
    ...
    namespace Flow {
        ...
        function tabToGlyph(fret: string): {
            text: string;
            code: number;
            width: number;
            shift_y: number;
        ...
        function articulationCodes(artic: string): {
            code: string;
            width: number;
            shift_right: number;
            shift_up: number;
        ...
        function accidentalCodes(acc: string): {
            code: string;
            width: number;
        ...
        function ornamentCodes(acc: string): {
            code: string;
            shift_right: number;
            shift_up: number;
            shift_down: number;
        ...
        function parseNoteDurationString(durationString: string): {
            duration: string;
            dots: number;
            type: string;
        };
        ...
        class Bend extends Modifier {
            constructor(
                text: string,
                release?: boolean,
                phrase?: Array<{ type: number; text: string; width: number }>,
            );
            static UP: number;
            static DOWN: number;
            static format(
        ...
        class CanvasContext implements IRenderContext {
            ...
            quadraticCurveToTo(
                ...
                x: number,
                y: number,
            ): void; // inconsistent name: x -> x2, y -> y2
            arc(
                x: number,
                y: number,
                radius: number,
        ...
        namespace Music {
            ...
            const noteValues: {
                [value: string]: { root_index: number; int_val: number };
            };
        }
        ...
        class RaphaelContext implements IRenderContext {
            ...
            quadraticCurveTo(
                ...
                x: number,
                y: number,
            ): RaphaelContext; // inconsistent name: x, y -> x2, y2
            arc(
                x: number,
                y: number,
                radius: number,
            ...
            glow(): {
                ...
                offsety: number;
                color: string;
            }; // inconsistent type : Object -> RaphaelContext
            fill(): RaphaelContext;
        ...
        class Stave {
            ...
            setText(
                ...
                options?: {
                    shift_x?: number | undefined;
                    shift_y?: number | undefined;
                    justification?: TextNote.Justification | undefined;
                },
            ): Stave;
            getHeight(): number;
            ...
            setConfigForLines(
                lines_configuration: Array<{ visible: boolean }>,
            ): Stave;
        ...
        class StaveConnector {
            ...
            }): void; // inconsistent type: void -> StaveConnector
        ...
        class Stroke extends Modifier {
            constructor(
                type: Stroke.Type,
                options?: { all_voices?: boolean | undefined },
            );
            static format(
                strokes: Stroke[],
                state: {
        ...
        class SVGContext implements IRenderContext {
            ...
            quadraticCurveTo(
                ...
                x: number,
                y: number,
            ): SVGContext; // inconsistent: x, y -> x2, y2
            arc(
                x: number,
                y: number,
                radius: number,
        ...
        namespace TimeSignature {
            const glyphs: {
                [name: string]: { code: string; point: number; line: number };
            };
        }
        ...
        class Voice {
            constructor(time: {
                num_beats?: number | undefined;
                beat_value?: number | undefined;
