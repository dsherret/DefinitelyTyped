...
export interface BaseUserMigrationTriggerEvent<T extends string>
...
export type UserMigrationAuthenticationTriggerEvent =
    BaseUserMigrationTriggerEvent<"UserMigration_Authentication">;

export type UserMigrationForgotPasswordTriggerEvent =
