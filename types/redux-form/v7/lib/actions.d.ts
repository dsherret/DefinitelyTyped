...
export declare function updateSyncErrors<T = any>(
    from: string,
    syncErrors: FormErrors<FormData, T>,
    error: T,
): FormAction;
export declare function updateSyncWarnings<T = any>(
    form: string,
    syncWarnings: FormWarnings<FormData, T>,
    warning: T,
): FormAction;
