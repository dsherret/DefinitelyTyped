...
import {
    IPageVersion,
    IPageVersionPriorityGroup,
    IPageVersionProperties,
} from "./interfaces/IPageInterfaces";
    ...
    namespace Digispace {
        ...
        class Utilities {
            ...
            static GetPropertyValue(
                ...
                defaultValue: string,
                dataType: string,
            ): any; // Boolean, string, number, JSON object
        ...
        namespace Data {
            ...
            class PageFactory {
                ...
                ): JQueryDeferred<IPageVersionProperties>;
                GetPageVersion(
                    pageVersionId: string,
                ): JQueryDeferred<IPageVersionProperties>;
                DeletePageVersion(
