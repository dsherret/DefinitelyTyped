...
export function useLDflex(
    expression: string,
    listMode: true,
): [LDflexValue[], boolean, Error | undefined];
export function useLDflex(
    expression: string,
    listMode?: false,
): [LDflexValue, boolean, Error | undefined];
...
export interface ListProps {
    ...
    children?:
        | ((listItem: LDflexValue, index: number) => JSX.Element)
        | undefined;
}
...
> {}
export class LiveUpdate extends React.Component<{
    subscribe?: "*" | string | string[] | undefined;
}> {}
