...
binarySearch(
    [
        new Record(new Date(21)),
        new Record(new Date(42)),
        new Record(new Date(91)),
        new Record(new Date(91)),
    ],
...
binarySearch([21, 42, 91, 91], 40, (a: number, b: number) =>
    a === b ? 0 : a < b ? -1 : 1,
);
// 1
binarySearch(
...
binarySearch(
    ["G", "KG", "KG", "MG"],
    "KG",
    (a: string, b: string, i: number, arr: readonly string[]) =>
        a.localeCompare(b),
    null,
    1,
    4,
