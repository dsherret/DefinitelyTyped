...
export interface Entity {
    ...
    getActionByClasses(
        actionClasses: ReadonlyArray<string | RegExp>,
    ): Action | undefined;
    getActionsByClasses(
        actionClasses: ReadonlyArray<string | RegExp>,
    ): Action[];
    ...
    getLinkByClasses(
        linkClasses: ReadonlyArray<string | RegExp>,
    ): Link | undefined;
    ...
    getSubEntityByRels(
        entityRels: ReadonlyArray<string | RegExp>,
    ): Entity | undefined;
    ...
    getSubEntityByClasses(
        entityClasses: ReadonlyArray<string | RegExp>,
    ): Entity | undefined;
