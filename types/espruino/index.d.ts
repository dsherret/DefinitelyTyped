...
declare namespace NRF {
    ...
    /**
     * @url https://www.espruino.com/Reference#l_NRF_connect
     * @url https://www.espruino.com/Reference#l_NRF_disconnect
     * @url https://www.espruino.com/Reference#l_NRF_HID
     ...
     * The UUID should be a Bluetooth Service ID.
     *
     * The UUID can refer to the existing assigned numbers:
     ...
     * Lowering the interval (eg. more packets/second) means a lower delay
     * when sending data, higher bandwidth, but also more power consumption.
     *
     * By default, when connected as a peripheriral Espruino automatically
     * adjusts the connection interval.
     * When connected it's as fast as possible (7.5 ms) but when idle for
     * over a minute it drops to 200 ms.
     * On continued activity (>1 BLE operation), the interval is raised
     * to 7.5 ms again.
     *
    ...
    /**
     * The raw scan response data should be supplied as an array.
     *
     * @param data The data to for the scan response
     */
    function setScanResponse(data: Array<number | string>): void;
...
declare interface BluetoothRemoteGATTServer {
     ...
     */
    getPrimaryService(service: any): Promise<BluetoothRemoteGATTService>;
