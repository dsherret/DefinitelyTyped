...
export default class FetchQueue extends Array {
    add(
        queueItem: QueueItem,
        force?: boolean,
        callback?: (error?: Error, queueItem?: QueueItem) => void,
    ): void;
    exists(
        url: string,
        callback: (error: Error | null, exists: 0 | 1) => void,
    ): void;
    get(
        index: number,
        callback?: (error?: Error, queueItem?: QueueItem) => void,
    ...
    max(
        ...
        callback?: (error?: Error, maximum?: number) => void,
    ): void;
    min(
        statisticName: string,
        callback?: (error?: Error, minimum?: number) => void,
    ): void;
    avg(
        statisticName: string,
        callback?: (error?: Error, average?: number) => void,
    ): void;
    countItems(
        comparator: object,
    ...
    filterItems(
        comparator: object,
        callback?: (error?: Error, items?: QueueItem[]) => void,
    ): void;
