...
export function get_commandAsync(
    options: optionsType,
    command: string,
): Promise<any>;
export function post_command(
    options: optionsType,
    command: string,
    body: object,
    callback: nodeBack,
): void;
export function post_commandAsync(
    options: optionsType,
    command: string,
    body: object,
): Promise<any>;
...
export function mobileEnabledAsync(
    options: optionsType,
...
export function scheduleSoftwareUpdateAsync(
    options: optionsType,
): Promise<Result>;
export function cancelSoftwareUpdate(options: optionsType, callback: any): any;
export function cancelSoftwareUpdateAsync(
    options: optionsType,
): Promise<Result>;
...
export function mediaPlayNextFavoriteAsync(
    options: optionsType,
): Promise<Result>;
export function mediaPlayPreviousFavorite(
    options: optionsType,
    callback: any,
): any;
export function mediaPlayPreviousFavoriteAsync(
    options: optionsType,
): Promise<Result>;
...
export function speedLimitActivate(
    options: optionsType,
    pin: number,
    callback: any,
): any;
export function speedLimitActivateAsync(
    options: optionsType,
    pin: number,
): Promise<Result>;
export function speedLimitDeactivate(
    options: optionsType,
    pin: number,
    callback: any,
): any;
export function speedLimitDeactivateAsync(
    options: optionsType,
    pin: number,
): Promise<Result>;
export function speedLimitClearPin(
    options: optionsType,
    pin: number,
    callback: any,
): any;
export function speedLimitClearPinAsync(
    options: optionsType,
    pin: number,
): Promise<Result>;
export function speedLimitSetLimit(
    options: optionsType,
    limit: number,
    callback: any,
): any;
export function speedLimitSetLimitAsync(
    options: optionsType,
    limit: number,
): Promise<Result>;
...
export function setSentryModeAsync(
    options: optionsType,
    onoff: boolean,
): Promise<Result>;
export function seatHeater(
    options: optionsType,
    heater: number,
    level: number,
    callback: any,
): any;
export function seatHeaterAsync(
    options: optionsType,
    heater: number,
    level: number,
): Promise<Result>;
export function steeringHeater(
    options: optionsType,
    level: number,
    callback: any,
): any;
export function steeringHeaterAsync(
    options: optionsType,
    level: number,
): Promise<Result>;
export function maxDefrost(
    options: optionsType,
    onoff: boolean,
    callback: any,
): any;
export function maxDefrostAsync(
    options: optionsType,
    onoff: boolean,
): Promise<Result>;
...
export function windowControlAsync(
    options: optionsType,
    command: string,
): Promise<Result>;
...
export function setChargeLimitAsync(
    options: optionsType,
    amt: any,
): Promise<Result>;
...
export function sunRoofControl(
    options: optionsType,
    state: string,
    callback: nodeBack,
): void;
export function sunRoofControlAsync(
    options: optionsType,
    state: string,
): Promise<Result>;
export function sunRoofMove(
    options: optionsType,
    percent: any,
    callback: nodeBack,
): void;
export function sunRoofMoveAsync(
    options: optionsType,
    percent: any,
): Promise<Result>;
...
export function remoteStartAsync(
    options: optionsType,
    password: string,
): Promise<Result>;
...
export function openTrunkAsync(
    options: optionsType,
    which: string,
): Promise<Result>;
...
export function setValetModeAsync(
    options: optionsType,
    onoff: boolean,
    pin: any,
): Promise<Result>;
