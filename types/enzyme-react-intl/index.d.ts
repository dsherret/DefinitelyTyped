...
export function mountWithIntl<
    ...
    P = C["props"],
    S = C["state"],
>(node: ReactElement<P>, options?: MountRendererProps): ReactWrapper<P, S, C>;
...
// eslint-disable-next-line @definitelytyped/no-unnecessary-generics
export function renderWithIntl<P, S>(
    node: ReactElement<P>,
    options?: any,
): cheerio.Cheerio;
...
export function loadTranslationObject<T extends { [key: string]: string }>(
    translations: T,
): T;
