...
```
     */
    closest(
        selector_selection_element: JQuery.Selector | Element | JQuery,
    ): this;
    /**
...
```
    ...
    find<E extends HTMLElement>(
        selector_element: JQuery.Selector | Element | E | JQuery<E>,
    ): JQuery<E>;
    /**
