 ...
 */
declare function deasync<TResult>(
    fn: (callback: CallbackWithResult<TResult>) => void,
): () => TResult;
declare function deasync(
    fn: (callback: CallbackWithoutResult) => void,
): () => void;
declare function deasync<T1, TResult>(
    fn: (arg1: T1, callback: CallbackWithResult<TResult>) => void,
): (arg1: T1) => TResult;
declare function deasync<T1>(
    fn: (arg1: T1, callback: CallbackWithoutResult) => void,
): (arg1: T1) => void;
...
declare function deasync<T1, T2, T3, TResult>(
    fn: (
        ...
        arg2: T2,
        arg3: T3,
        callback: CallbackWithResult<TResult>,
    ) => void,
