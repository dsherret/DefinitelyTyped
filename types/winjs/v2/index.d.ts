...
declare namespace WinJS.UI.Animation {
     ...
     */
    function createPageNavigationAnimation(
        currentPreferredAnimation: PageNavigationAnimation,
        nextPreferredAnimation: PageNavigationAnimation,
    ...
    function slideRightIn(
        page: any,
        firstIncomingElements: any,
        secondIncomingElements: any,
        thirdIncomingElements: any,
    ): Promise<any>;
    ...
    function slideRightOut(
        page: any,
        firstOutgoingElements: any,
        secondOutgoingElements: any,
        thirdOutgoingElements: any,
    ): Promise<any>;
...
declare namespace WinJS.UI {
    ...
    interface ILayout {
        ...
        getKeyboardNavigatedItem(
            itemIndex: number,
            element: HTMLElement,
            keyPressed: WinJS.Utilities.Key,
        ): Promise<number>;
