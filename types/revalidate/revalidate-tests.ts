...
const lessThan = r.hasLengthLessThan(16)({
    message: "Must be 15 characters or less",
});

const username = r.composeValidators(customIsRequired, lessThan)();

const email = r.composeValidators(customIsRequired, isValidEmail)();
...
const age = r.composeValidators(customIsRequired, isNumber, isGreater)();
