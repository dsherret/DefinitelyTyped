...
export function variant<
    ...
    // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
    TPropName = string,
>(props: VariantArgs<TStyle, K, TPropName>): (...args: any[]) => any;
/**
...
export interface FontFamilyProps<ThemeType extends Theme = RequiredTheme> {
    fontFamily?:
        | ResponsiveValue<CSS.Property.FontFamily, ThemeType>
        | undefined;
}
...
export interface AlignItemsProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    alignItems?:
        | ResponsiveValue<CSS.Property.AlignItems, ThemeType>
        | undefined;
}
...
export interface AlignContentProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    alignContent?:
        | ResponsiveValue<CSS.Property.AlignContent, ThemeType>
        | undefined;
}
...
export interface JustifyItemsProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    justifyItems?:
        | ResponsiveValue<CSS.Property.JustifyItems, ThemeType>
        | undefined;
}
...
export interface JustifySelfProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    justifySelf?:
        | ResponsiveValue<CSS.Property.JustifySelf, ThemeType>
        | undefined;
}
...
export interface FlexShrinkProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    flexShrink?:
        | ResponsiveValue<CSS.Property.FlexShrink, ThemeType>
        | undefined;
}
...
export interface GridColumnProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    gridColumn?:
        | ResponsiveValue<CSS.Property.GridColumn, ThemeType>
        | undefined;
}
...
export interface GridAutoFlowProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    gridAutoFlow?:
        | ResponsiveValue<CSS.Property.GridAutoFlow, ThemeType>
        | undefined;
}
...
export interface BorderStyleProps<ThemeType extends Theme = RequiredTheme> {
     ...
     */
    borderStyle?:
        | ResponsiveValue<CSS.Property.BorderStyle, ThemeType>
        | undefined;
    /**
