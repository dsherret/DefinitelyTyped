...
app.config(function (
    localStorageServiceProvider: angular.localForage.ILocalForageProvider,
) {
    // TODO
});
...
$localForage
    .setItem(["myName", "myPassion", "myHobbie"], values)
    .then(function (data) {
...
$localForage.removeItem(["myName", "myPassion"]).then(function () {
    $localForage
        .getItem(["myName", "myPassion", "myHobbie"])
        .then(function (data) {});
});
...
$localForage
    .bind($rootScope, { key: "key", defaultValue: "defaultValue" })
    .then(function (data) {});

$localForage
    .bind($rootScope, { key: "key", scopeKey: "scopeKey" })
    .then(function (data) {});

$localForage
    .bind($rootScope, { key: "key", name: "name" })
    .then(function (data) {});
