...
$(function () {
    ...
    if (
        $.param.querystring() !== params_init ||
        $.param.fragment() !== params_init
    ) {
    ...
    QUnit.test("jQuery.param.sorted", function () {
        var tests: any[] = [
            ...
            {
                obj: {
                    a: [[4, [5, 6] as any] as any, [[7, 8] as any, 9] as any],
                },
                traditional: false,
                expected:
                    "a[0][]=4&a[0][1][]=5&a[0][1][]=6&a[1][0][]=7&a[1][0][]=8&a[1][]=9",
        ...
        QUnit.assert.equal(
            $.param.fragment("foo", "#b=2&a=1", 1),
            "foo#a=1&b=2",
            "params should be sorted",
        );
        QUnit.assert.equal(
            $.param.fragment("foo", "#b=2&a=1", 2),
            "foo#b=2&a=1",
    ...
    QUnit.test("jQuery.param.querystring", function () {
        ...
        QUnit.assert.equal(
            $.param.querystring("http://example.com/"),
            "",
            "properly identifying params",
        );
        QUnit.assert.equal(
            $.param.querystring("http://example.com/?foo"),
            "foo",
            "properly identifying params",
        );
        QUnit.assert.equal(
            $.param.querystring("http://example.com/?foo#bar"),
            "foo",
            "properly identifying params",
        );
        QUnit.assert.equal(
        ...
        QUnit.assert.equal(
            $.param.querystring(),
            params_str,
            "params string from window.location",
        );
        QUnit.assert.equal(
            $.param.querystring("?" + params_str),
            params_str,
            "params string from url",
        );
        QUnit.assert.equal(
            $.param.querystring("foo.html?" + params_str),
            params_str,
            "params string from url",
        );
        QUnit.assert.equal(
            $.param.querystring(
                "http://a:b@example.com:1234/foo.html?" + params_str,
            ),
            params_str,
            "params string from url",
        );
        QUnit.assert.equal(
            $.param.querystring(
                "http://a:b@example.com:1234/foo.html?" +
                    params_str +
                    "#bippity-boppity-boo",
            ),
            params_str,
        ...
        run_many_tests(
            ...
            function () {
                current_url = $.param.querystring.apply(
                    this,
                    [current_url].concat(aps.call(arguments)),
                );
            },
            // tests:
            ...
            [
                "http://example.com/test.html?/path/to/file.php#the-cow-goes-moo" as any,
                2,
            ],
            function (result) {
                QUnit.assert.equal(
    ...
    QUnit.test("jQuery.param.fragment", function () {
        ...
        QUnit.assert.equal(
            $.param.fragment("http://example.com/"),
            "",
            "properly identifying params",
        );
        QUnit.assert.equal(
            $.param.fragment("http://example.com/?foo"),
            "",
            "properly identifying params",
        );
        QUnit.assert.equal(
            $.param.fragment("http://example.com/?foo#bar"),
            "bar",
            "properly identifying params",
        );
        QUnit.assert.equal(
        ...
        QUnit.assert.equal(
            $.param.fragment("#" + params_str),
            params_str,
            "params string from url",
        );
        QUnit.assert.equal(
            $.param.fragment("foo.html#" + params_str),
            params_str,
            "params string from url",
        );
        QUnit.assert.equal(
        ...
        QUnit.assert.equal(
            $.param.fragment(
                "http://a:b@example.com:1234/foo.html?bippity-boppity-boo#" +
                    params_str,
            ),
            params_str,
            "params string from url",
    ...
    QUnit.test("jQuery.param.fragment - build URL", function () {
        ...
        run_many_tests(
            ...
            function (result) {
                ...
                QUnit.assert.equal(
                    current_url,
                    pre + fake_encode(params),
                    "$.param.fragment( url, Object, 2 )",
                );
            },
            [{ a: "1", c: "2" } as any, 1],
            function (result) {
            ...
            function (result) {
                ...
                QUnit.assert.equal(
                    current_url,
                    pre + fake_encode(params),
                    "$.param.fragment( url, String, 1 )",
                );
            },
            [
                "http://example.com/test.html?the-cow-goes-moo#/path/to/file.php" as any,
                2,
            ],
            function (result) {
                QUnit.assert.equal(
                    current_url,
                    pre + "#/path/to/file.php",
    ...
    QUnit.test("jQuery.param.fragment.ajaxCrawlable", function () {
        ...
        QUnit.assert.equal(
            ajaxcrawlable_init,
            false,
            "ajaxCrawlable is disabled by default",
        );
        QUnit.assert.equal(
            $.param.fragment.ajaxCrawlable(true),
            true,
            "enabling ajaxCrawlable should return true",
        );
        QUnit.assert.equal(
            $.param.fragment.ajaxCrawlable(),
            true,
            "ajaxCrawlable is now enabled",
        );
        QUnit.assert.equal(
            $.param.fragment.ajaxCrawlable(false),
            false,
            "disabling ajaxCrawlable should return false",
        );
        QUnit.assert.equal(
            $.param.fragment.ajaxCrawlable(),
            false,
            "ajaxCrawlable is now disabled",
        );
    });
    ...
    QUnit.test("jQuery.deparam.querystring", function () {
        ...
        QUnit.assert.deepEqual(
            $.deparam.querystring(),
            params_obj,
            "params obj from window.location",
        );
        QUnit.assert.deepEqual(
        ...
        QUnit.assert.deepEqual(
            $.deparam.querystring(params_str),
            params_obj,
        ...
        QUnit.assert.deepEqual(
            $.deparam.querystring("foo.html?" + params_str),
            params_obj,
            "params obj from string",
        );
        QUnit.assert.deepEqual(
    ...
    QUnit.test("jQuery.fn.querystring", function () {
        ...
        run_many_tests(
            ...
            function () {
                ...
                QUnit.assert.equal(
                    elems.querystring.apply(
                        elems,
                        ["arbitrary_attr"].concat(aps.call(arguments)),
                    ),
                    elems,
                    "pass query string",
                );
                ...
                QUnit.assert.equal(
                    elems.querystring.apply(
                        elems,
                        ["href"].concat(aps.call(arguments)),
                    ),
                    elems,
                    "pass query string",
                );
                ...
                QUnit.assert.equal(
                    elems.querystring.apply(elems, aps.call(arguments)),
                    elems,
                    "pass query string",
                );
    ...
    QUnit.test("jQuery.fn.fragment", function () {
        ...
        function test_fn_fragment(url, params, merge_mode?) {
            ...
            QUnit.assert.equal(
                elems.fragment("arbitrary_attr", params, merge_mode),
                elems,
                "pass fragment",
            );
            ...
            QUnit.assert.equal(
                elems.fragment(params, merge_mode),
                elems,
                "pass fragment",
            );
        ...
        QUnit.assert.equal(
            test_fn_fragment("foo", {}),
            "foo#!",
            "$.fn.fragment( url, Object )",
        );
        QUnit.assert.equal(
            test_fn_fragment("foo", { b: 2, a: 1 }),
            "foo#!a=1&b=2",
            "$.fn.fragment( url, Object )",
        );
        QUnit.assert.equal(
    ...
    QUnit.test(
        ...
        function () {
            ...
            QUnit.assert.equal(
                ...
                "",
                "window.location hash should be empty",
            );
            ...
            $(window)
                .bind("hashchange", function (evt) {
                    ...
                    obj = {
                        str: $.bbq.getState(),
                        coerce: $.bbq.getState(true),
                    };
                    a = {
                        str: $.bbq.getState("a"),
                        coerce: $.bbq.getState("a", true),
                    };
                    b = {
                        str: $.bbq.getState("b"),
                        coerce: $.bbq.getState("b", true),
                    };
                    c = {
                        str: $.bbq.getState("c"),
                        coerce: $.bbq.getState("c", true),
                    };
                    d = {
                        str: $.bbq.getState("d"),
                        coerce: $.bbq.getState("d", true),
                    };
                    e = {
                        str: $.bbq.getState("e"),
                        coerce: $.bbq.getState("e", true),
                    };
                    f = {
                        str: $.bbq.getState("f"),
                        coerce: $.bbq.getState("f", true),
                    };
                })
                .trigger("hashchange");
            ...
            QUnit.assert.equal(
                a.str,
                "1",
                'hashchange triggered manually: $.bbq.getState( "a" )',
            );
            QUnit.assert.equal(
                a.coerce,
                1,
                'hashchange triggered manually: $.bbq.getState( "a", true )',
            );
            ...
            if (!old_jquery) {
                ...
                QUnit.assert.equal(
                    event.getState("a"),
                    "1",
                    'hashchange triggered manually: event.getState( "a" )',
                );
                QUnit.assert.equal(
            ...
            run_many_tests(
                ...
                function (result) {
                    ...
                    QUnit.assert.deepEqual(
                        obj.str,
                        { a: ["4", "5", "6"], b: b_str } as any,
                        "$.bbq.getState()",
                    );
                    QUnit.assert.deepEqual(
                        obj.coerce,
                        { a: [4, 5, 6], b: b_coerce } as any,
                        "$.bbq.getState( true )",
                    );
                    QUnit.assert.deepEqual(
                        a.str,
                ...
                function (result) {
                    QUnit.assert.equal(
                        hash,
                        "omg_ponies",
                        "event handler 1: $.param.fragment()",
                    );
                    QUnit.assert.equal(
                        x,
                        "omg_ponies",
                        "event handler 2: $.param.fragment()",
                    );
                ...
                function (result) {
                    ...
                    QUnit.assert.ok(
                        !events || !events.hashchange,
                        "hashchange event unbound",
                    );
                },
                ["#"],
                function (result) {
