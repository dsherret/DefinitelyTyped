function test_api() {
    ...
    var absUrl = $.mobile.path.makeUrlAbsolute(
        "#bar",
...
function test_pagesDialogs() {
    ...
    $(document).delegate("#aboutPage", "pageinit", function () {
        alert(
            'A page with an id of "aboutPage" was just created by jQuery Mobile!',
        );
    });
    $(document).delegate("#aboutPage", "pagebeforecreate", function () {
        alert(
            'A page with an id of "aboutPage" is about to be created by jQuery Mobile!',
        );
    });
    $.mobile.changePage("about/us.html", { transition: "slideup" });
    $.mobile.changePage("searchresults.php", {
...
function test_collapsible() {
    ...
    $.mobile.collapsibleset.prototype.options.initSelector =
        ".mycollapsibleset";
    $.mobile.collapsible.prototype.options.inset = false;
...
function test_listview() {
    ...
    $.mobile.listview.prototype.options.filterCallback = function (
        ...
        return (
            text.toLowerCase().substring(0, searchValue.length) !== searchValue
        );
    };
