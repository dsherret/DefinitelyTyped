...
type ThinNestedEntryPointParamsObject<
    TPreloadedEntryPoints extends Record<
        string,
        EntryPoint<any, any> | undefined
    > = {},
> = {
    [K in keyof TPreloadedEntryPoints]: ThinNestedEntryPointParams<
        TPreloadedEntryPoints[K]
    >;
};

type PreloadedQueries<TPreloadedQueries> = TPreloadedQueries extends Record<
    string,
    OperationType
>
    ? {
...
type PreloadedEntryPoints<TPreloadedEntryPoints> =
    TPreloadedEntryPoints extends Record<
        string,
...
> extends Readonly<{
        entryPoints?:
            | ThinNestedEntryPointParamsObject<TPreloadedEntryPoints>
            | undefined;
