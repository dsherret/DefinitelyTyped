...
export type RelayFragmentContainer<TComponent extends React.ElementType> =
    React.ComponentType<
        ContainerProps<React.ComponentPropsWithoutRef<TComponent>>
    >;

export type RelayPaginationContainer<TComponent extends React.ElementType> =
    React.ComponentType<
        ContainerProps<React.ComponentPropsWithoutRef<TComponent>>
    >;

export type RelayRefetchContainer<TComponent extends React.ElementType> =
    React.ComponentType<
        ContainerProps<React.ComponentPropsWithoutRef<TComponent>>
    >;

type PropsWithoutRelay<
...
export function createFragmentContainer<
    C extends React.ComponentType<
        React.ComponentProps<C> & { relay?: RelayProp | undefined }
    >,
>(
    Component: C,
...
export function createPaginationContainer<
    C extends React.ComponentType<
        React.ComponentProps<C> & { relay: RelayPaginationProp }
    >,
>(
    Component: C,
    fragmentSpec: Record<string, GraphQLTaggedNode>,
...
export function createRefetchContainer<
    C extends React.ComponentType<
        React.ComponentProps<C> & { relay: RelayRefetchProp }
    >,
>(
    Component: C,
    fragmentSpec: Record<string, GraphQLTaggedNode>,
