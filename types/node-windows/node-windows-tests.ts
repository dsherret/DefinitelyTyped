import { EventLogger, LogMode, Service } from "node-windows";
...
service.on("invalidinstallation", () =>
    log.error("Invalid Installation", 2002),
);
