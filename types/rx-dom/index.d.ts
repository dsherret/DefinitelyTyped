...
declare module "rx" {
    namespace DOM {
        ...
        // Ajax
        function ajax(
            settingsOrUrl: AjaxSettings | string,
        ): Rx.Observable<AjaxSuccessResponse>;
        ...
        function jsonpRequest(
            settings: JsonpSettings,
        ): Rx.Observable<JsonpSuccessResponse>;

        // Server-Sent Events
        function fromEventSource<T>(
            url: string,
            openObservable?: Rx.Observer<T>,
        ): Rx.Observable<T>;
        ...
        ): Rx.Observable<MutationEvent>;

        // Geolocation
        namespace geolocation {
            function getCurrentPosition(
                geolocationOptions?: GeolocationOptions,
            ): Rx.Observable<GeolocationPosition>;
