...
agent = new httpAgent.HttpAgent("https://api.github.com", [
    { method: "GET", uri: "octocat?test=1" },
]);
agent = new httpAgent.HttpAgent("example.com", ["/", "page", "another"]);
agent = new httpAgent.HttpAgent("example.com", ["/", "page", "another"], {
    encoding: "utf8",
});
agent = new httpAgent.HttpAgent({
    host: "example.com",
    urls: ["/", "page", "another"],
    encoding: "utf8",
});
agent = new httpAgent.HttpAgent({ host: "example.com", encoding: "utf8" }, [
    "/",
    "page",
    "another",
]);
agent = httpAgent.create("https://api.github.com", [
    { method: "GET", uri: "octocat?test=1" },
]);
agent = httpAgent.create({ host: "example.com", encoding: "utf8" }, [
    "/",
    "page",
    "another",
]);
