...
interface OvenPlayerHandler {
    ...
    (
        evnetName: "ready",
        callback: (eventData: OvenPlayerEvents["ready"]) => void,
    ): void;
    /**
     * It occurs when new metadata is received.
     */
    (
        evnetName: "metaChanged",
        callback: (eventData: OvenPlayerEvents["metaChanged"]) => void,
    ): void;
    /**
     * It occurs when the state of a player changes.
     */
    (
        evnetName: "stateChanged",
        callback: (eventData: OvenPlayerEvents["stateChanged"]) => void,
    ): void;
    /**
    ...
    (
        evnetName: "resized",
        callback: (eventData: OvenPlayerEvents["resized"]) => void,
    ): void;
    /**
     * Fired when the playback rate has been changed
     */
    (
        evnetName: "playbackRateChanged",
    ...
    (
        evnetName: "seek",
        callback: (eventData: OvenPlayerEvents["seek"]) => void,
    ): void;
    /**
    ...
    (
        evnetName: "time",
        callback: (eventData: OvenPlayerEvents["time"]) => void,
    ): void;
    /**
     * Fired when the currently playing item loads additional data into its buffer.
     */
    (
        evnetName: "bufferChanged",
        callback: (eventData: OvenPlayerEvents["bufferChanged"]) => void,
    ): void;
    /**
    ...
    (
        evnetName: "mute",
        callback: (eventData: OvenPlayerEvents["mute"]) => void,
    ): void;
    /**
     * Triggered when the player's volume is changed.
     */
    (
        evnetName: "volumeChanged",
        callback: (eventData: OvenPlayerEvents["volumeChanged"]) => void,
    ): void;
    /**
     ...
     */
    (
        evnetName: "playlistChanged",
        callback: (eventData: OvenPlayerEvents["playlistChanged"]) => void,
    ): void;
    /**
     ...
     */
    (
        evnetName: "sourceChanged",
        callback: (eventData: OvenPlayerEvents["sourceChanged"]) => void,
    ): void;
    /**
     ...
     */
    (
        evnetName: "cueChanged",
        callback: (eventData: OvenPlayerEvents["cueChanged"]) => void,
    ): void;
    /**
    ...
    (
        ...
        callback: (
            eventData: OvenPlayerEvents["timeDisplayModeChanged"],
        ) => void,
    ): void;
    /**
    ...
    (
        evnetName: "adChanged",
        callback: (eventData: OvenPlayerEvents["adChanged"]) => void,
    ): void;
    /**
    ...
    (
        evnetName: "adTime",
        callback: (eventData: OvenPlayerEvents["adTime"]) => void,
    ): void;
    /**
     * Fired when Ad is complete.
     */
    (
        evnetName: "adComplete",
        callback: (eventData: OvenPlayerEvents["adComplete"]) => void,
    ): void;
    /**
     * Fired when screen mode is changed.
     */
    (
        evnetName: "fullscreenChanged",
        callback: (eventData: OvenPlayerEvents["fullscreenChanged"]) => void,
    ): void;
    /**
    ...
    (
        evnetName: "clicked",
        callback: (eventData: OvenPlayerEvents["clicked"]) => void,
    ): void;
    /**
     * Fired when the all playlist is complete.
     */
    (
        evnetName: "allPlaylistEnded",
        callback: (eventData: OvenPlayerEvents["allPlaylistEnded"]) => void,
    ): void;
    /**
     * Triggered when HLS object is initialized and ready to use.
     */
    (
        evnetName: "hlsPrepared",
        callback: (eventData: OvenPlayerEvents["hlsPrepared"]) => void,
    ): void;
    /**
     * Triggered after HLS object is destroyed.
     */
    (
        evnetName: "hlsDestroyed",
        callback: (eventData: OvenPlayerEvents["hlsDestroyed"]) => void,
    ): void;
    /**
     * Triggered when DASH object is initialized and ready to use.
     */
    (
        evnetName: "dashPrepared",
        callback: (eventData: OvenPlayerEvents["dashPrepared"]) => void,
    ): void;
    /**
     * Triggered after DASH object is destroyed.
     */
    (
        evnetName: "dashDestroyed",
        callback: (eventData: OvenPlayerEvents["dashDestroyed"]) => void,
    ): void;
    /**
     * Player is destroyed.
     */
    (
        evnetName: "destroy",
        callback: (eventData: OvenPlayerEvents["destroy"]) => void,
    ): void;
    /**
     * Error occurred.
     * @internal
    ...
    (
        evnetName: "error",
        callback: (eventData: OvenPlayerEvents["error"]) => void,
    ): void;
}
