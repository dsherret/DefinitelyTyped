...
export function babelInclude(
    options: TransformOptions["include"],
): OverrideFunc;
export function babelExclude(
    options: TransformOptions["exclude"],
): OverrideFunc;
...
export function fixBabelImports(
    libraryName: string,
    options: any,
): OverrideFunc;
