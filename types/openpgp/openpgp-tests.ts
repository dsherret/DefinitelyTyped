...
openpgp.crypto.crypto.publicKeyDecrypt(
    openpgp.enums.publicKey.rsa_encrypt,
    mpis,
    mpis,
    "",
);
openpgp.crypto.crypto.publicKeyEncrypt(
    openpgp.enums.publicKey.rsa_encrypt,
    mpis,
    mpi,
    "",
...
message.packets.findPacket(
    openpgp.enums.packet.literal,
) as openpgp.packet.Literal;
