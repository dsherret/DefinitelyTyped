...
declare namespace SeamlessImmutable {
    ...
    interface ImmutableObjectMixin<T> {
        ...
        getIn<K extends keyof T>(
            propertyPath: [K],
            defaultValue: T[K],
        ): Immutable<T[K]>;
        getIn<K extends keyof T, L extends keyof T[K]>(
            propertyPath: [K, L],
        ): Immutable<T[K][L]>;
        getIn<K extends keyof T, L extends keyof T[K]>(
            propertyPath: [K, L],
        ...
        asMutable(opts?: AsMutableOptions<false>): {
            [K in keyof T]: Immutable<T[K]>;
        };
        asMutable(opts: AsMutableOptions<true>): T;
        asMutable(
            opts: AsMutableOptions,
        ): T | { [K in keyof T]: Immutable<T[K]> };

        merge(
            part: DeepPartial<T | Immutable<T>>,
            config?: MergeConfig,
        ): Immutable<T>;
        ...
        without<K extends keyof T>(
            filter: (value: T[K], key: K) => boolean,
        ): Immutable<T>;

        replace<S>(valueObj: S, options?: ReplaceConfig): Immutable<S>;
    }
    type ImmutableObject<T> = ImmutableObjectMixin<T> & {
    ...
    type ImmutableArray<T> = Readonly<ImmutableArray.Remaining<T>> &
    ...
    namespace ImmutableArray {
        ...
        interface Additions<T> {
            ...
            ): Immutable<TTarget extends any[] ? TTarget : TTarget[]>;
        }
        ...
        interface Overrides<T> {
            ...
            filter(
                filterFunction: (item: Immutable<T>, index: number) => boolean,
            ): Immutable<T[]>;
        ...
        type AdditionalMutatingArrayMethods = Extract<
            keyof any[],
            "copyWithin" | "fill"
        >;
        ...
        type Remaining<T> = Omit<
            ...
            | AdditionalMutatingArrayMethods
            | keyof Overrides<any>
        >;
    }
    ...
    type Immutable<T, O extends object = {}> = T extends Promise<infer U>
        ? Promise<Immutable.MakeImmutable<U, O>>
        : Immutable.MakeImmutable<T, O>;
    namespace Immutable {
        type AnyFunction = (...args: any[]) => any;

        type AlreadyImmutable<O extends object = {}> =
            | ImmutableObject<O>
            | ImmutableArray<any>
            | ImmutableDate;
        ...
        type CannotMakeImmutable<O extends object = {}> =
            | AlreadyImmutable<O>
            | Primitive;
        ...
        type MakeImmutable<
            T,
            O extends object = {},
        > = T extends CannotMakeImmutable<O>
            ? T
    ...
    function asMutable<T>(
        obj: T[] | ImmutableArray<T>,
        opts?: AsMutableOptions<false>,
    ): T[];
    function asMutable<T>(
        obj: T[] | ImmutableArray<T>,
        opts: AsMutableOptions<true>,
    ): T[];
    function asMutable<T>(
        obj: T[] | ImmutableArray<T>,
        opts: AsMutableOptions,
