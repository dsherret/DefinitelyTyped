...
export type WebSocketServerOptions = Pick<
    IServerConfig,
    Exclude<keyof IServerConfig, "httpServer">
>;

export type ConnectionRequestAcceptFn = () => WebSocketTransport;

export type ConnectionRequestRejectFn = ((
    code: number,
    reason: string,
) => void) &
    ((error: Error) => void);

export type RequestCb = (
...
export type RejectFn = ((errorCode?: Error) => void) &
    ((errorCode: number, errorReason: Error | string) => void);
