...
export interface Model<T> {
    ...
    get(
        ...
        callback: Callback<Item<T> | null>,
    ): void;
    get(
        hashKey: string,
        rangeKeyOrOptions: string | GetOptions<T>,
        callback: Callback<Item<T> | null>,
    ): void;
    get(
        hashKeyOrAttributes: string | Partial<T>,
        callback: Callback<Item<T> | null>,
    ): void;
    get(
    ...
    create(
        attributes: ReadonlyArray<Partial<T>>,
        options: CreateOptions,
    ...
    before: (
        event: "create" | "update",
        hook: (data: Partial<T>, next: Callback<Partial<T>>) => void,
    ) => void;
    after: (
        event: "create" | "update" | "destroy",
        hook: (data: Item<T>, next: Callback<void>) => void,
    ) => void;
