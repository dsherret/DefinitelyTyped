...
firstG = svgEl.selectChild<SVGGElement, SVGGElement>(
    (child, i, children) => true,
);
...
gElementsOldData = svgEl.selectChildren<SVGGElement, CircleDatum, SVGGElement>(
    (child, i, children) => true,
);
...
declare const transition: d3Selection.TransitionLike<
    SVGCircleElement,
    CircleDatumAlternative
>;
...
let listener:
    | undefined
    | ((this: HTMLBodyElement, event: any, datum: BodyDatum) => void);
