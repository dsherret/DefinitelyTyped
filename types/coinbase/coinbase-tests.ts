...
client.getAccounts(
    {},
    (error: Error | null, result: coinbase.Account[]): void => undefined,
);

client.getAccount(
    "abcdef",
    (error: Error | null, account: coinbase.Account): void => {
        account.buy(
            {
                amount: "1",
                commit: false,
            ...
            (error: Error | null, buy: coinbase.Buy): void => {
                buy.commit(
                    (error: Error | null, buy: coinbase.Buy): void => undefined,
                );
            },
        );
        ...
        account.createAddress(
            { name: "foo" },
            (error: Error | null, address: coinbase.Address): void => {
        ...
        account.getAddress(
            "abcdef",
            (error: Error | null, address: coinbase.Address): void => undefined,
        );
        ...
        account.getDeposit(
            "abcdef",
            (error: Error | null, deposit: coinbase.Deposit): void => undefined,
        );
        ...
        account.getSell(
            "abcdef",
            (error: Error | null, deposit: coinbase.Sell): void => undefined,
        );
        ...
        account.getTransaction(
            "abcdef",
            (error: Error | null, transaction: coinbase.Transaction): void => {
        ...
        account.getTransactions(
            {},
            (error: Error | null, transactions: coinbase.Transaction[]): void =>
                undefined,
        );
        ...
        account.getWithdrawal(
            "abcdef",
            (error: Error | null, withdrawal: coinbase.Withdrawal): void =>
                undefined,
        );
        ...
        account.requestMoney(
            ...
            (error: Error | null, tx: coinbase.Transaction) => {
                tx.cancel(
                    (error: Error | null, tx: coinbase.Transaction): void =>
                        undefined,
                );
                tx.complete(
                    (error: Error | null, tx: coinbase.Transaction): void =>
...
client.getCurrencies(
    (error: Error | null, result: coinbase.Currencies): void => undefined,
);

client.getExchangeRates(
    { currency: "ETC" },
    (error: Error | null, result: coinbase.ExchangeRate): void => undefined,
);

client.getPaymentMethod(
    "foo",
    (error: Error | null, result: coinbase.PaymentMethod): void => undefined,
);
...
client.getUser("abcdef", (error: Error | null, user: coinbase.User): void => {
    user.showAuth(
        (error: Error | null, auth: coinbase.Auth): void => undefined,
    );
    user.update(
