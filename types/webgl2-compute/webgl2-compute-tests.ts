window.onload = () => {
    ...
    const gl: WebGL2ComputeRenderingContext | null =
        canvas.getContext("webgl2-compute");
    ...
    const maxComputeUniformBlocks = gl.getParameter(
    ...
    const maxShaderStorageBlocks = gl.getParameter(
    ...
    const maxWorkGroupInvocations = gl.getParameter(
