...
export interface WebTwainViewer extends WebTwainAcquire {
     ...
     */
    BindViewer(elementId: string, config?: BasicViewerConfig): boolean;
    /**
...
export interface DynamsoftViewer {
     ...
     */
    setViewMode(columns: number, rows: number): boolean;
    /**
     ...
     */
    setButtonClass(name: string, className: string): boolean;
    /**
