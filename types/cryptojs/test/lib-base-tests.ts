    ...
    function (Y) {
        ...
        Y.Test.Runner.add(
            new Y.Test.Case({
                ...
                testMixIn: function () {
                    Y.Assert.areEqual(
                        this.data.mixins.mixinMethod,
                        this.data.Obj.mixinMethod,
                    );
                    Y.Assert.isTrue(
                        this.data.Obj.hasOwnProperty("mixinMethod"),
                    );
                },
                ...
                testCloneCopy: function () {
                    Y.Assert.areEqual(
                        this.data.obj.initArg,
                        this.data.objClone.initArg,
                    );
                },
