        ...
        Y.Test.Runner.add(
            new Y.Test.Case({
                ...
                testStringify1: function () {
                    Y.Assert.areEqual(
                        "z",
                        C.enc.Utf16.stringify(
                            C.lib.WordArray.create([0x007a0000], 2),
                        ),
                    );
                },
                ...
                testStringify2: function () {
                    Y.Assert.areEqual(
                        "水",
                        C.enc.Utf16.stringify(
                            C.lib.WordArray.create([0x6c340000], 2),
                        ),
                    );
                },
                ...
                testStringify3: function () {
                    Y.Assert.areEqual(
                        "𐀀",
                        C.enc.Utf16.stringify(
                            C.lib.WordArray.create([0xd800dc00], 4),
                        ),
                    );
                },
                ...
                testStringify4: function () {
                    Y.Assert.areEqual(
                        "𝄞",
                        C.enc.Utf16.stringify(
                            C.lib.WordArray.create([0xd834dd1e], 4),
                        ),
                    );
                },
                ...
                testStringify5: function () {
                    Y.Assert.areEqual(
                        "􏿽",
                        C.enc.Utf16.stringify(
                            C.lib.WordArray.create([0xdbffdffd], 4),
                        ),
                    );
                },
                ...
                testStringifyLE: function () {
                    Y.Assert.areEqual(
                        "􏿽",
                        C.enc.Utf16LE.stringify(
                            C.lib.WordArray.create([0xffdbfddf], 4),
                        ),
                    );
                },
