            ...
            new Y.Test.Case({
                ...
                testEncrypt2: function () {
                    Y.Assert.areEqual(
                        ...
                        C.TripleDES.encrypt(
                            C.enc.Hex.parse("0000000000000000"),
                            C.enc.Hex.parse(
                                "010101010101010201010101010101020101010101010102",
                            ),
                            { mode: C.mode.ECB, padding: C.pad.NoPadding },
                        ).ciphertext.toString(),
                    );
                ...
                testDecrypt2: function () {
                    Y.Assert.areEqual(
                        ...
                        C.TripleDES.decrypt(
                            C.lib.CipherParams.create({
                                ciphertext: C.enc.Hex.parse("869efd7f9f265a09"),
                            }),
                            C.enc.Hex.parse(
                                "010101010101010201010101010101020101010101010102",
                            ),
                ...
                testDecrypt3: function () {
                    Y.Assert.areEqual(
                        ...
                        C.TripleDES.decrypt(
                            C.lib.CipherParams.create({
                                ciphertext: C.enc.Hex.parse("95f8a5e5dd31d900"),
                            }),
                            C.enc.Hex.parse(
                                "010101010101010101010101010101010101010101010101",
                            ),
                ...
                testDecrypt4: function () {
                    Y.Assert.areEqual(
                        ...
                        C.TripleDES.decrypt(
                            C.lib.CipherParams.create({
                                ciphertext: C.enc.Hex.parse("166b40b44aba4bd6"),
                            }),
                            C.enc.Hex.parse(
                                "010101010101010101010101010101010101010101010101",
                            ),
                ...
                testMultiPart: function () {
                    var des = C.algo.TripleDES.createEncryptor(
                        C.enc.Hex.parse(
