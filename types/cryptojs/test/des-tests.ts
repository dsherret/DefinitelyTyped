            ...
            new Y.Test.Case({
                    ...
                    Y.Assert.areEqual(
                        ...
                        C.DES.decrypt(
                            C.lib.CipherParams.create({
                                ciphertext: C.enc.Hex.parse("95a8d72813daa94d"),
                            }),
                            C.enc.Hex.parse("8000000000000000"),
                ...
                testDecrypt2: function () {
                    Y.Assert.areEqual(
                        ...
                        C.DES.decrypt(
                            C.lib.CipherParams.create({
                                ciphertext: C.enc.Hex.parse("1de5279dae3bed6f"),
                            }),
                            C.enc.Hex.parse("0000000000002000"),
                            { mode: C.mode.ECB, padding: C.pad.NoPadding },
                        ).toString(),
                ...
                testDecrypt3: function () {
                    Y.Assert.areEqual(
                        ...
                        C.DES.decrypt(
                            C.lib.CipherParams.create({
                                ciphertext: C.enc.Hex.parse("1d1ca853ae7c0c5f"),
                            }),
                            C.enc.Hex.parse("0000000000000000"),
                            { mode: C.mode.ECB, padding: C.pad.NoPadding },
                        ).toString(),
                ...
                testDecrypt4: function () {
                    Y.Assert.areEqual(
                        ...
                        C.DES.decrypt(
                            C.lib.CipherParams.create({
                                ciphertext: C.enc.Hex.parse("ac978c247863388f"),
                            }),
                            C.enc.Hex.parse("3232323232323232"),
                            { mode: C.mode.ECB, padding: C.pad.NoPadding },
                        ).toString(),
                ...
                testDecrypt5: function () {
                    Y.Assert.areEqual(
                        ...
                        C.DES.decrypt(
                            C.lib.CipherParams.create({
                                ciphertext: C.enc.Hex.parse("3af1703d76442789"),
                            }),
                            C.enc.Hex.parse("6464646464646464"),
                            { mode: C.mode.ECB, padding: C.pad.NoPadding },
                        ).toString(),
                ...
                testDecrypt6: function () {
                    Y.Assert.areEqual(
                        ...
                        C.DES.decrypt(
                            C.lib.CipherParams.create({
                                ciphertext: C.enc.Hex.parse("a020003c5554f34c"),
                            }),
                            C.enc.Hex.parse("9696969696969696"),
                            { mode: C.mode.ECB, padding: C.pad.NoPadding },
                        ).toString(),
                ...
                testMultiPart: function () {
                    var des = C.algo.DES.createEncryptor(
                    ...
                    var ciphertext1 = des.process(
                        C.enc.Hex.parse("001122334455"),
                    );
                    var ciphertext2 = des.process(
                        C.enc.Hex.parse("66778899aa"),
                    );
                    var ciphertext3 = des.process(
                        C.enc.Hex.parse("bbccddeeff"),
                    );
                ...
                testHelper: function () {
                    ...
                    // Test
                    Y.Assert.areEqual(
                        C.algo.DES.createEncryptor(C.SHA256("Jefe"), {
                            mode: C.mode.ECB,
                            padding: C.pad.NoPadding,
                        })
                            .finalize("Hi There")
                    ...
                    Y.Assert.areEqual(
                        C.lib.PasswordBasedCipher.encrypt(
                            C.algo.DES,
                            "Hi There",
                            "Jefe",
                            {
