        ...
        Y.Test.Runner.add(
            new Y.Test.Case({
                ...
                testStringify1: function () {
                    Y.Assert.areEqual(
                        "$",
                        C.enc.Utf8.stringify(
                            C.lib.WordArray.create([0x24000000], 1),
                        ),
                    );
                },
                ...
                testStringify2: function () {
                    Y.Assert.areEqual(
                        "¢",
                        C.enc.Utf8.stringify(
                            C.lib.WordArray.create([0xc2a20000], 2),
                        ),
                    );
                },
                ...
                testStringify3: function () {
                    Y.Assert.areEqual(
                        "€",
                        C.enc.Utf8.stringify(
                            C.lib.WordArray.create([0xe282ac00], 3),
                        ),
                    );
                },
                ...
                testStringify4: function () {
                    Y.Assert.areEqual(
                        "𤭢",
                        C.enc.Utf8.stringify(
                            C.lib.WordArray.create([0xf0a4ada2], 4),
                        ),
                    );
                },
