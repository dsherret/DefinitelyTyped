        ...
        Y.Test.Runner.add(
            new Y.Test.Case({
                ...
                testClone: function () {
                    ...
                    Y.Assert.areEqual(
                        C.SHA384("a").toString(),
                        sha384.update("a").clone().finalize().toString(),
                    );
                    Y.Assert.areEqual(
                        C.SHA384("ab").toString(),
                        sha384.update("b").clone().finalize().toString(),
                    );
                    Y.Assert.areEqual(
                        C.SHA384("abc").toString(),
                        sha384.update("c").clone().finalize().toString(),
                    );
                },
                ...
                testHelper: function () {
                    Y.Assert.areEqual(
                        C.algo.SHA384.create().finalize("").toString(),
                        C.SHA384("").toString(),
                    );
                },
                ...
                testHmacHelper: function () {
                    Y.Assert.areEqual(
                        C.algo.HMAC.create(
                            C.algo.SHA384,
                            C.enc.Hex.parse("0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b"),
                        )
                            .finalize("Hi There")
                            .toString(),
                        C.HmacSHA384(
