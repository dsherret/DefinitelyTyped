            ...
            new Y.Test.Case({
                ...
                testKeySize128Iterations5: function () {
                    Y.Assert.areEqual(
                        ...
                        C.PBKDF2(
                            "password",
                            C.enc.Hex.parse("1234567878563412"),
                            {
                                keySize: 128 / 32,
                                iterations: 5,
                            },
                ...
                testKeySize128Iterations1200PassPhraseEqualsBlockSize:
                    function () {
                        Y.Assert.areEqual(
                ...
                testKeySize256Iterations1200PassPhraseEqualsBlockSize:
                    function () {
                        Y.Assert.areEqual(
                ...
                testKeySize128Iterations1200PassPhraseExceedsBlockSize:
                    function () {
                        Y.Assert.areEqual(
                ...
                testKeySize256Iterations1200PassPhraseExceedsBlockSize:
                    function () {
                        Y.Assert.areEqual(
