                ...
                new Y.Test.Case({
                    ...
                    testInt8Array: function () {
                        Y.Assert.areEqual(
                            ...
                            C.lib.WordArray.create(
                                new Int8Array(this.data.buffer),
                            ).toString(),
                        );
                    },
                    ...
                    testInt16Array: function () {
                        Y.Assert.areEqual(
                            "0123456789abcdef",
                            C.lib.WordArray.create(
                                new Int16Array(this.data.buffer),
                            ).toString(),
                        );
                    },
                    ...
                    testUint16Array: function () {
                        Y.Assert.areEqual(
                            "0123456789abcdef",
                            C.lib.WordArray.create(
                                new Uint16Array(this.data.buffer),
                            ).toString(),
                        );
                    },
                    ...
                    testInt32Array: function () {
                        Y.Assert.areEqual(
                            "0123456789abcdef",
                            C.lib.WordArray.create(
                                new Int32Array(this.data.buffer),
                            ).toString(),
                        );
                    },
                    ...
                    testUint32Array: function () {
                        Y.Assert.areEqual(
                            "0123456789abcdef",
                            C.lib.WordArray.create(
                                new Uint32Array(this.data.buffer),
                            ).toString(),
                        );
                    },
                    ...
                    testPartialView: function () {
                        Y.Assert.areEqual(
                            "456789ab",
                            C.lib.WordArray.create(
                                new Int16Array(this.data.buffer, 2, 2),
                            ).toString(),
                        );
                    },
                }),
