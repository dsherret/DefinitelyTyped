        ...
        Y.Test.Runner.add(
            new Y.Test.Case({
                ...
                setUp: function () {
                    ...
                    this.data.key = C.lib.WordArray.create([
                        0x10111213, 0x14151617, 0x18191a1b, 0x1c1d1e1f,
                    ]);
                    this.data.iv = C.lib.WordArray.create([
                ...
                testEncrypt: function () {
                    ...
                    // Compute actual
                    var actual = C.lib.SerializableCipher.encrypt(
                        C.algo.AES,
                        this.data.message,
                        this.data.key,
                        {
                ...
                testDecrypt: function () {
                    ...
                    var decrypted = C.lib.SerializableCipher.decrypt(
                        C.algo.AES,
                        encrypted,
                        this.data.key,
                        {
