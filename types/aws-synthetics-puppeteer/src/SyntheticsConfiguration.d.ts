...
declare module "SyntheticsConfiguration" {
    ...
    class SyntheticsConfiguration {
        ...
        withScreenshotOnStepStart(
            screenshotOnStepStart: any,
        ): SyntheticsConfiguration;
        getScreenshotOnStepStart(): boolean;
        withScreenshotOnStepSuccess(
            screenshotOnStepSuccess: any,
        ): SyntheticsConfiguration;
        getScreenshotOnStepSuccess(): boolean;
        withScreenshotOnStepFailure(
            screenshotOnStepFailure: any,
        ): SyntheticsConfiguration;
        getScreenshotOnStepFailure(): boolean;
        disableStepScreenshots(): void;
        enableStepScreenshots(): void;
        withIncludeRequestHeaders(
            includeRequestHeaders: any,
        ): SyntheticsConfiguration;
        ...
        withIncludeRequestBody(
            includeRequestBody: any,
        ): SyntheticsConfiguration;
        getIncludeRequestBody(): boolean;
        withIncludeResponseHeaders(
            includeResponseHeaders: any,
        ): SyntheticsConfiguration;
        getIncludeResponseHeaders(): boolean;
        withIncludeResponseBody(
            includeResponseBody: any,
        ): SyntheticsConfiguration;
        ...
        withContinueOnHttpStepFailure(
            continueOnHttpStepFailure: any,
        ): SyntheticsConfiguration;
        ...
        withStepDurationMetric(
            stepDurationMetric: any,
        ): SyntheticsConfiguration;
        ...
        withFailedRequestsMetric(
            failedRequestsMetric: any,
        ): SyntheticsConfiguration;
        getFailedRequestsMetric(): boolean;
        withAggregatedFailedRequestsMetric(
            aggregatedFailedRequestsMetric: any,
        ): SyntheticsConfiguration;
        getAggregatedFailedRequestsMetric(): boolean;
        withAggregated2xxMetric(
            aggregated2xxMetric: any,
        ): SyntheticsConfiguration;
        getAggregated2xxMetric(): boolean;
        withAggregated4xxMetric(
            aggregated4xxMetric: any,
        ): SyntheticsConfiguration;
        getAggregated4xxMetric(): boolean;
        withAggregated5xxMetric(
            aggregated5xxMetric: any,
        ): SyntheticsConfiguration;
        getAggregated5xxMetric(): boolean;
        withFailedCanaryMetric(
            failedCanaryMetric: any,
        ): SyntheticsConfiguration;
        getFailedCanaryMetric(): boolean;
        withAggregatedFailedCanaryMetric(
            aggregatedFailedCanaryMetric: any,
        ): SyntheticsConfiguration;
        ...
        withVisualCompareWithBaseRun(
            visualCompareWithBaseRun: boolean,
        ): SyntheticsConfiguration;
        getVisualCompareWithBaseRun(): boolean;
        withVisualVarianceThresholdPercentage(
            visualVarianceThresholdPercentage: number,
        ): SyntheticsConfiguration;
        getVisualVarianceThresholdPercentage(): number;
        withVisualVarianceHighlightHexColor(
            visualVarianceHighlightHexColor: string,
        ): SyntheticsConfiguration;
        getVisualVarianceHighlightHexColor(): string;
        withFailCanaryRunOnVisualVariance(
