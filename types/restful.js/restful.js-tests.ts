...
var articlesCollection = api.allUrl(
    "articles",
    "http://custom.url/article/list",
); // http://custom.url/article/list
...
resource.addRequestInterceptor(
    (data: any, headers: any, method: string, url: string) => {
...
resource.addFullRequestInterceptor(
    function (params, headers, data, method, url) {
        // ...
