...
expectType<{
    (
        template: string,
        opts: ejs.Options & { async: true; client?: false | undefined },
    ): ejs.AsyncTemplateFunction;
    (
        template: string,
        opts: ejs.Options & { async: true; client: true },
    ...
    (
        template: string,
        opts?: ejs.Options & { async?: false | undefined; client: true },
    ): ejs.ClientFunction;
    (
        template: string,
        opts?: ejs.Options,
...
expectType<{
    (
        template: string,
        data?: ejs.Data,
        opts?: ejs.Options & { async: false },
    ): string;
    (
        template: string,
        data: ejs.Data,
        opts: ejs.Options & { async: true },
    ): Promise<string>;
    (
        template: string,
        data: ejs.Data,
        opts: ejs.Options & { async?: undefined },
    ): string;
    (
        template: string,
        data?: ejs.Data,
