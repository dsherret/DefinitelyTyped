...
type ObjectType = Record<
    string,
    ScalarType | Record<string, ScalarType> | Array<Record<string, ScalarType>>
>;
...
interface NumberAggregateResult<T, Keys extends keyof T>
    extends BaseAggregateResult<T> {
    avg?:
        | {
              [key in Keys]?: number;
          }
...
export type HasuraDataResult<T extends Record<string, any>> = Array<
    HasuraDataItem<T>
>;
...
export interface HasuraAggregateQueryResponse<
    K extends string,
    T extends Record<string, any>,
> {
    data: {
...
export type HasuraInsertOnConflict<
    T extends Record<string, any>,
