...
ES2015.Call<bigint, readonly [], string>(
...
ES2015.Call(
    ...
    any,
    args as IArguments & [PropertyKey],
); // $ExpectType boolean
...
ES2015.Invoke(
    Object as typeof Object & typeof Object.prototype,
    "hasOwnProperty",
    ["prototype"],
); // $ExpectType boolean
...
expectType<
    IteratorResult<number, void> | Promise<IteratorResult<number, void>>
>(
    // eslint-disable-next-line @typescript-eslint/no-invalid-void-type
    ES2015.IteratorNext<number, void>(
        any as Generator<number, void> | AsyncGenerator<number, void>,
    ),
);
...
const iteratorResult =
    Math.random() < 0.5 ? iteratorYieldResult : iteratorReturnResult;
const iteratorNeverUnknownResult: IteratorResult<never, unknown> =
    iteratorResult as any;
...
expectType<
    ES2015.PropertyDescriptor<typeof Reflect.getPrototypeOf> | undefined
>(ES2015.OrdinaryGetOwnProperty(Reflect, "getPrototypeOf"));
expectType<
    ES2015.PropertyDescriptor<typeof Reflect.setPrototypeOf> | undefined
>(ES2015.OrdinaryGetOwnProperty(Reflect, "setPrototypeOf"));

const completeNullishUnionDescriptor =
    ES2015.CompletePropertyDescriptor(
...
const completeRequiredValueDescriptor =
    ES2015.CompletePropertyDescriptor(newType<{ "[[Value]]": string }>());
...
const completeDataDescriptor =
    ES2015.CompletePropertyDescriptor(
        newType<{ "[[Value]]"?: number | undefined }>(),
    );
...
const completeAccessorDescriptor =
    ES2015.CompletePropertyDescriptor(
...
declare const Biz: { readonly prototype?: null | undefined } & Omit<
    Function,
    "prototype"
>;
