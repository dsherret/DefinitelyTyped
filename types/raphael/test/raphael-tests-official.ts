...
((assert) => {
    ...
    QUnit.test(
        "insertBefore: first element wrapped in <a> and wrapped in <a>",
        (assert) => {
    ...
    QUnit.test(
        "insertBefore: middle element wrapped in <a> and wrapped in <a>",
        (assert) => {
            const x = paper.rect(0, 0, 0, 0).attr("href", url);
            const xAnchor = x.node.parentNode;
    ...
    QUnit.test(
        "insertAfter: last element wrapped in <a> and wrapped in <a>",
        (assert) => {
            const x = paper.rect(0, 0, 0, 0).attr("href", url);
            const xAnchor = x.node.parentNode;
            const el = paper.rect(0, 0, 0, 0).attr("href", url);
    ...
    QUnit.test(
        "insertAfter: middle element wrapped in <a> and wrapped in <a>",
        (assert) => {
            const x = paper.rect(0, 0, 0, 0).attr("href", url);
            const xAnchor = x.node.parentNode;
            const y = paper.rect(0, 0, 0, 0).attr("href", url);
