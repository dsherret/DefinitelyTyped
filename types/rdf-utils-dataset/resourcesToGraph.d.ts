...
type DatasetOf<F> = F extends RDF.DatasetCoreFactory<any, any, infer D>
    ? D
    : never;

export default function resourcesToGraph<
    F extends Factory = Factory<QuadExt, QuadExt, DatasetExt>,
>(
