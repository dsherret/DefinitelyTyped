import {
    ApplicationEventMapping,
    PropagatedApplicationEventMapping,
} from "./application";
import { ApplicationEvent } from "./base";
import { PropagatedViewEvents } from "./view";
import { PropagatedWindowEvents } from "./window";
export interface PlatformEventMapping<Topic = string, Type = string>
    extends ApplicationEventMapping {
...
export declare type PlatformEvents = PropagatedWindowEvents<"application"> &
    PropagatedViewEvents<"application"> & {
        [Type in keyof PlatformEventMapping]: PlatformEventMapping<
            "application",
            Type
        >[Type];
    };
export declare type PropagatedPlatformEvents<Topic> = {
    [Type in keyof PropagatedPlatformEventMapping]: PropagatedPlatformEventMapping<
        Topic,
        Type
    >[Type];
};
