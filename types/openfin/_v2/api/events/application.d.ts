...
export interface RunRequestedEvent<Topic, Type>
    extends ApplicationEvent<Topic, Type> {
    userAppConfigArgs: any;
    manifest: ManifestInfo;
}
export interface TrayIconClicked<Topic, Type>
    extends ApplicationEvent<Topic, Type> {
    button: 0 | 1 | 2;
    bounds: Bounds;
    x: number;
...
export interface PropagatedApplicationEventMapping<
    Topic = string,
    Type = string,
> {
...
export declare type ApplicationEvents = PropagatedWindowEvents<"application"> &
    PropagatedViewEvents<"application"> & {
        [Type in keyof ApplicationEventMapping]: ApplicationEventMapping<
            "application",
            Type
        >[Type];
    };
export declare type PropagatedApplicationEvents<Topic> = {
    [Type in keyof PropagatedApplicationEventMapping]: PropagatedApplicationEventMapping<
        Topic,
        Type
    >[Type];
};
