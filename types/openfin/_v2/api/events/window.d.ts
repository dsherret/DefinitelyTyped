...
export interface WindowAlertRequestedEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    message: string;
    url: string;
}
export interface WindowAuthRequestedEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    authInfo: {
        host: string;
        isProxy: boolean;
...
export interface WindowEndLoadEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    documentName: string;
    isMain: boolean;
}
export interface WindowNavigationRejectedEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    sourceName?: string | undefined;
    url: string;
}
export interface WindowReloadedEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    url: string;
}
export interface WindowOptionsChangedEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    options: WindowOption;
    diff: WindowOptionDiff;
}
export interface WindowExternalProcessExitedEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    processUuid: string;
    exitCode: number;
}
export interface WindowExternalProcessStartedEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    processUuid: string;
}
export interface WindowHiddenEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
...
export interface WindowPreloadScriptsStateChangeEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    preloadScripts: Array<PreloadScriptInfoRunning & any>;
}
export interface WindowPreloadScriptsStateChangedEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    preloadScripts: Array<PreloadScriptInfoRunning & any>;
}
export interface WindowBeginBoundsChangingEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    height: number;
    left: number;
    top: number;
...
export interface WindowEndBoundsChangingEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    height: number;
    left: number;
    top: number;
...
export interface WindowBoundsChange<Topic, Type>
    extends WindowEvent<Topic, Type> {
    changeType: 0 | 1 | 2;
    deferred: boolean;
    height: number;
...
export interface WillMoveOrResize<Topic, Type>
    extends WindowEvent<Topic, Type> {
    height: number;
    left: number;
    top: number;
...
export interface WindowGroupChanged<Topic, Type>
    extends WindowEvent<Topic, Type> {
...
export declare type WindowPerformanceReport<Topic, Type> = Performance &
...
export interface WindowEventMapping<Topic = string, Type = string>
...
export interface PropagatedWindowEventMapping<Topic = string, Type = string>
    extends BaseEventMap {
    "window-begin-user-bounds-changing": WindowBeginBoundsChangingEvent<
        Topic,
        Type
    >;
    ...
    "window-end-user-bounds-changing": WindowBeginBoundsChangingEvent<
        Topic,
        Type
    >;
    "window-external-process-exited": WindowExternalProcessExitedEvent<
        Topic,
        Type
    >;
    "window-external-process-started": WindowExternalProcessStartedEvent<
        Topic,
        Type
    >;
    ...
    "window-resource-response-received": WindowResourceResponseReceivedEvent<
        Topic,
        Type
    >;
...
export declare type WindowEvents = PropagatedViewEventMapping<"window"> & {
    [Type in keyof WindowEventMapping]: WindowEventMapping<
        "window",
        Type
    >[Type];
};
export declare type PropagatedWindowEvents<Topic> = {
    [Type in keyof PropagatedWindowEventMapping]: PropagatedWindowEventMapping<
        Topic,
        Type
    >[Type];
};
