...
export declare type MonitorEvent<Topic, Type> = MonitorInfo &
    BaseEvent<Topic, Type>;
export interface SessionChangedEvent<Topic, Type>
    extends BaseEvent<Topic, Type> {
    reason:
        | "lock"
        | "unlock"
        | "remote-connect"
...
export declare type SystemEvents = PropagatedWindowEvents<"system"> &
    ...
    PropagatedViewEvents<"system"> & {
        [Type in keyof SystemEventMapping]: SystemEventMapping<
            "system",
            Type
        >[Type];
    };
