...
export interface WindowResourceLoadFailedEvent<Topic, Type>
...
export interface WindowResourceResponseReceivedEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    status: boolean;
    newUrl: string;
    originalUrl: string;
...
export interface PageTitleUpdatedEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    title: string;
}
export interface CertificateErrorEvent<Topic, Type>
    extends WindowEvent<Topic, Type> {
    error: string;
    url: string;
    certificate: any;
}
export interface WebContentsEventMapping<Topic = string, Type = string>
