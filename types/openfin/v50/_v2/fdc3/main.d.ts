 ...
 * @throws If `context` is passed, `TypeError` if `context` is not a valid [[Context]].
 */
export declare function findIntent(
    intent: string,
    context?: Context,
): Promise<AppIntent>;
/**
 ...
 */
export declare function findIntentsByContext(
    context: Context,
): Promise<AppIntent[]>;
/**
 ...
 * @throws `TypeError` if `context` is not a valid [[Context]].
 */
export declare function raiseIntent(
    intent: string,
    context: Context,
    target?: AppName,
 ...
 */
export declare function addIntentListener(
    intent: string,
 ...
 */
export declare function addContextListener(
    handler: (context: Context) => void,
): ContextListener;
/**
