...
declare namespace fin {
    ...
    type ApplySnapshotOptions =
        import("./_v2/api/platform/platform").ApplySnapshotOptions;
    ...
    type InitPlatformOptions =
        import("./_v2/api/platform/platform").InitPlatformOptions;
    type Layout = import("./_v2/api/platform/layout").Layout;
    type PlatformOptions =
        import("./_v2/api/platform/platform").PlatformOptions;
    ...
    interface OpenFinExternalWindow {
         ...
         */
        mergeGroups(
            target: OpenFinExternalWindow | OpenFinWindow,
        ): Promise<void>;
    ...
    interface OpenFinView {
         ...
         */
        setBounds: (
            bounds: Pick<Bounds, "height" | "width" | "top" | "left">,
        ) => Promise<void>;
        /**
