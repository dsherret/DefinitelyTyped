...
var repositioned = (): favicojs.Favico =>
    new Favico({
        position: "upleft",
    });

var shaped = (): favicojs.Favico =>
    new Favico({
        type: "rectangle",
    });

var usingCustomFont = (): favicojs.Favico =>
    new Favico({
        fontFamily: "FontAwesome",
        elementId: "badgefont",
    });

var colored = (): favicojs.Favico =>
    new Favico({
        bgColor: "#5CB85C",
        textColor: "#ff0",
    });

var domBound = (): favicojs.Favico =>
    new Favico({
...
var withDataUrl = (): favicojs.Favico =>
    new Favico({
