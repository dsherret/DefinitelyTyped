...
describe("ReactDOMServer", () => {
    ...
    it("renderToStream", () => {
        const content: any = ReactDOMServer.renderToNodeStream(
            React.createElement("div"),
        );
    });

    it("renderToStaticStream", () => {
        const content: any = ReactDOMServer.renderToStaticNodeStream(
            React.createElement("div"),
        );
    });
});
...
describe("React dom test utils", () => {
    ...
    it("Simulate all event types", () => {
        ...
        const node = ReactDOM.findDOMNode(dom) as HTMLInputElement;
        // @see: https://github.com/facebook/react/blob/v16.14.0/packages/react-dom/src/test-utils/ReactTestUtils.js#L616-L702
