...
export function bindActionCreatorsDeep<M extends ActionFactoriesMap, S>(
    actionFactories: M,
    dispatch: Dispatch<S>,
): M;
export function bindActionCreatorsDeep<A extends ActionCreator<any>, S>(
    actionFactories: A,
    dispatch: Dispatch<S>,
): A;
...
export function scopeActionCreators<
    A extends ActionCreator<any> | ActionCreatorsMapObject,
>(actionCreator: A, scopeID: string | number): A;

export function scopeReducers(reducers?: {
